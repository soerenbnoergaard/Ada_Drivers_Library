...
package SAM_SVD.UOTGHS is
   ...
   type UOTGHS_DEVCTRL_Register is record
      ...
      --  Mode Configuration
      SPDCONF        : DEVCTRL_SPDCONF_Field := SAM_SVD.UOTGHS.Normal;
   ...
   subtype UOTGHS_DEVFNUM_MFNUM_Field is HAL.UInt3;
   ...
   type UOTGHS_DEVEPTCFG_Register is record
      ...
      NBTRANS        : DEVEPTCFG_NBTRANS_Field :=
                        SAM_SVD.UOTGHS.DEVEPTCFG_NBTRANS_Field_0_Trans;
      --  unspecified
   ...
   type HSTCTRL_SPDCONF_Field is
     (
      ...
      --  switch to the high-speed mode if the downstream peripheral is
      --  high-speed capable.
      Normal,
      --  For a better consumption, if high-speed is not needed.
      Low_Power,
   ...
   type UOTGHS_HSTCTRL_Register is record
      ...
      Reserved_11_11 : HAL.Bit := 16#0#;
      --  Mode Configuration
      SPDCONF        : HSTCTRL_SPDCONF_Field := SAM_SVD.UOTGHS.Normal;
      --  unspecified
   ...
   subtype UOTGHS_HSTFNUM_MFNUM_Field is HAL.UInt3;
   ...
   subtype UOTGHS_HSTPIPCFG0_HSBOHSCP_PEPNUM_Field is HAL.UInt4;
   subtype UOTGHS_HSTPIPCFG0_HSBOHSCP_BINTERVAL_Field is HAL.UInt8;
   ...
   type UOTGHS_HSTPIPCFG0_HSBOHSCP_Register is record
      ...
      PBK            : HSTPIPCFG0_HSBOHSCP_PBK_Field :=
                        SAM_SVD.UOTGHS.HSTPIPCFG0_HSBOHSCP_PBK_Field_1_Bank;
      --  Pipe Size
      PSIZE          : HSTPIPCFG0_HSBOHSCP_PSIZE_Field :=
                        SAM_SVD.UOTGHS.HSTPIPCFG0_HSBOHSCP_PSIZE_Field_8_Byte;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Pipe Token
      PTOKEN         : HSTPIPCFG0_HSBOHSCP_PTOKEN_Field :=
                        SAM_SVD.UOTGHS.Setup;
      --  Automatic Switch
      AUTOSW         : Boolean := False;
      --  unspecified
      Reserved_11_11 : HAL.Bit := 16#0#;
      --  Pipe Type
      PTYPE          : HSTPIPCFG0_HSBOHSCP_PTYPE_Field := SAM_SVD.UOTGHS.Ctrl;
      --  unspecified
      Reserved_14_15 : HAL.UInt2 := 16#0#;
      --  Pipe Endpoint Number
