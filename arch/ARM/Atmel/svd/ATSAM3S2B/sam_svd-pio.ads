...
package SAM_SVD.PIO is
   ...
   for PIOA_Peripheral use record
      ...
      RPR     at 16#104# range 0 .. 31;
      RCR     at 16#108# range 0 .. 31;
      RNPR    at 16#114# range 0 .. 31;
      RNCR    at 16#118# range 0 .. 31;
      PTCR    at 16#124# range 0 .. 31;
      PTSR    at 16#128# range 0 .. 31;
   end record;
   ...
   type PIOB_Peripheral is record
      --  PIO Enable Register
      PER     : aliased PIOA_PER_Register;
      --  PIO Disable Register
      PDR     : aliased PIOA_PDR_Register;
   ...
   for PIOB_Peripheral use record
      PER     at 16#0# range 0 .. 31;
      PDR     at 16#4# range 0 .. 31;
      PSR     at 16#8# range 0 .. 31;
      OER     at 16#10# range 0 .. 31;
   ...
   --  Parallel Input/Output Controller B
   PIOB_Periph : aliased PIOB_Peripheral
