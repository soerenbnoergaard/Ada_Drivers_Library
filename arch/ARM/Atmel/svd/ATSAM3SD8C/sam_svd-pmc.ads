...
package SAM_SVD.PMC is
   ...
   --  PMC_PCER0_PID array
   type PMC_PCER0_PID_Field_Array is array (2 .. 16) of Boolean
   ...
   --  PMC_PCER0_PID array
   type PMC_PCER0_PID_Field_Array_1 is array (18 .. 31) of Boolean
   ...
   type PMC_PCER0_Register is record
      ...
      --  Write-only. Peripheral Clock 18 Enable
   ...
   for PMC_PCER0_Register use record
      ...
      PID_1          at 0 range 18 .. 31;
   end record;

   --  PMC_PCDR0_PID array
   type PMC_PCDR0_PID_Field_Array is array (2 .. 16) of Boolean
     with Component_Size => 1, Size => 15;
   ...
   --  PMC_PCDR0_PID array
   type PMC_PCDR0_PID_Field_Array_1 is array (18 .. 31) of Boolean
     with Component_Size => 1, Size => 14;
   ...
   type PMC_PCDR0_Register is record
      ...
      --  unspecified
      Reserved_17_17 : HAL.Bit := 16#0#;
      --  Write-only. Peripheral Clock 18 Disable
   ...
   --  PMC_PCSR0_PID array
   type PMC_PCSR0_PID_Field_Array is array (2 .. 16) of Boolean
     with Component_Size => 1, Size => 15;
   ...
   --  PMC_PCSR0_PID array
   type PMC_PCSR0_PID_Field_Array_1 is array (18 .. 31) of Boolean
     with Component_Size => 1, Size => 14;
   ...
   type PMC_PCSR0_Register is record
      ...
      --  Read-only. Peripheral Clock 18 Status
