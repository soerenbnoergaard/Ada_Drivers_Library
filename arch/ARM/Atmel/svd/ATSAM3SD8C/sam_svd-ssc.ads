...
package SAM_SVD.SSC is
   ...
   type SSC_RCMR_Register is record
      ...
      CKI            : Boolean := False;
      --  Receive Clock Gating Selection
      CKG            : RCMR_CKG_Field := SAM_SVD.SSC.None;
      --  Receive Start Selection
   ...
   type SSC_TCMR_Register is record
      ...
      CKI            : Boolean := False;
      --  Transmit Clock Gating Selection
      CKG            : TCMR_CKG_Field := SAM_SVD.SSC.None;
      --  Transmit Start Selection
   ...
   subtype SSC_WPMR_WPKEY_Field is HAL.UInt24;
   ...
   subtype SSC_RCR_RXCTR_Field is HAL.UInt16;
   ...
   subtype SSC_TCR_TXCTR_Field is HAL.UInt16;
   ...
   subtype SSC_RNCR_RXNCTR_Field is HAL.UInt16;
   ...
   subtype SSC_TNCR_TXNCTR_Field is HAL.UInt16;
