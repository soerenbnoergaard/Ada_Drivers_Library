...
package SAM_SVD.SYSC is
   ...
   subtype SUPC_CR_KEY_Field is HAL.UInt8;
   ...
   type SMMR_SMTH_Field is
     (
      --  1.9 V
      SMMR_SMTH_Field_1_9V,
      --  2.0 V
      SMMR_SMTH_Field_2_0V,
      --  2.1 V
      SMMR_SMTH_Field_2_1V,
      --  2.2 V
      SMMR_SMTH_Field_2_2V,
      --  2.3 V
      SMMR_SMTH_Field_2_3V,
      --  2.4 V
      SMMR_SMTH_Field_2_4V,
      --  2.5 V
      SMMR_SMTH_Field_2_5V,
      --  2.6 V
      SMMR_SMTH_Field_2_6V,
      --  2.7 V
      SMMR_SMTH_Field_2_7V,
      --  2.8 V
      SMMR_SMTH_Field_2_8V,
      --  2.9 V
      SMMR_SMTH_Field_2_9V,
      --  3.0 V
      SMMR_SMTH_Field_3_0V,
      --  3.1 V
      SMMR_SMTH_Field_3_1V,
      --  3.2 V
      SMMR_SMTH_Field_3_2V,
      --  3.3 V
      SMMR_SMTH_Field_3_3V,
      --  3.4 V
      SMMR_SMTH_Field_3_4V)
     with Size => 4;
   for SMMR_SMTH_Field use
     (SMMR_SMTH_Field_1_9V => 0,
      SMMR_SMTH_Field_2_0V => 1,
      SMMR_SMTH_Field_2_1V => 2,
      SMMR_SMTH_Field_2_2V => 3,
      SMMR_SMTH_Field_2_3V => 4,
      SMMR_SMTH_Field_2_4V => 5,
      SMMR_SMTH_Field_2_5V => 6,
      SMMR_SMTH_Field_2_6V => 7,
      SMMR_SMTH_Field_2_7V => 8,
      SMMR_SMTH_Field_2_8V => 9,
      SMMR_SMTH_Field_2_9V => 10,
      SMMR_SMTH_Field_3_0V => 11,
      SMMR_SMTH_Field_3_1V => 12,
      SMMR_SMTH_Field_3_2V => 13,
      SMMR_SMTH_Field_3_3V => 14,
      SMMR_SMTH_Field_3_4V => 15);
   ...
   type SUPC_SMMR_Register is record
      --  Supply Monitor Threshold
      SMTH           : SMMR_SMTH_Field := SAM_SVD.SYSC.SMMR_SMTH_Field_1_9V;
      --  unspecified
   ...
   subtype SUPC_MR_KEY_Field is HAL.UInt8;
   ...
   type WUIR_WKUPT0_Field is
     (
      ...
      Low,
      --  a high levelfor a period defined by WKUPDBC on the correspond-ing
      --  wake-up input forces the wake up of the core power supply.
      High)
     with Size => 1;
   ...
   subtype WDT_CR_KEY_Field is HAL.UInt8;
