...
package SAM_SVD.USART is
   ...
   subtype USART0_FIDI_FI_DI_RATIO_Field is HAL.UInt11;
   ...
   subtype USART0_WPMR_WPKEY_Field is HAL.UInt24;
   ...
   subtype USART0_VERSION_VERSION_Field is HAL.UInt12;
   subtype USART0_VERSION_MFN_Field is HAL.UInt3;

   --  Version Register
   type USART0_VERSION_Register is record
      --  Read-only. Harware Module Version
      VERSION        : USART0_VERSION_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : USART0_VERSION_MFN_Field;
      --  unspecified
   ...
   for USART0_VERSION_Register use record
   ...
   is record
      ...
      --  Version Register
      VERSION      : aliased USART0_VERSION_Register;
