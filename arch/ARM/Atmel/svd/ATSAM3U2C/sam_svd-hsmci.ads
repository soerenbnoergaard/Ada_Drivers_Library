...
package SAM_SVD.HSMCI is
   ...
   subtype HSMCI_DMA_CHKSIZE_Field is HAL.UInt3;
   ...
   type HSMCI_DMA_Register is record
      ...
      CHKSIZE        : HSMCI_DMA_CHKSIZE_Field := 16#0#;
      --  unspecified
