...
package SAM_SVD.SYSC is
   ...
   GPBR_Periph : aliased GPBR_Peripheral
     with Import, Address => System'To_Address (16#400E1290#);
   ...
   RTC_Periph : aliased RTC_Peripheral
     with Import, Address => System'To_Address (16#400E1260#);
   ...
   RTT_Periph : aliased RTT_Peripheral
     with Import, Address => System'To_Address (16#400E1230#);
   ...
   SUPC_Periph : aliased SUPC_Peripheral
     with Import, Address => System'To_Address (16#400E1210#);
   ...
   WDT_Periph : aliased WDT_Peripheral
     with Import, Address => System'To_Address (16#400E1250#);
