...
package SAM_SVD.UART is
   ...
   subtype UART_RCR_RXCTR_Field is HAL.UInt16;
   ...
   subtype UART_TCR_TXCTR_Field is HAL.UInt16;
   ...
   subtype UART_RNCR_RXNCTR_Field is HAL.UInt16;
   ...
   subtype UART_TNCR_TXNCTR_Field is HAL.UInt16;
