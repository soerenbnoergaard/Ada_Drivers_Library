...
package SAM_SVD.PWM is
   ...
   type PWM_FSR_Register is record
      --  Read-only. Fault Input Value (fault input bit varies from 0 to 3)
      FIV            : PWM_FSR_FIV_Field;
      --  Read-only. Fault Status (fault input bit varies from 0 to 3)
      FS             : PWM_FSR_FS_Field;
      --  unspecified
   ...
   type PWM_FCR_Register is record
      --  Write-only. Fault Clear (fault input bit varies from 0 to 3)
