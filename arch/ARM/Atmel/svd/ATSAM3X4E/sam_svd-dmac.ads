...
package SAM_SVD.DMAC is
   ...
   type CTRLA_Register is record
      ...
      --  Source Chunk Transfer Size.
      SCSIZE         : CTRLA0_SCSIZE_Field := SAM_SVD.DMAC.Chk_1;
      --  unspecified
      Reserved_19_19 : HAL.Bit := 16#0#;
      --  Destination Chunk Transfer Size
      DCSIZE         : CTRLA0_DCSIZE_Field := SAM_SVD.DMAC.Chk_1;
      --  unspecified
   ...
   type DMAC_Peripheral is record
      ...
      SADDR4 : aliased HAL.UInt32;
      --  DMAC Channel Destination Address Register (ch_num = 4)
      DADDR4 : aliased HAL.UInt32;
      ...
      SADDR5 : aliased HAL.UInt32;
      --  DMAC Channel Destination Address Register (ch_num = 5)
      DADDR5 : aliased HAL.UInt32;
