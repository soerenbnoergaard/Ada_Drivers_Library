--  This spec has been automatically generated from ATSAM3X4E.svd
...
package SAM_SVD.EBI is
   ...
   type SMC_CFG_Register is record
      --  Page Size of the NAND Flash Device
      PAGESIZE       : CFG_PAGESIZE_Field := SAM_SVD.EBI.Ps512;
      --  unspecified
   ...
   type SMC_ECC_MD_Register is record
      --  ECC Page Size
      ECC_PAGESIZE  : ECC_MD_ECC_PAGESIZE_Field := SAM_SVD.EBI.Ps512;
      --  unspecified
   ...
   type WPCR_WP_KEY_Field is
     (
      ...
      --  the WP_EN bit. Always reads as 0.
      Passwd)
     with Size => 24;
