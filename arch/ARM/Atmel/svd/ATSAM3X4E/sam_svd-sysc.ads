...
package SAM_SVD.SYSC is
   ...
   type MR_VDDIORDY_Field is
     (
      --  VDDIO is removed (used before going to backup mode when backup
      --  batteries are used)
      Vddio_Removed,
      --  VDDIO is present (used before going to backup mode when backup
      --  batteries are used)
      Vddio_Present)
     with Size => 1;
   ...
   type SUPC_MR_Register is record
      ...
      --  VDDIO Ready
      VDDIORDY       : MR_VDDIORDY_Field := SAM_SVD.SYSC.Vddio_Present;
      --  unspecified
   ...
   GPBR_Periph : aliased GPBR_Peripheral
     with Import, Address => System'To_Address (16#400E1A90#);
   ...
   RTC_Periph : aliased RTC_Peripheral
     with Import, Address => System'To_Address (16#400E1A60#);
   ...
   RTT_Periph : aliased RTT_Peripheral
     with Import, Address => System'To_Address (16#400E1A30#);
   ...
   SUPC_Periph : aliased SUPC_Peripheral
     with Import, Address => System'To_Address (16#400E1A10#);
   ...
   WDT_Periph : aliased WDT_Peripheral
     with Import, Address => System'To_Address (16#400E1A50#);
