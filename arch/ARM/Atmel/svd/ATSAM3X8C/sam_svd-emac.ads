...
package SAM_SVD.EMAC is
   ...
   type EMAC_NCFGR_Register is record
      ...
      --  MDC clock divider
      CLK            : NCFGR_CLK_Field := SAM_SVD.EMAC.Mck_32;
      --  Retry test
      RTY            : Boolean := False;
      --  Pause Enable
      PAE            : Boolean := False;
      --  Receive Buffer Offset
      RBOF           : NCFGR_RBOF_Field := SAM_SVD.EMAC.Offset_0;
   ...
   subtype EMAC_RBQP_ADDR_Field is HAL.UInt30;
   ...
   subtype EMAC_TBQP_ADDR_Field is HAL.UInt30;
   ...
   subtype EMAC_MAN_DATA_Field is HAL.UInt16;
   subtype EMAC_MAN_CODE_Field is HAL.UInt2;
   subtype EMAC_MAN_REGA_Field is HAL.UInt5;
   subtype EMAC_MAN_PHYA_Field is HAL.UInt5;
   subtype EMAC_MAN_RW_Field is HAL.UInt2;
   subtype EMAC_MAN_SOF_Field is HAL.UInt2;
   ...
   subtype EMAC_PTR_PTIME_Field is HAL.UInt16;
   ...
   subtype EMAC_PFR_FROK_Field is HAL.UInt16;
   ...
   subtype EMAC_FTO_FTOK_Field is HAL.UInt24;
   ...
   subtype EMAC_SCF_SCF_Field is HAL.UInt16;
   ...
   subtype EMAC_MCF_MCF_Field is HAL.UInt16;
   ...
   subtype EMAC_FRO_FROK_Field is HAL.UInt24;
   ...
   subtype EMAC_FCSE_FCSE_Field is HAL.UInt8;
   ...
   subtype EMAC_ALE_ALE_Field is HAL.UInt8;
   ...
   subtype EMAC_DTF_DTF_Field is HAL.UInt16;
   ...
   subtype EMAC_LCOL_LCOL_Field is HAL.UInt8;
   ...
   subtype EMAC_ECOL_EXCOL_Field is HAL.UInt8;
   ...
   subtype EMAC_TUND_TUND_Field is HAL.UInt8;
   ...
   subtype EMAC_CSE_CSE_Field is HAL.UInt8;
   ...
   subtype EMAC_RRE_RRE_Field is HAL.UInt16;
   ...
   subtype EMAC_ROV_ROVR_Field is HAL.UInt8;
   ...
   subtype EMAC_RSE_RSE_Field is HAL.UInt8;
   ...
   subtype EMAC_ELE_EXL_Field is HAL.UInt8;
   ...
   subtype EMAC_RJA_RJB_Field is HAL.UInt8;
   ...
   subtype EMAC_USF_USF_Field is HAL.UInt8;
   ...
   subtype EMAC_STE_SQER_Field is HAL.UInt8;
   ...
   subtype EMAC_RLE_RLFM_Field is HAL.UInt8;
   ...
   subtype EMAC_SA1T_ADDR_Field is HAL.UInt16;
   ...
   subtype EMAC_SA2T_ADDR_Field is HAL.UInt16;
   ...
   subtype EMAC_SA3T_ADDR_Field is HAL.UInt16;
   ...
   subtype EMAC_SA4T_ADDR_Field is HAL.UInt16;
   ...
   subtype EMAC_TID_TID_Field is HAL.UInt16;
