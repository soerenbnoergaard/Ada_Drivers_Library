--  This spec has been automatically generated from ATSAM4C16C_0.svd
...
package SAM_SVD.SYSC is
   ...
   --  Low Power Debouncer Tamper Status on WKUP14/TMP2 (cleared on read)
   ...
   --  Low Power Debouncer Tamper Status on WKUP15/TMP3 (cleared on read)
   ...
   type SUPC_SR_Register is record
      ...
      LCDS           : SR_LCDS_Field;
      --  Read-only. Low Power Debouncer Tamper Status on WKUP14/TMP2 (cleared
      --  on read)
      LPDBCS2        : SR_LPDBCS2_Field;
      --  Read-only. Low Power Debouncer Tamper Status on WKUP15/TMP3 (cleared
      --  on read)
