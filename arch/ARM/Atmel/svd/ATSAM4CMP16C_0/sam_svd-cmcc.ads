...
package SAM_SVD.CMCC is
   ...
   type CMCC0_TYPE_Register is record
      --  unspecified
   ...
   for CMCC0_TYPE_Register use record
   ...
   type CMCC0_CTRL_Register is record
   ...
   for CMCC0_CTRL_Register use record
      CEN           at 0 range 0 .. 0;
      Reserved_1_31 at 0 range 1 .. 31;
   end record;

   --  Cache Controller Status Register
   type CMCC0_SR_Register is record
   ...
   for CMCC0_SR_Register use record
      CSTS          at 0 range 0 .. 0;
      Reserved_1_31 at 0 range 1 .. 31;
   end record;

   --  Cache Controller Maintenance Register 0
   type CMCC0_MAINT0_Register is record
   ...
   for CMCC0_MAINT0_Register use record
      INVALL        at 0 range 0 .. 0;
      Reserved_1_31 at 0 range 1 .. 31;
   end record;

   subtype CMCC0_MAINT1_INDEX_Field is HAL.UInt5;
   ...
   type CMCC0_MAINT1_Register is record
      --  unspecified
      Reserved_0_3  : HAL.UInt4 := 16#0#;
      --  Write-only. Invalidate Index
      INDEX         : CMCC0_MAINT1_INDEX_Field := 16#0#;
      --  unspecified
   ...
   for CMCC0_MAINT1_Register use record
   ...
   type CMCC0_MCFG_Register is record
      --  Cache Controller Monitor Counter Mode
   ...
   for CMCC0_MCFG_Register use record
      MODE          at 0 range 0 .. 1;
      Reserved_2_31 at 0 range 2 .. 31;
   end record;

   --  Cache Controller Monitor Enable Register
   type CMCC0_MEN_Register is record
   ...
   for CMCC0_MEN_Register use record
      MENABLE       at 0 range 0 .. 0;
      Reserved_1_31 at 0 range 1 .. 31;
   end record;

   --  Cache Controller Monitor Control Register
   type CMCC0_MCTRL_Register is record
      --  Write-only. Monitor
      SWRST         : Boolean := False;
      --  unspecified
      Reserved_1_31 : HAL.UInt31 := 16#0#;
   ...
   for CMCC0_MCTRL_Register use record
   ...
   type CMCC_Peripheral is record
      --  Cache Controller Type Register
      TYPE_k : aliased CMCC0_TYPE_Register;
      --  Cache Controller Control Register
      CTRL   : aliased CMCC0_CTRL_Register;
      --  Cache Controller Status Register
      SR     : aliased CMCC0_SR_Register;
      --  Cache Controller Maintenance Register 0
      MAINT0 : aliased CMCC0_MAINT0_Register;
      --  Cache Controller Maintenance Register 1
      MAINT1 : aliased CMCC0_MAINT1_Register;
      --  Cache Controller Monitor Configuration Register
      MCFG   : aliased CMCC0_MCFG_Register;
      --  Cache Controller Monitor Enable Register
      MEN    : aliased CMCC0_MEN_Register;
      --  Cache Controller Monitor Control Register
      MCTRL  : aliased CMCC0_MCTRL_Register;
   ...
   --  Cortex-M Cache Controller 0
   CMCC0_Periph : aliased CMCC_Peripheral
     with Import, Address => System'To_Address (16#4007C000#);

   --  Cortex-M Cache Controller 1
   CMCC1_Periph : aliased CMCC_Peripheral
     with Import, Address => System'To_Address (16#48018000#);
