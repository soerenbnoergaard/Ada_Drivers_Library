...
package SAM_SVD.MATRIX is
   ...
   --  Master Configuration Register
   type MATRIX0_MCFG_Registers is array (0 .. 6) of MATRIX0_MCFG_Register
     with Volatile;
   ...
   --  Slave Configuration Register
   type MATRIX0_SCFG_Registers is array (0 .. 7) of MATRIX0_SCFG_Register
     with Volatile;
   ...
   for MATRIX_Peripheral use record
      MCFG       at 16#0# range 0 .. 223;
      SCFG       at 16#40# range 0 .. 255;
