...
package SAM_SVD.USART is
   ...
   type USART0_CSR_Register is record
      --  Read-only. Receiver Ready (automatically set / reset)
      RXRDY          : Boolean;
      --  Read-only. Transmitter Ready (automatically set / reset)
      TXRDY          : Boolean;
      ...
      TIMEOUT        : Boolean;
      --  Read-only. Transmitter Empty (automatically set / reset)
      TXEMPTY        : Boolean;
