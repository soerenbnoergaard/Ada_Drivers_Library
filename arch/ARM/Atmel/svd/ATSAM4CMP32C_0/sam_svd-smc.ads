...
package SAM_SVD.SMC is
   ...
   type MODE_Register is record
      ...
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  Byte Access Type
      BAT            : MODE0_BAT_Field := SAM_SVD.SMC.Byte_Select;
      --  unspecified
      ...
      --  Page Size
      PS             : MODE0_PS_Field := SAM_SVD.SMC.MODE0_PS_Field_8_Byte;
      --  unspecified
      Reserved_30_31 : HAL.UInt2 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type SMC0_OCMS_Register is record
      --  Static Memory Controller Scrambling
      --  EnableSAM4C0x00030003CS0SECS1SECS1SECS2SECS3SE
      SMSE           : Boolean := False;
      --  unspecified
