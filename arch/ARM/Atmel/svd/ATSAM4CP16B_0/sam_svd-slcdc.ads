...
package SAM_SVD.SLCDC is
   ...
   type SLCDC_MR_Register is record
      ...
      --  Low Power Mode (Taken into account from the next begin of frame.)
   ...
   type SLCDC_FRR_Register is record
      --  Clock Prescaler
      PRESC          : FRR_PRESC_Field := SAM_SVD.SLCDC.Sclk_Div8;
      --  unspecified
      Reserved_3_7   : HAL.UInt5 := 16#0#;
      --  Clock Division
   ...
   type DR_DISPMODE_Field is
     (
      ...
      --  unchanged.)
      Force_On,
      --  Blinking Mode: All pixels are alternately turned off to the
      --  predefined state in SLCDC memory at LCDBLKFREQ frequency. (The SLCDC
      --  memory is unchanged.)
      Blinking,
   ...
   type SLCDC_IER_Register is record
      ...
      --  Write-only. Disable Interrupt Enable
      DIS           : Boolean := False;
      --  unspecified
   ...
   type SLCDC_IDR_Register is record
      ...
      --  unspecified
      Reserved_1_1  : HAL.Bit := 16#0#;
      --  Write-only. Disable Interrupt Disable
      DIS           : Boolean := False;
      --  unspecified
      Reserved_3_31 : HAL.UInt29 := 16#0#;
   end record
   ...
   type SLCDC_IMR_Register is record
      --  Write-only. End of Frame Interrupt Mask
      ENDFRAME      : Boolean := False;
      --  unspecified
      Reserved_1_1  : HAL.Bit := 16#0#;
      --  Write-only. Disable Interrupt Mask
      DIS           : Boolean := False;
      --  unspecified
      Reserved_3_31 : HAL.UInt29 := 16#0#;
   end record
   ...
   type SLCDC_ISR_Register is record
      ...
      --  Read-only. Disable Interrupt Mask
      DIS           : Boolean;
      --  unspecified
   ...
   subtype SLCDC_WPMR_WPKEY_Field is HAL.UInt24;

   --  SLCDC Write Protect Mode Register
   type SLCDC_WPMR_Register is record
      ...
      --  Write Protect KEY
      WPKEY        : SLCDC_WPMR_WPKEY_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   --  SLCDC Write Protect Status Register
