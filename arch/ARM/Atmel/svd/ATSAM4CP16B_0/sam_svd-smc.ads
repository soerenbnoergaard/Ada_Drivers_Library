...
package SAM_SVD.SMC is
   ...
   type SETUP_Register is record
      --  NWE Setup Length
      NWE_SETUP      : SETUP_NWE_SETUP_Field := 16#0#;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  NCS Setup Length in WRITE Access
      NCS_WR_SETUP   : SETUP_NCS_WR_SETUP_Field := 16#0#;
      --  unspecified
      Reserved_14_15 : HAL.UInt2 := 16#0#;
      --  NRD Setup Length
      NRD_SETUP      : SETUP_NRD_SETUP_Field := 16#0#;
      --  unspecified
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  NCS Setup Length in READ Access
      NCS_RD_SETUP   : SETUP_NCS_RD_SETUP_Field := 16#0#;
      --  unspecified
   ...
   type PULSE_Register is record
      --  NWE Pulse Length
      NWE_PULSE      : PULSE_NWE_PULSE_Field := 16#0#;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  NCS Pulse Length in WRITE Access
      NCS_WR_PULSE   : PULSE_NCS_WR_PULSE_Field := 16#0#;
      --  unspecified
      Reserved_15_15 : HAL.Bit := 16#0#;
      --  NRD Pulse Length
      NRD_PULSE      : PULSE_NRD_PULSE_Field := 16#0#;
      --  unspecified
      Reserved_23_23 : HAL.Bit := 16#0#;
      --  NCS Pulse Length in READ Access
      NCS_RD_PULSE   : PULSE_NCS_RD_PULSE_Field := 16#0#;
      --  unspecified
   ...
   type CYCLE_Register is record
      ...
      NWE_CYCLE      : CYCLE_NWE_CYCLE_Field := 16#0#;
      --  unspecified
      Reserved_9_15  : HAL.UInt7 := 16#0#;
      --  Total Read Cycle Length
      NRD_CYCLE      : CYCLE_NRD_CYCLE_Field := 16#0#;
      --  unspecified
   ...
   type MODE_Register is record
      ...
      --  NWAIT Mode
      EXNW_MODE      : MODE0_EXNW_MODE_Field := SAM_SVD.SMC.Disabled;
      --  unspecified
      Reserved_6_11  : HAL.UInt6 := 16#0#;
      --  Data Bus Width
      DBW            : MODE0_DBW_Field := SAM_SVD.SMC.MODE0_DBW_Field_8_Bit;
      --  unspecified
      ...
      --  Page Size
      PS             : MODE0_PS_Field := SAM_SVD.SMC.MODE0_PS_Field_4_Byte;
      --  unspecified
      Reserved_30_31 : HAL.UInt2 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type SMC0_OCMS_Register is record
   ...
   for SMC0_OCMS_Register use record
      SMSE           at 0 range 0 .. 0;
   ...
   subtype SMC0_WPMR_WPKEY_Field is HAL.UInt24;

   --  SMC Write Protect Mode Register
   type SMC0_WPMR_Register is record
      --  Write Protect Enable
      WPEN         : Boolean := False;
      --  unspecified
      Reserved_1_7 : HAL.UInt7 := 16#0#;
      --  Write Protect KEY
      WPKEY        : SMC0_WPMR_WPKEY_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for SMC0_WPMR_Register use record
      WPEN         at 0 range 0 .. 0;
      Reserved_1_7 at 0 range 1 .. 7;
      WPKEY        at 0 range 8 .. 31;
   end record;

   subtype SMC0_WPSR_WPVSRC_Field is HAL.UInt16;

   --  SMC Write Protect Status Register
   type SMC0_WPSR_Register is record
      --  Read-only. Write Protect Enable
      WPVS           : Boolean;
      --  unspecified
      Reserved_1_7   : HAL.UInt7;
      --  Read-only. Write Protect Violation Source
      WPVSRC         : SMC0_WPSR_WPVSRC_Field;
      --  unspecified
   ...
   for SMC0_WPSR_Register use record
      WPVS           at 0 range 0 .. 0;
      Reserved_1_7   at 0 range 1 .. 7;
   ...
   type SMC_Peripheral is record
      ...
      --  SMC OCMS MODE Register
      OCMS   : aliased SMC0_OCMS_Register;
      --  SMC OCMS KEY1 Register
      KEY1   : aliased HAL.UInt32;
      --  SMC OCMS KEY2 Register
      KEY2   : aliased HAL.UInt32;
      --  SMC Write Protect Mode Register
      WPMR   : aliased SMC0_WPMR_Register;
      --  SMC Write Protect Status Register
      WPSR   : aliased SMC0_WPSR_Register;
   end record
     with Volatile;
   ...
   --  Static Memory Controller 0
   SMC0_Periph : aliased SMC_Peripheral
     with Import, Address => System'To_Address (16#400E0000#);

   --  Static Memory Controller 1
   SMC1_Periph : aliased SMC_Peripheral
     with Import, Address => System'To_Address (16#4801C000#);
