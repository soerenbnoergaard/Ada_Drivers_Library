--  This spec has been automatically generated from ATSAM4CP16B_0.svd
...
package SAM_SVD.SYSC is
   ...
   subtype RSTC_CPMR_CPKEY_Field is HAL.UInt8;
   ...
   type RSTC_CPMR_Register is record
      ...
      CPKEY         : RSTC_CPMR_CPKEY_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype RSWDT_CR_KEY_Field is HAL.UInt8;
   ...
   type RTC_TSTR0_Register is record
      ...
      --  Read-only. AMPM indicator of the tamper
      AMPM           : Boolean;
      --  unspecified
   ...
   type SUPC_MR_Register is record
      ...
      --  Backup Area Power-On Reset Enable
      BUPPOREN       : MR_BUPPOREN_Field := SAM_SVD.SYSC.Buppor_Enable;
      --  unspecified
   ...
   type WUMR_LPDBCCLR_Field is
     (
      ...
      Not_Enable,
      --  A low-power debounce event on WKUP0/TMP0 or WKUP10/14/15/TMP1/2/3 (if
      --  DISTMPCLR1/2/3 is cleared) generates an immediate clear on the first
   ...
   type WUMR_LPDBC_Field is
     (
      ...
      Disable,
      --  WKUP0/10/14/15/TMP0/1/2/3 in active state for at least 2 RTCOUT0
      --  periods
      WUMR_LPDBC_Field_2_Rtcout0,
      --  WKUP0/10/14/15/TMP0/1/2/3 in active state for at least 3 RTCOUT0
      --  periods
      WUMR_LPDBC_Field_3_Rtcout0,
      --  WKUP0/10/14/15/TMP0/1/2/3 in active state for at least 4 RTCOUT0
      --  periods
      WUMR_LPDBC_Field_4_Rtcout0,
      --  WKUP0/10/14/15/TMP0/1/2/3 in active state for at least 5 RTCOUT0
      --  periods
      WUMR_LPDBC_Field_5_Rtcout0,
      --  WKUP0/10/14/15/TMP0/1/2/3 in active state for at least 6 RTCOUT0
      --  periods
      WUMR_LPDBC_Field_6_Rtcout0,
      --  WKUP0/10/14/15/TMP0/1/2/3 in active state for at least 7 RTCOUT0
      --  periods
      WUMR_LPDBC_Field_7_Rtcout0,
      --  WKUP0/10/14/15/TMP0/1/2/3 in active state for at least 8 RTCOUT0
      --  periods
   ...
   --  Low Power Debouncer Enable WKUP14/TMP2
   type WUMR_LPDBCEN2_Field is
     (
      --  The WKUP14/TMP2 input pin is not connected to the low-power
      --  debouncer.
      Not_Enable,
      --  The WKUP14/TMP2 input pin is connected to the low-power debouncer and
      --  can force a system wake-up.
      Enable)
     with Size => 1;
   for WUMR_LPDBCEN2_Field use
     (Not_Enable => 0,
      Enable => 1);

   --  Low Power Debouncer Enable WKUP15/TMP3
   type WUMR_LPDBCEN3_Field is
     (
      --  The WKUP15/TMP3 input pin is not connected to the low-power
      --  debouncer.
      Not_Enable,
      --  The WKUP15/TMP3 input pin is connected to the low-power debouncer and
      --  can force a system wake-up.
      Enable)
     with Size => 1;
   for WUMR_LPDBCEN3_Field use
     (Not_Enable => 0,
      Enable => 1);
   ...
   --  Disable GPBR Clear Command from WKUP14/TMP2 Pin
   type WUMR_DISTMPCLR2_Field is
     (
      --  The WKUP14/TMP2 input pin can clear the GPBR (if LPDBCCLR is enabled)
      --  when tamper is detected.
      Enable,
      --  The WKUP14/TMP2 input pin has no effect on the GPBR value (no clear
      --  on tamper detection).
      Disable)
     with Size => 1;
   for WUMR_DISTMPCLR2_Field use
     (Enable => 0,
      Disable => 1);

   --  Disable GPBR Clear Command from WKUP15/TMP3 Pin
   type WUMR_DISTMPCLR3_Field is
     (
      --  The WKUP15/TMP3 input pin can clear the GPBR (if LPDBCCLR is enabled)
      --  when tamper is detected.
      Enable,
      --  The WKUP15/TMP3 input pin has no effect on the GPBR value (no clear
      --  on tamper detection).
      Disable)
     with Size => 1;
   for WUMR_DISTMPCLR3_Field use
     (Enable => 0,
      Disable => 1);
   ...
   --  Disable Timestamp from WKUP14/TMP2 Pin
   type WUMR_DISTSTMP2_Field is
     (
      --  A tamper detection on WKUP14/TMP2 pin generates a timestamp.
      Enable,
      --  A tamper detection on WKUP14/TMP2 does NOT generate a report in
      --  timestamp register.
      Disable)
     with Size => 1;
   for WUMR_DISTSTMP2_Field use
     (Enable => 0,
      Disable => 1);

   --  Disable Timestamp from WKUP15/TMP3 Pin
   type WUMR_DISTSTMP3_Field is
     (
      --  A tamper detection on WKUP15/TMP3 pin generates a timestamp.
      Enable,
      --  A tamper detection on WKUP15/TMP3 does NOT generate a report in
      --  timestamp register.
      Disable)
     with Size => 1;
   for WUMR_DISTSTMP3_Field use
     (Enable => 0,
      Disable => 1);
   ...
   type SUPC_WUMR_Register is record
      ...
      Reserved_19_19 : HAL.Bit := 16#0#;
      --  Low Power Debouncer Enable WKUP14/TMP2
      LPDBCEN2       : WUMR_LPDBCEN2_Field := SAM_SVD.SYSC.Not_Enable;
      --  Low Power Debouncer Enable WKUP15/TMP3
      LPDBCEN3       : WUMR_LPDBCEN3_Field := SAM_SVD.SYSC.Not_Enable;
      --  unspecified
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  Disable GPBR Clear Command from WKUP10/TMP1 pin
      DISTMPCLR1     : WUMR_DISTMPCLR1_Field := SAM_SVD.SYSC.Enable;
      --  Disable GPBR Clear Command from WKUP14/TMP2 Pin
      DISTMPCLR2     : WUMR_DISTMPCLR2_Field := SAM_SVD.SYSC.Enable;
      --  Disable GPBR Clear Command from WKUP15/TMP3 Pin
      DISTMPCLR3     : WUMR_DISTMPCLR3_Field := SAM_SVD.SYSC.Enable;
      --  unspecified
      Reserved_27_27 : HAL.Bit := 16#0#;
      --  Disable Timestamp from WKUP10/TMP1 Pin
      DISTSTMP1      : WUMR_DISTSTMP1_Field := SAM_SVD.SYSC.Enable;
      --  Disable Timestamp from WKUP14/TMP2 Pin
      DISTSTMP2      : WUMR_DISTSTMP2_Field := SAM_SVD.SYSC.Enable;
      --  Disable Timestamp from WKUP15/TMP3 Pin
      DISTSTMP3      : WUMR_DISTSTMP3_Field := SAM_SVD.SYSC.Enable;
      --  unspecified
   ...
   for SUPC_WUMR_Register use record
      ...
      Reserved_19_19 at 0 range 19 .. 19;
      LPDBCEN2       at 0 range 20 .. 20;
      LPDBCEN3       at 0 range 21 .. 21;
      Reserved_22_23 at 0 range 22 .. 23;
      DISTMPCLR1     at 0 range 24 .. 24;
      DISTMPCLR2     at 0 range 25 .. 25;
      DISTMPCLR3     at 0 range 26 .. 26;
      Reserved_27_27 at 0 range 27 .. 27;
      DISTSTMP1      at 0 range 28 .. 28;
      DISTSTMP2      at 0 range 29 .. 29;
      DISTSTMP3      at 0 range 30 .. 30;
   ...
   type WUIR_WKUPT0_Field is
     (
      ...
      --  wake-up input forces a system wake-up.
      Low,
   ...
   --  Low Power Debouncer Tamper Status on WKUP14/TMP2
   type SR_LPDBCS2_Field is
     (
      --  No tamper detection or wake-up due to the assertion of the
      --  WKUP14/TMP2 pin has occurred since the last read of SUPC_SR.
      No,
      --  At least one tamper detection and wake-up (if enabled by WKUPEN14)
      --  due to the assertion of the WKUP14/TMP2 pin has occurred since the
      --  last read of SUPC_SR. The SUPC interrupt line is asserted while
      --  LPDBCS2 is 1.
      Present)
     with Size => 1;
   for SR_LPDBCS2_Field use
     (No => 0,
      Present => 1);

   --  Low Power Debouncer Tamper Status on WKUP15/TMP3
   type SR_LPDBCS3_Field is
     (
      --  No tamper detection or wake-up due to the assertion of the
      --  WKUP15/TMP3 pin has occurred since the last read of SUPC_SR.
      No,
      --  At least one tamper detection and wake-up (if enabled by WKUPEN15)
      --  due to the assertion of the WKUP15/TMP3 pin has occurred since the
      --  last read of SUPC_SR. The SUPC interrupt line is asserted while
      --  LPDBCS2 is 1.
      Present)
     with Size => 1;
   for SR_LPDBCS3_Field use
     (No => 0,
      Present => 1);
   ...
   --  Low Power Debouncer Wake-up Status on WKUP0/TMP0
   ...
   --  Low Power Debouncer Wake-up Status on WKUP10/TMP1
   ...
   type SUPC_SR_Register is record
      ...
      LCDS           : SR_LCDS_Field;
      --  Read-only. Low Power Debouncer Tamper Status on WKUP14/TMP2
      LPDBCS2        : SR_LPDBCS2_Field;
      --  Read-only. Low Power Debouncer Tamper Status on WKUP15/TMP3
      LPDBCS3        : SR_LPDBCS3_Field;
      --  unspecified
      Reserved_11_11 : HAL.Bit;
      --  Read-only. FWUP Input Status
      FWUPIS         : SR_FWUPIS_Field;
      --  Read-only. Low Power Debouncer Wake-up Status on WKUP0/TMP0
      LPDBCS0        : SR_LPDBCS0_Field;
      --  Read-only. Low Power Debouncer Wake-up Status on WKUP10/TMP1
      LPDBCS1        : SR_LPDBCS1_Field;
      --  Read-only. Backup Area Power-On Reset Status
      BUPPORS        : SR_BUPPORS_Field;
      --  Read-only. WKUPx Input Status
   ...
   for SUPC_SR_Register use record
      ...
      LCDS           at 0 range 8 .. 8;
      LPDBCS2        at 0 range 9 .. 9;
      LPDBCS3        at 0 range 10 .. 10;
      Reserved_11_11 at 0 range 11 .. 11;
