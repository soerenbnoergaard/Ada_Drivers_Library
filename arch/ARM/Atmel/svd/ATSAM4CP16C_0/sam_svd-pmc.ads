...
package SAM_SVD.PMC is
   ...
   --  PMC_PCER0_PID array
   type PMC_PCER0_PID_Field_Array is array (8 .. 21) of Boolean
   ...
   --  PMC_PCER0_PID array
   type PMC_PCER0_PID_Field_Array_1 is array (23 .. 29) of Boolean
   ...
   for PMC_PCER0_Register use record
      ...
      PID_1          at 0 range 23 .. 29;
      Reserved_30_30 at 0 range 30 .. 30;
      PID31          at 0 range 31 .. 31;
   end record;

   --  PMC_PCDR0_PID array
   type PMC_PCDR0_PID_Field_Array is array (8 .. 21) of Boolean
     with Component_Size => 1, Size => 14;
   ...
   --  PMC_PCDR0_PID array
   type PMC_PCDR0_PID_Field_Array_1 is array (23 .. 29) of Boolean
     with Component_Size => 1, Size => 7;
   ...
   --  PMC_PCSR0_PID array
   type PMC_PCSR0_PID_Field_Array is array (8 .. 21) of Boolean
     with Component_Size => 1, Size => 14;
   ...
   --  PMC_PCSR0_PID array
   type PMC_PCSR0_PID_Field_Array_1 is array (23 .. 29) of Boolean
     with Component_Size => 1, Size => 7;
   ...
   --  Coprocessor Fast Start-up Mode Register
