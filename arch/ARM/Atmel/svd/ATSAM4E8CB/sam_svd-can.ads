...
package SAM_SVD.CAN is
   ...
   subtype CAN0_BR_PHASE2_Field is HAL.UInt3;
   subtype CAN0_BR_PHASE1_Field is HAL.UInt3;
   subtype CAN0_BR_PROPAG_Field is HAL.UInt3;
   subtype CAN0_BR_SJW_Field is HAL.UInt2;
   subtype CAN0_BR_BRP_Field is HAL.UInt7;
   ...
   type BR_SMP_Field is
     (
      ...
      Once,
      --  The incoming bit stream is sampled three times with a period of a
      --  peripheral clock, centered on sample point.
      Three)
     with Size => 1;
   ...
   type CAN0_BR_Register is record
      ...
      --  Sampling Mode
      SMP            : BR_SMP_Field := SAM_SVD.CAN.Once;
      --  unspecified
   ...
   subtype CAN0_TIM_TIMER_Field is HAL.UInt16;
   ...
   subtype CAN0_TIMESTP_MTIMESTAMP_Field is HAL.UInt16;
   ...
   subtype CAN0_ECR_REC_Field is HAL.UInt8;
   subtype CAN0_ECR_TEC_Field is HAL.UInt9;
   ...
   subtype CAN0_WPSR_WPVSRC_Field is HAL.UInt8;
   ...
   subtype MMR_MTIMEMARK_Field is HAL.UInt16;
   subtype MMR_PRIOR_Field is HAL.UInt4;
   ...
   type MMR_Register is record
      ...
      --  Mailbox Object Type
      MOT            : MMR0_MOT_Field := SAM_SVD.CAN.Mb_Disabled;
      --  unspecified
   ...
   subtype MAM_MIDvB_Field is HAL.UInt18;
   subtype MAM_MIDvA_Field is HAL.UInt11;
   ...
   subtype MID_MIDvB_Field is HAL.UInt18;
   subtype MID_MIDvA_Field is HAL.UInt11;
   ...
   subtype MFID_MFID_Field is HAL.UInt29;
   ...
   subtype MSR_MTIMESTAMP_Field is HAL.UInt16;
   subtype MSR_MDLC_Field is HAL.UInt4;
   ...
   subtype MCR_MDLC_Field is HAL.UInt4;
   ...
   type CAN_Peripheral is record
      ...
      MDL0    : aliased HAL.UInt32;
      --  Mailbox Data High Register (MB = 0)
      MDH0    : aliased HAL.UInt32;
      --  Mailbox Control Register (MB = 0)
      ...
      MDL1    : aliased HAL.UInt32;
      --  Mailbox Data High Register (MB = 1)
      MDH1    : aliased HAL.UInt32;
      ...
      MDL2    : aliased HAL.UInt32;
      --  Mailbox Data High Register (MB = 2)
      MDH2    : aliased HAL.UInt32;
      ...
      MDL3    : aliased HAL.UInt32;
      --  Mailbox Data High Register (MB = 3)
      MDH3    : aliased HAL.UInt32;
      ...
      MDL4    : aliased HAL.UInt32;
      --  Mailbox Data High Register (MB = 4)
      MDH4    : aliased HAL.UInt32;
      ...
      MDL5    : aliased HAL.UInt32;
      --  Mailbox Data High Register (MB = 5)
      MDH5    : aliased HAL.UInt32;
      ...
      MDL6    : aliased HAL.UInt32;
      --  Mailbox Data High Register (MB = 6)
      MDH6    : aliased HAL.UInt32;
      ...
      MDL7    : aliased HAL.UInt32;
      --  Mailbox Data High Register (MB = 7)
      MDH7    : aliased HAL.UInt32;
