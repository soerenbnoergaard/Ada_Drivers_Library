...
package SAM_SVD.MATRIX is
   ...
   --  Master Configuration Register
   type MATRIX_MCFG_Registers is array (0 .. 6) of MATRIX_MCFG_Register
     with Volatile;
   ...
   --  Slave Configuration Register
   type MATRIX_SCFG_Registers is array (0 .. 5) of MATRIX_SCFG_Register
     with Volatile;
   ...
   type MATRIX_PRAS_Register is record
      --  Master 0 Priority
      M0PR           : MATRIX_PRAS_M0PR_Field := 16#3#;
      --  unspecified
      Reserved_2_3   : HAL.UInt2 := 16#0#;
      --  Master 1 Priority
      M1PR           : MATRIX_PRAS_M1PR_Field := 16#3#;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  Master 2 Priority
      M2PR           : MATRIX_PRAS_M2PR_Field := 16#3#;
      --  unspecified
      Reserved_10_11 : HAL.UInt2 := 16#0#;
      --  Master 3 Priority
      M3PR           : MATRIX_PRAS_M3PR_Field := 16#3#;
      --  unspecified
      Reserved_14_15 : HAL.UInt2 := 16#0#;
      --  Master 4 Priority
      M4PR           : MATRIX_PRAS_M4PR_Field := 16#3#;
      --  unspecified
      Reserved_18_19 : HAL.UInt2 := 16#0#;
      --  Master 5 Priority
      M5PR           : MATRIX_PRAS_M5PR_Field := 16#3#;
      --  unspecified
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  Master 6 Priority
      M6PR           : MATRIX_PRAS_M6PR_Field := 16#3#;
      --  unspecified
      Reserved_26_31 : HAL.UInt6 := 16#C#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type MATRIX_MRCR_RCB_Field_Array is array (0 .. 6) of Boolean
   ...
   for MATRIX_Peripheral use record
      MATRIX_MCFG  at 16#0# range 0 .. 223;
      MATRIX_SCFG  at 16#40# range 0 .. 191;
