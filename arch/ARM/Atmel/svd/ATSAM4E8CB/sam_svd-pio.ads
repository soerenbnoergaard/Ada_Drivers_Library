...
package SAM_SVD.PIO is
   ...
   --  PIOA_DELAYR_Delay array element
   subtype PIOA_DELAYR_Delay_Element is HAL.UInt4;

   --  PIOA_DELAYR_Delay array
   type PIOA_DELAYR_Delay_Field_Array is array (0 .. 7)
     of PIOA_DELAYR_Delay_Element
     with Component_Size => 4, Size => 32;

   --  I/O Delay Register
   type PIOA_DELAYR_Register
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
         ...
         when True =>
            --  Delay as an array
            Arr : PIOA_DELAYR_Delay_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 32, Volatile_Full_Access,
          Bit_Order => System.Low_Order_First;

   for PIOA_DELAYR_Register use record
      Val at 0 range 0 .. 31;
      Arr at 0 range 0 .. 31;
   end record;
   ...
   type PIOA_Peripheral is record
      ...
      --  I/O Delay Register
      DELAYR  : aliased PIOA_DELAYR_Register;
      --  Parallel Capture Mode Register
