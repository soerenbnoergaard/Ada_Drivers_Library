...
package SAM_SVD.PWM is
   ...
   type SCM_UPDM_Field is
     (
      ...
      --  synchronous channels
      Mode1,
      --  Automatic write of duty-cycle update registers by the PDCPDC or DMA
   ...
   type PWM_SCM_Register is record
      ...
      --  PDCPDC or DMA Transfer Request Mode
      PTRM           : Boolean := False;
      --  PDCPDC or DMA Transfer Request Comparison Selection
