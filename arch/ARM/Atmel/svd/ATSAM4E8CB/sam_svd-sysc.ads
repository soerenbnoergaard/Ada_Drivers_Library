...
package SAM_SVD.SYSC is
   ...
   --  General Purpose Backup Register
   type GPBR_GPBR_Registers is array (0 .. 19) of HAL.UInt32
     with Volatile;
   ...
   type WUMR_LPDBCEN0_Field is
     (
      ...
      Not_Enable,
      --  The WKUP0 input pin is connected with low-power debouncer and forces
      --  a system wake-up.
      Enable)
     with Size => 1;
   ...
   type WUMR_LPDBCEN1_Field is
     (
      ...
      Not_Enable,
      --  The WKUP1 input pin is connected with low-power debouncer and forces
      --  a system wake-up.
      Enable)
     with Size => 1;
