--  This spec has been automatically generated from ATSAM4E8CB.svd
...
package SAM_SVD.TC is
   ...
   type TC0_CMR0_WAVE_EQ_1_Register is record
      --  Clock Selection
      TCCLKS  : CMR0_WAVE_EQ_1_TCCLKS_Field := SAM_SVD.TC.Timer_Clock1;
      --  Clock Invert
      CLKI    : Boolean := False;
      --  Burst Signal Selection
      BURST   : CMR0_WAVE_EQ_1_BURST_Field := SAM_SVD.TC.None;
      --  Counter Clock Stopped with RC Compare
      CPCSTOP : Boolean := False;
      --  Counter Clock Disable with RC Compare
      CPCDIS  : Boolean := False;
      --  External Event Edge Selection
      EEVTEDG : CMR0_WAVE_EQ_1_EEVTEDG_Field := SAM_SVD.TC.None;
      --  External Event Selection
      EEVT    : CMR0_WAVE_EQ_1_EEVT_Field := SAM_SVD.TC.Tiob;
      --  External Event Trigger Enable
      ENETRG  : Boolean := False;
      --  Waveform Selection
      WAVSEL  : CMR0_WAVE_EQ_1_WAVSEL_Field := SAM_SVD.TC.Up;
      --  Waveform Mode
      WAVE    : Boolean := False;
      --  RA Compare Effect on TIOA
      ACPA    : CMR0_WAVE_EQ_1_ACPA_Field := SAM_SVD.TC.None;
      --  RC Compare Effect on TIOA
      ACPC    : CMR0_WAVE_EQ_1_ACPC_Field := SAM_SVD.TC.None;
      --  External Event Effect on TIOA
      AEEVT   : CMR0_WAVE_EQ_1_AEEVT_Field := SAM_SVD.TC.None;
      --  Software Trigger Effect on TIOA
      ASWTRG  : CMR0_WAVE_EQ_1_ASWTRG_Field := SAM_SVD.TC.None;
      --  RB Compare Effect on TIOB
      BCPB    : CMR0_WAVE_EQ_1_BCPB_Field := SAM_SVD.TC.None;
      --  RC Compare Effect on TIOB
      BCPC    : CMR0_WAVE_EQ_1_BCPC_Field := SAM_SVD.TC.None;
      --  External Event Effect on TIOB
      BEEVT   : CMR0_WAVE_EQ_1_BEEVT_Field := SAM_SVD.TC.None;
      --  Software Trigger Effect on TIOB
      BSWTRG  : CMR0_WAVE_EQ_1_BSWTRG_Field := SAM_SVD.TC.None;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type EMR0_TRIGSRCB_Field is
     (
      ...
      External_Tiobx,
      --  The trigger/capture input B is driven internally by PWMx
      Pwmx)
     with Size => 2;
   ...
   type TC0_CMR1_WAVE_EQ_1_Register is record
      --  Clock Selection
      TCCLKS  : CMR1_WAVE_EQ_1_TCCLKS_Field := SAM_SVD.TC.Timer_Clock1;
      --  Clock Invert
      CLKI    : Boolean := False;
      --  Burst Signal Selection
      BURST   : CMR1_WAVE_EQ_1_BURST_Field := SAM_SVD.TC.None;
      --  Counter Clock Stopped with RC Compare
      CPCSTOP : Boolean := False;
      --  Counter Clock Disable with RC Compare
      CPCDIS  : Boolean := False;
      --  External Event Edge Selection
      EEVTEDG : CMR1_WAVE_EQ_1_EEVTEDG_Field := SAM_SVD.TC.None;
      --  External Event Selection
      EEVT    : CMR1_WAVE_EQ_1_EEVT_Field := SAM_SVD.TC.Tiob;
      --  External Event Trigger Enable
      ENETRG  : Boolean := False;
      --  Waveform Selection
      WAVSEL  : CMR1_WAVE_EQ_1_WAVSEL_Field := SAM_SVD.TC.Up;
      --  Waveform Mode
      WAVE    : Boolean := False;
      --  RA Compare Effect on TIOA
      ACPA    : CMR1_WAVE_EQ_1_ACPA_Field := SAM_SVD.TC.None;
      --  RC Compare Effect on TIOA
      ACPC    : CMR1_WAVE_EQ_1_ACPC_Field := SAM_SVD.TC.None;
      --  External Event Effect on TIOA
      AEEVT   : CMR1_WAVE_EQ_1_AEEVT_Field := SAM_SVD.TC.None;
      --  Software Trigger Effect on TIOA
      ASWTRG  : CMR1_WAVE_EQ_1_ASWTRG_Field := SAM_SVD.TC.None;
      --  RB Compare Effect on TIOB
      BCPB    : CMR1_WAVE_EQ_1_BCPB_Field := SAM_SVD.TC.None;
      --  RC Compare Effect on TIOB
      BCPC    : CMR1_WAVE_EQ_1_BCPC_Field := SAM_SVD.TC.None;
      --  External Event Effect on TIOB
      BEEVT   : CMR1_WAVE_EQ_1_BEEVT_Field := SAM_SVD.TC.None;
      --  Software Trigger Effect on TIOB
      BSWTRG  : CMR1_WAVE_EQ_1_BSWTRG_Field := SAM_SVD.TC.None;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type TC0_CMR2_WAVE_EQ_1_Register is record
      --  Clock Selection
      TCCLKS  : CMR2_WAVE_EQ_1_TCCLKS_Field := SAM_SVD.TC.Timer_Clock1;
      --  Clock Invert
      CLKI    : Boolean := False;
      --  Burst Signal Selection
      BURST   : CMR2_WAVE_EQ_1_BURST_Field := SAM_SVD.TC.None;
      --  Counter Clock Stopped with RC Compare
      CPCSTOP : Boolean := False;
      --  Counter Clock Disable with RC Compare
      CPCDIS  : Boolean := False;
      --  External Event Edge Selection
      EEVTEDG : CMR2_WAVE_EQ_1_EEVTEDG_Field := SAM_SVD.TC.None;
      --  External Event Selection
      EEVT    : CMR2_WAVE_EQ_1_EEVT_Field := SAM_SVD.TC.Tiob;
      --  External Event Trigger Enable
      ENETRG  : Boolean := False;
      --  Waveform Selection
      WAVSEL  : CMR2_WAVE_EQ_1_WAVSEL_Field := SAM_SVD.TC.Up;
      --  Waveform Mode
      WAVE    : Boolean := False;
      --  RA Compare Effect on TIOA
      ACPA    : CMR2_WAVE_EQ_1_ACPA_Field := SAM_SVD.TC.None;
      --  RC Compare Effect on TIOA
      ACPC    : CMR2_WAVE_EQ_1_ACPC_Field := SAM_SVD.TC.None;
      --  External Event Effect on TIOA
      AEEVT   : CMR2_WAVE_EQ_1_AEEVT_Field := SAM_SVD.TC.None;
      --  Software Trigger Effect on TIOA
      ASWTRG  : CMR2_WAVE_EQ_1_ASWTRG_Field := SAM_SVD.TC.None;
      --  RB Compare Effect on TIOB
      BCPB    : CMR2_WAVE_EQ_1_BCPB_Field := SAM_SVD.TC.None;
      --  RC Compare Effect on TIOB
      BCPC    : CMR2_WAVE_EQ_1_BCPC_Field := SAM_SVD.TC.None;
      --  External Event Effect on TIOB
      BEEVT   : CMR2_WAVE_EQ_1_BEEVT_Field := SAM_SVD.TC.None;
      --  Software Trigger Effect on TIOB
      BSWTRG  : CMR2_WAVE_EQ_1_BSWTRG_Field := SAM_SVD.TC.None;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type TC0_BMR_Register is record
      ...
      --  Auto-Correction of missing pulses
      AUTOC          : BMR_AUTOC_Field := SAM_SVD.TC.Disabled;
      --  unspecified
   ...
   subtype RCR_RXCTR_Field is HAL.UInt16;
   ...
   subtype RNCR_RXNCTR_Field is HAL.UInt16;
   ...
   is record
      ...
      RPR0           : aliased HAL.UInt32;
      --  Receive Counter Register (pdc = 0)
      RCR0           : aliased RCR_Register;
      --  Receive Next Pointer Register (pdc = 0)
      RNPR0          : aliased HAL.UInt32;
      --  Receive Next Counter Register (pdc = 0)
      RNCR0          : aliased RNCR_Register;
      --  Transfer Control Register (pdc = 0)
      PTCR0          : aliased PTCR_Register;
      --  Transfer Status Register (pdc = 0)
      PTSR0          : aliased PTSR_Register;
      --  Receive Pointer Register (pdc = 1)
      RPR1           : aliased HAL.UInt32;
      --  Receive Counter Register (pdc = 1)
      RCR1           : aliased RCR_Register;
      --  Receive Next Pointer Register (pdc = 1)
      RNPR1          : aliased HAL.UInt32;
      --  Receive Next Counter Register (pdc = 1)
      RNCR1          : aliased RNCR_Register;
      --  Transfer Control Register (pdc = 1)
      PTCR1          : aliased PTCR_Register;
      --  Transfer Status Register (pdc = 1)
      PTSR1          : aliased PTSR_Register;
      --  Receive Pointer Register (pdc = 2)
      RPR2           : aliased HAL.UInt32;
      --  Receive Counter Register (pdc = 2)
      RCR2           : aliased RCR_Register;
      --  Receive Next Pointer Register (pdc = 2)
      RNPR2          : aliased HAL.UInt32;
      --  Receive Next Counter Register (pdc = 2)
      RNCR2          : aliased RNCR_Register;
      --  Transfer Control Register (pdc = 2)
      PTCR2          : aliased PTCR_Register;
      --  Transfer Status Register (pdc = 2)
      PTSR2          : aliased PTSR_Register;
   ...
   for TC0_Peripheral use record
      ...
      RPR1           at 16#140# range 0 .. 31;
      RCR1           at 16#144# range 0 .. 31;
      RNPR1          at 16#150# range 0 .. 31;
      RNCR1          at 16#154# range 0 .. 31;
      PTCR1          at 16#160# range 0 .. 31;
      PTSR1          at 16#164# range 0 .. 31;
      RPR2           at 16#180# range 0 .. 31;
      RCR2           at 16#184# range 0 .. 31;
      RNPR2          at 16#190# range 0 .. 31;
      RNCR2          at 16#194# range 0 .. 31;
      PTCR2          at 16#1A0# range 0 .. 31;
      PTSR2          at 16#1A4# range 0 .. 31;
   ...
   --  Timer Counter 1
   TC1_Periph : aliased TC0_Peripheral
   ...
   --  Timer Counter 2
   TC2_Periph : aliased TC2_Peripheral
