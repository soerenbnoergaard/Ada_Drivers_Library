...
package SAM_SVD.TWI is
   ...
   subtype TWI0_WPROT_MODE_SECURITY_CODE_Field is HAL.UInt24;

   --  Protection Mode Register
   type TWI0_WPROT_MODE_Register is record
      --  Write protection bit
      WPROT         : Boolean := False;
      --  unspecified
      Reserved_1_7  : HAL.UInt7 := 16#0#;
      --  Write protection mode security code
      SECURITY_CODE : TWI0_WPROT_MODE_SECURITY_CODE_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for TWI0_WPROT_MODE_Register use record
      WPROT         at 0 range 0 .. 0;
      Reserved_1_7  at 0 range 1 .. 7;
      SECURITY_CODE at 0 range 8 .. 31;
   end record;

   subtype TWI0_WPROT_STATUS_WPROTADDR_Field is HAL.UInt24;

   --  Protection Status Register
   type TWI0_WPROT_STATUS_Register is record
      --  Read-only. Write Protection Error
      WPROTERR     : Boolean;
      --  unspecified
      Reserved_1_7 : HAL.UInt7;
      --  Read-only. Write Protection Error Address
      WPROTADDR    : TWI0_WPROT_STATUS_WPROTADDR_Field;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for TWI0_WPROT_STATUS_Register use record
      WPROTERR     at 0 range 0 .. 0;
      Reserved_1_7 at 0 range 1 .. 7;
      WPROTADDR    at 0 range 8 .. 31;
   end record;
   ...
   type TWI_Peripheral is record
      ...
      --  Protection Mode Register
      WPROT_MODE   : aliased TWI0_WPROT_MODE_Register;
      --  Protection Status Register
      WPROT_STATUS : aliased TWI0_WPROT_STATUS_Register;
   ...
   for TWI_Peripheral use record
      ...
      WPROT_MODE   at 16#E4# range 0 .. 31;
      WPROT_STATUS at 16#E8# range 0 .. 31;
