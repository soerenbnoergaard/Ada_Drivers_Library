...
--  This spec has been automatically generated from ATSAM4LC4B.svd
...
--  Atmel ATSAM4LC4B device: Cortex-M4 Microcontroller with 256KB Flash, 32KB
--  SRAM, 64-pin package (refer to http://www.atmel.com/devices/SAM4LC4B.aspx
--  for more)
package SAM_SVD is
   pragma Preelaborate;
