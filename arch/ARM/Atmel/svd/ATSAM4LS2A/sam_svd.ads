...
--  This spec has been automatically generated from ATSAM4LS2A.svd
...
--  Atmel ATSAM4LS2A device: Cortex-M4 Microcontroller with 128KB Flash, 32KB
--  SRAM, QFP48_noLCD-pin package (refer to
--  http://www.atmel.com/devices/SAM4LS2A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
