...
--  This spec has been automatically generated from ATSAM4LS4A.svd
...
--  Atmel ATSAM4LS4A device: Cortex-M4 Microcontroller with 256KB Flash, 32KB
--  SRAM, QFP48_noLCD-pin package (refer to
--  http://www.atmel.com/devices/SAM4LS4A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
