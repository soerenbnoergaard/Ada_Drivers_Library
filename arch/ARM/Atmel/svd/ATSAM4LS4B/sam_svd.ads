...
--  Atmel ATSAM4LS4B device: Cortex-M4 Microcontroller with 256KB Flash, 32KB
--  SRAM, QFP64_noLCD-pin package (refer to
--  http://www.atmel.com/devices/SAM4LS4B.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
