...
--  Atmel ATSAM4LS8C device: Cortex-M4 Microcontroller with 512KB Flash, 64KB
--  SRAM, QFP100_noLCD-pin package (refer to
--  http://www.atmel.com/devices/SAM4LS8C.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
