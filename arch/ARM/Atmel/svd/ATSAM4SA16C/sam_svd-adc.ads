...
package SAM_SVD.ADC is
   ...
   type MR_USEQ_Field is
     (
      ...
      --  ADC_SEQR1 and ADC_SEQR2 registers and can be used to convert the same
   ...
   subtype ADC_SEQR2_USCH_Element is HAL.UInt4;
   ...
   --  Gain for Channel 0
   type CGR_GAIN0_Field is
     (
      --  Single-ended gain = 1 (ADC_COR.DIFFx = 0), differential gain = 0.5
      --  (ADC_COR.DIFFx = 1)
      Se1_Diff0_5,
      --  Single-ended gain = 1 (ADC_COR.DIFFx = 0), differential gain = 1
      --  (ADC_COR.DIFFx = 1)
      Se1_Diff1,
      --  Single-ended gain = 2 (ADC_COR.DIFFx = 0), differential gain = 2
      --  (ADC_COR.DIFFx = 1)
      Se2_Diff2,
      --  Single-ended gain = 4 (ADC_COR.DIFFx = 0), differential gain = 2
      --  (ADC_COR.DIFFx = 1)
      Se4_Diff2)
     with Size => 2;
   for CGR_GAIN0_Field use
     (Se1_Diff0_5 => 0,
      Se1_Diff1 => 1,
      Se2_Diff2 => 2,
      Se4_Diff2 => 3);
   ...
   --  ADC_CGR_GAIN array
   type ADC_CGR_GAIN_Field_Array is array (0 .. 15) of CGR_GAIN0_Field
