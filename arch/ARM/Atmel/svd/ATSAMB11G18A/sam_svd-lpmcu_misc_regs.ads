...
package SAM_SVD.LPMCU_MISC_REGS is
   ...
   type LPMCU_GLOBAL_RESET_0_Register is record
      ...
      --  SPI1 Core Reset
      CORTUS_SPI1_CORE_RSTN : Boolean := True;
      --  SPI1 Interface Reset
      CORTUS_SPI1_IF_RSTN   : Boolean := True;
      --  I2C0 Core Reset
   ...
   for LPMCU_GLOBAL_RESET_0_Register use record
      ...
      CORTUS_SPI1_CORE_RSTN at 0 range 6 .. 6;
      CORTUS_SPI1_IF_RSTN   at 0 range 7 .. 7;
   ...
   type LPMCU_GLOBAL_RESET_1_Register is record
      ...
      --  SPI1 SCK Clock Reset
      CORTUS_SPI1_SCK_CLK_RSTN           : Boolean := True;
      --  SPI0 SCK Phase Clock Reset
      CORTUS_SPI0_SCK_PHASE_INT_CLK_RSTN : Boolean := True;
      --  SPI1 SCK Phase Clock Reset
      CORTUS_SPI1_SCK_PHASE_INT_CLK_RSTN : Boolean := True;
   ...
   for LPMCU_GLOBAL_RESET_1_Register use record
      ...
      CORTUS_SPI1_SCK_CLK_RSTN           at 0 range 8 .. 8;
      CORTUS_SPI0_SCK_PHASE_INT_CLK_RSTN at 0 range 9 .. 9;
      CORTUS_SPI1_SCK_PHASE_INT_CLK_RSTN at 0 range 10 .. 10;
   ...
   type LPMCU_CLOCK_ENABLES_0_Register is record
      ...
      --  SPI1 Core Clock Enable
      CORTUS_SPI1_CORE_CLK_EN : Boolean := True;
   ...
   for LPMCU_CLOCK_ENABLES_0_Register use record
      ...
      CORTUS_SPI1_CORE_CLK_EN at 0 range 3 .. 3;
   ...
   type LPMCU_CLOCK_ENABLES_1_Register is record
      ...
      --  SPI1 SCK Phase Internal Clock Enable
      SPI1_SCK_PHASE_INT_CLK_EN : Boolean := True;
      --  GPIO Controller Clock Enable
   ...
   for LPMCU_CLOCK_ENABLES_1_Register use record
      ...
      SPI1_SCK_PHASE_INT_CLK_EN at 0 range 12 .. 12;
   ...
   type INVERT_OUTPUT_CTRL_Register is record
      ...
      --  Invert the output for lp_gpio_4
      LP_GPIO_4      : Boolean := False;
      --  Invert the output for lp_gpio_5
      LP_GPIO_5      : Boolean := False;
      --  Invert the output for lp_gpio_6
      LP_GPIO_6      : Boolean := False;
      --  Invert the output for lp_gpio_7
      LP_GPIO_7      : Boolean := False;
      ...
      --  Invert the output for lp_gpio_14
      LP_GPIO_14     : Boolean := False;
      --  Invert the output for lp_gpio_15
      LP_GPIO_15     : Boolean := False;
      --  Invert the output for lp_gpio_16
      LP_GPIO_16     : Boolean := False;
      --  Invert the output for lp_gpio_17
      LP_GPIO_17     : Boolean := False;
      --  Invert the output for lp_gpio_18
      LP_GPIO_18     : Boolean := False;
      --  Invert the output for lp_gpio_19
      LP_GPIO_19     : Boolean := False;
      --  Invert the output for lp_gpio_20
      LP_GPIO_20     : Boolean := False;
      --  Invert the output for lp_gpio_21
      LP_GPIO_21     : Boolean := False;
      --  Invert the output for lp_gpio_22
      LP_GPIO_22     : Boolean := False;
      --  Invert the output for lp_gpio_23
      LP_GPIO_23     : Boolean := False;
      --  unspecified
      Reserved_24_26 : HAL.UInt3 := 16#0#;
      --  Invert the output for lp_sip_0
      LP_SIP_0       : Boolean := False;
      --  Invert the output for lp_sip_1
      LP_SIP_1       : Boolean := False;
      --  Invert the output for lp_sip_2
      LP_SIP_2       : Boolean := False;
      --  Invert the output for lp_sip_3
      LP_SIP_3       : Boolean := False;
      --  Invert the output for lp_sip_4
      LP_SIP_4       : Boolean := False;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   for INVERT_OUTPUT_CTRL_Register use record
      ...
      LP_GPIO_4      at 0 range 4 .. 4;
      LP_GPIO_5      at 0 range 5 .. 5;
      LP_GPIO_6      at 0 range 6 .. 6;
      LP_GPIO_7      at 0 range 7 .. 7;
      ...
      LP_GPIO_14     at 0 range 14 .. 14;
      LP_GPIO_15     at 0 range 15 .. 15;
      LP_GPIO_16     at 0 range 16 .. 16;
      LP_GPIO_17     at 0 range 17 .. 17;
      LP_GPIO_18     at 0 range 18 .. 18;
      LP_GPIO_19     at 0 range 19 .. 19;
      LP_GPIO_20     at 0 range 20 .. 20;
      LP_GPIO_21     at 0 range 21 .. 21;
      LP_GPIO_22     at 0 range 22 .. 22;
      LP_GPIO_23     at 0 range 23 .. 23;
      Reserved_24_26 at 0 range 24 .. 26;
      LP_SIP_0       at 0 range 27 .. 27;
      LP_SIP_1       at 0 range 28 .. 28;
      LP_SIP_2       at 0 range 29 .. 29;
      LP_SIP_3       at 0 range 30 .. 30;
      LP_SIP_4       at 0 range 31 .. 31;
   end record;
   ...
   --  Pinmux select for LP_GPIO_4
   type PINMUX_SEL_0_LP_GPIO_4_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      ...
      Test_Out_4)
     with Size => 3;
   for PINMUX_SEL_0_LP_GPIO_4_SEL_Field use
     (Gpio => 0,
      Megamux => 1,
      Uart0_Cts => 2,
      Spi1_Ssn => 4,
   ...
   --  Pinmux select for LP_GPIO_5
   type PINMUX_SEL_0_LP_GPIO_5_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      ...
      Test_Out_5)
     with Size => 3;
   for PINMUX_SEL_0_LP_GPIO_5_SEL_Field use
     (Gpio => 0,
      Megamux => 1,
      Uart0_Rts => 2,
      Spi1_Miso => 4,
   ...
   --  Pinmux select for LP_GPIO_6
   type PINMUX_SEL_0_LP_GPIO_6_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      ...
      Test_Out_6)
     with Size => 3;
   for PINMUX_SEL_0_LP_GPIO_6_SEL_Field use
     (Gpio => 0,
      Megamux => 1,
      Uart1_Rxd => 2,
      Spi0_Sck => 5,
   ...
   --  Pinmux select for LP_GPIO_7
   type PINMUX_SEL_0_LP_GPIO_7_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      ...
      Test_Out_7)
     with Size => 3;
   for PINMUX_SEL_0_LP_GPIO_7_SEL_Field use
     (Gpio => 0,
      Megamux => 1,
      Uart1_Txd => 2,
      Spi0_Mosi => 5,
   ...
   type PINMUX_SEL_0_Register is record
      ...
      --  Pinmux select for LP_GPIO_4
      LP_GPIO_4_SEL  : PINMUX_SEL_0_LP_GPIO_4_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_19_19 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_5
      LP_GPIO_5_SEL  : PINMUX_SEL_0_LP_GPIO_5_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_23_23 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_6
      LP_GPIO_6_SEL  : PINMUX_SEL_0_LP_GPIO_6_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_27_27 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_7
      LP_GPIO_7_SEL  : PINMUX_SEL_0_LP_GPIO_7_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_31_31 : HAL.Bit := 16#0#;
   end record
   ...
   for PINMUX_SEL_0_Register use record
      ...
      LP_GPIO_4_SEL  at 0 range 16 .. 18;
      Reserved_19_19 at 0 range 19 .. 19;
      LP_GPIO_5_SEL  at 0 range 20 .. 22;
      Reserved_23_23 at 0 range 23 .. 23;
      LP_GPIO_6_SEL  at 0 range 24 .. 26;
      Reserved_27_27 at 0 range 27 .. 27;
      LP_GPIO_7_SEL  at 0 range 28 .. 30;
      Reserved_31_31 at 0 range 31 .. 31;
   end record;
   ...
   --  Pinmux select for LP_GPIO_14
   type PINMUX_SEL_1_LP_GPIO_14_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      ...
      Test_Out_14)
     with Size => 3;
   for PINMUX_SEL_1_LP_GPIO_14_SEL_Field use
     (Gpio => 0,
      Megamux => 1,
      Uart1_Cts => 2,
      I2C1_Sda => 4,
   ...
   --  Pinmux select for LP_GPIO_15
   type PINMUX_SEL_1_LP_GPIO_15_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      ...
      Test_Out_15)
     with Size => 3;
   for PINMUX_SEL_1_LP_GPIO_15_SEL_Field use
     (Gpio => 0,
      Megamux => 1,
      Uart1_Rts => 2,
      I2C1_Scl => 4,
   ...
   type PINMUX_SEL_1_Register is record
      ...
      Reserved_23_23 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_14
      LP_GPIO_14_SEL : PINMUX_SEL_1_LP_GPIO_14_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_27_27 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_15
      LP_GPIO_15_SEL : PINMUX_SEL_1_LP_GPIO_15_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_31_31 : HAL.Bit := 16#0#;
   end record
   ...
   for PINMUX_SEL_1_Register use record
      ...
      Reserved_23_23 at 0 range 23 .. 23;
      LP_GPIO_14_SEL at 0 range 24 .. 26;
      Reserved_27_27 at 0 range 27 .. 27;
      LP_GPIO_15_SEL at 0 range 28 .. 30;
      Reserved_31_31 at 0 range 31 .. 31;
   end record;

   --  Pinmux select for LP_GPIO_16
   type PINMUX_SEL_2_LP_GPIO_16_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      ...
      Test_Out_16)
     with Size => 3;
   for PINMUX_SEL_2_LP_GPIO_16_SEL_Field use
     (Gpio => 0,
      Megamux => 1,
      Spi_Flash0_Sck => 2,
      Spi1_Ssn => 4,
   ...
   type PINMUX_SEL_2_LP_GPIO_17_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      ...
      Test_Out_17)
     with Size => 3;
   for PINMUX_SEL_2_LP_GPIO_17_SEL_Field use
     (Gpio => 0,
      Megamux => 1,
      Spi_Flash0_Txd => 2,
      Spi1_Sck => 4,
   ...
   type PINMUX_SEL_2_LP_GPIO_18_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      ...
      Test_Out_18)
     with Size => 3;
   for PINMUX_SEL_2_LP_GPIO_18_SEL_Field use
     (Gpio => 0,
      Megamux => 1,
      Spi_Flash0_Ssn => 2,
      Spi1_Miso => 4,
   ...
   type PINMUX_SEL_2_LP_GPIO_19_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      ...
      Test_Out_19)
     with Size => 3;
   for PINMUX_SEL_2_LP_GPIO_19_SEL_Field use
     (Gpio => 0,
      Megamux => 1,
      Spi_Flash0_Rxd => 2,
      Spi1_Mosi => 4,
   ...
   type PINMUX_SEL_2_LP_GPIO_20_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      ...
      Test_Out_20)
     with Size => 3;
   for PINMUX_SEL_2_LP_GPIO_20_SEL_Field use
     (Gpio => 0,
      Megamux => 1,
      Test_Out_20 => 7);

   --  Pinmux select for LP_GPIO_21
   type PINMUX_SEL_2_LP_GPIO_21_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      Megamux)
     with Size => 3;
   for PINMUX_SEL_2_LP_GPIO_21_SEL_Field use
     (Gpio => 0,
      Megamux => 1);

   --  Pinmux select for LP_GPIO_22
   type PINMUX_SEL_2_LP_GPIO_22_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      Megamux)
     with Size => 3;
   for PINMUX_SEL_2_LP_GPIO_22_SEL_Field use
     (Gpio => 0,
      Megamux => 1);

   --  Pinmux select for LP_GPIO_23
   type PINMUX_SEL_2_LP_GPIO_23_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      Megamux)
     with Size => 3;
   for PINMUX_SEL_2_LP_GPIO_23_SEL_Field use
     (Gpio => 0,
      Megamux => 1);
   ...
   type PINMUX_SEL_2_Register is record
      --  Pinmux select for LP_GPIO_16
      LP_GPIO_16_SEL : PINMUX_SEL_2_LP_GPIO_16_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_3_3   : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_17
      LP_GPIO_17_SEL : PINMUX_SEL_2_LP_GPIO_17_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_18
      LP_GPIO_18_SEL : PINMUX_SEL_2_LP_GPIO_18_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_11_11 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_19
      LP_GPIO_19_SEL : PINMUX_SEL_2_LP_GPIO_19_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_15_15 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_20
      LP_GPIO_20_SEL : PINMUX_SEL_2_LP_GPIO_20_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_19_19 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_21
      LP_GPIO_21_SEL : PINMUX_SEL_2_LP_GPIO_21_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_23_23 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_22
      LP_GPIO_22_SEL : PINMUX_SEL_2_LP_GPIO_22_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_27_27 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_GPIO_23
      LP_GPIO_23_SEL : PINMUX_SEL_2_LP_GPIO_23_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_31_31 : HAL.Bit := 16#0#;
   end record
   ...
   type PULL_ENABLE_Register is record
      ...
      LP_GPIO_3      : Boolean := False;
      --  Pull Enable for LP_GPIO_4
      LP_GPIO_4      : Boolean := False;
      --  Pull Enable for LP_GPIO_5
      LP_GPIO_5      : Boolean := False;
      --  Pull Enable for LP_GPIO_6
      LP_GPIO_6      : Boolean := False;
      --  Pull Enable for LP_GPIO_7
      LP_GPIO_7      : Boolean := False;
      ...
      LP_GPIO_13     : Boolean := False;
      --  Pull Enable for LP_GPIO_14
      LP_GPIO_14     : Boolean := False;
      --  Pull Enable for LP_GPIO_15
      LP_GPIO_15     : Boolean := False;
      --  Pull Enable for LP_GPIO_16
      LP_GPIO_16     : Boolean := False;
      --  Pull Enable for LP_GPIO_17
      LP_GPIO_17     : Boolean := False;
      --  Pull Enable for LP_GPIO_18
      LP_GPIO_18     : Boolean := False;
      --  Pull Enable for LP_GPIO_19
      LP_GPIO_19     : Boolean := False;
      --  Pull Enable for LP_GPIO_20
      LP_GPIO_20     : Boolean := False;
      --  Pull Enable for LP_GPIO_21
      LP_GPIO_21     : Boolean := False;
      --  Pull Enable for LP_GPIO_22
      LP_GPIO_22     : Boolean := False;
      --  Pull Enable for LP_GPIO_23
      LP_GPIO_23     : Boolean := False;
      --  unspecified
      Reserved_24_26 : HAL.UInt3 := 16#0#;
      --  Pull Enable for LP_SIP_0
      LP_SIP_0       : Boolean := False;
      --  Pull Enable for LP_SIP_1
      LP_SIP_1       : Boolean := False;
      --  Pull Enable for LP_SIP_2
      LP_SIP_2       : Boolean := False;
      --  Pull Enable for LP_SIP_3
      LP_SIP_3       : Boolean := False;
      --  Pull Enable for LP_SIP_4
      LP_SIP_4       : Boolean := False;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type RTYPE_PAD_0_Register is record
      ...
      LP_GPIO_3      : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_4
      LP_GPIO_4      : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_5
      LP_GPIO_5      : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_6
      LP_GPIO_6      : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_7
      LP_GPIO_7      : Boolean := False;
      ...
      LP_GPIO_13     : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_14
      LP_GPIO_14     : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_15
      LP_GPIO_15     : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_16
      LP_GPIO_16     : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_17
      LP_GPIO_17     : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_18
      LP_GPIO_18     : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_19
      LP_GPIO_19     : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_20
      LP_GPIO_20     : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_21
      LP_GPIO_21     : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_22
      LP_GPIO_22     : Boolean := False;
      --  Controls RTYPE (Pull Level) value LP_GPIO_23
      LP_GPIO_23     : Boolean := False;
      --  unspecified
      Reserved_24_31 : HAL.UInt8 := 16#0#;
   end record
   ...
   type PINMUX_SEL_3_LP_SIP_0_SEL_Field is
     (
      --  Reset value for the field
      Pinmux_Sel_3_Lp_Sip_0_Sel_Field_Reset,
      --  MUX function 1
      Spi_Flash0_Sck)
     with Size => 3;
   for PINMUX_SEL_3_LP_SIP_0_SEL_Field use
     (Pinmux_Sel_3_Lp_Sip_0_Sel_Field_Reset => 0,
      Spi_Flash0_Sck => 1);

   --  Pinmux select for LP_SIP_1
   type PINMUX_SEL_3_LP_SIP_1_SEL_Field is
     (
      --  Reset value for the field
      Pinmux_Sel_3_Lp_Sip_1_Sel_Field_Reset,
      --  MUX function 3
      Spi_Flash0_Txd)
     with Size => 3;
   for PINMUX_SEL_3_LP_SIP_1_SEL_Field use
     (Pinmux_Sel_3_Lp_Sip_1_Sel_Field_Reset => 0,
      Spi_Flash0_Txd => 3);

   --  Pinmux select for LP_SIP_2
   type PINMUX_SEL_3_LP_SIP_2_SEL_Field is
     (
      --  Reset value for the field
      Pinmux_Sel_3_Lp_Sip_2_Sel_Field_Reset,
      --  MUX function 2
      Spi_Flash0_Ssn)
     with Size => 3;
   for PINMUX_SEL_3_LP_SIP_2_SEL_Field use
     (Pinmux_Sel_3_Lp_Sip_2_Sel_Field_Reset => 0,
      Spi_Flash0_Ssn => 2);

   --  Pinmux select for LP_SIP_3
   type PINMUX_SEL_3_LP_SIP_3_SEL_Field is
     (
      --  Reset value for the field
      Pinmux_Sel_3_Lp_Sip_3_Sel_Field_Reset,
      --  MUX function 4
      Spi_Flash0_Rxd)
     with Size => 3;
   for PINMUX_SEL_3_LP_SIP_3_SEL_Field use
     (Pinmux_Sel_3_Lp_Sip_3_Sel_Field_Reset => 0,
      Spi_Flash0_Rxd => 4);

   --  Pinmux select for LP_SIP_4
   type PINMUX_SEL_3_LP_SIP_4_SEL_Field is
     (
      --  MUX function 0
      Spi_Flash0_Wp)
     with Size => 3;
   for PINMUX_SEL_3_LP_SIP_4_SEL_Field use
     (Spi_Flash0_Wp => 0);

   --  Pinmux select for LP_SIP_0, LP_SIP_1, LP_SIP_2, LP_SIP_3, LP_SIP_4
   type PINMUX_SEL_3_Register is record
      --  Pinmux select for LP_SIP_0
      LP_SIP_0_SEL   : PINMUX_SEL_3_LP_SIP_0_SEL_Field :=
                        Pinmux_Sel_3_Lp_Sip_0_Sel_Field_Reset;
      --  unspecified
      Reserved_3_3   : HAL.Bit := 16#0#;
      --  Pinmux select for LP_SIP_1
      LP_SIP_1_SEL   : PINMUX_SEL_3_LP_SIP_1_SEL_Field :=
                        Pinmux_Sel_3_Lp_Sip_1_Sel_Field_Reset;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Pinmux select for LP_SIP_2
      LP_SIP_2_SEL   : PINMUX_SEL_3_LP_SIP_2_SEL_Field :=
                        Pinmux_Sel_3_Lp_Sip_2_Sel_Field_Reset;
      --  unspecified
      Reserved_11_11 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_SIP_3
      LP_SIP_3_SEL   : PINMUX_SEL_3_LP_SIP_3_SEL_Field :=
                        Pinmux_Sel_3_Lp_Sip_3_Sel_Field_Reset;
      --  unspecified
      Reserved_15_15 : HAL.Bit := 16#0#;
      --  Pinmux select for LP_SIP_4
      LP_SIP_4_SEL   : PINMUX_SEL_3_LP_SIP_4_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Spi_Flash0_Wp;
      --  unspecified
   ...
   type PINMUX_SEL_4_LP_GPIO_24_SEL_Field is
     (
      --  MUX function 0
      Gpio,
      --  MUX function 1
      Megamux)
     with Size => 3;
   for PINMUX_SEL_4_LP_GPIO_24_SEL_Field use
     (Gpio => 0,
      Megamux => 1);
   ...
   type PINMUX_SEL_4_Register is record
      --  Pinmux select for LP_GPIO_24
      LP_GPIO_24_SEL : PINMUX_SEL_4_LP_GPIO_24_SEL_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.Gpio;
      --  unspecified
      Reserved_3_7   : HAL.UInt5 := 16#0#;
   end record
   ...
   type IRQ_MUX_IO_SEL_0_MUX_0_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_0_MUX_0_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_0_MUX_0_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_0_MUX_0_Field use
     (IRQ_MUX_IO_SEL_0_MUX_0_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_0_MUX_0_Field_7 => 7,
      IRQ_MUX_IO_SEL_0_MUX_0_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_0_MUX_1_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_0_MUX_1_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_0_MUX_1_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_0_MUX_1_Field use
     (IRQ_MUX_IO_SEL_0_MUX_1_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_0_MUX_1_Field_7 => 7,
      IRQ_MUX_IO_SEL_0_MUX_1_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_0_MUX_2_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_0_MUX_2_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_0_MUX_2_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_0_MUX_2_Field use
     (IRQ_MUX_IO_SEL_0_MUX_2_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_0_MUX_2_Field_7 => 7,
      IRQ_MUX_IO_SEL_0_MUX_2_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_0_MUX_3_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_0_MUX_3_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_0_MUX_3_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_0_MUX_3_Field use
     (IRQ_MUX_IO_SEL_0_MUX_3_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_0_MUX_3_Field_7 => 7,
      IRQ_MUX_IO_SEL_0_MUX_3_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_1_MUX_4_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_1_MUX_4_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_1_MUX_4_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_1_MUX_4_Field use
     (IRQ_MUX_IO_SEL_1_MUX_4_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_1_MUX_4_Field_7 => 7,
      IRQ_MUX_IO_SEL_1_MUX_4_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_1_MUX_5_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_1_MUX_5_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_1_MUX_5_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_1_MUX_5_Field use
     (IRQ_MUX_IO_SEL_1_MUX_5_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_1_MUX_5_Field_7 => 7,
      IRQ_MUX_IO_SEL_1_MUX_5_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_1_MUX_6_Field is
     (
      --  SPI1 RX
      IRQ_MUX_IO_SEL_1_MUX_6_Field_0,
      --  UART0 RX
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_1_MUX_6_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_1_MUX_6_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_1_MUX_6_Field use
     (IRQ_MUX_IO_SEL_1_MUX_6_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_1_MUX_6_Field_7 => 7,
      IRQ_MUX_IO_SEL_1_MUX_6_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_1_MUX_7_Field is
     (
      --  SPI1 TX
      IRQ_MUX_IO_SEL_1_MUX_7_Field_0,
      --  UART0 RX
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_1_MUX_7_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_1_MUX_7_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_1_MUX_7_Field use
     (IRQ_MUX_IO_SEL_1_MUX_7_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_1_MUX_7_Field_7 => 7,
      IRQ_MUX_IO_SEL_1_MUX_7_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_1_Register is record
      ...
      MUX_6          : IRQ_MUX_IO_SEL_1_MUX_6_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.IRQ_MUX_IO_SEL_1_MUX_6_Field_0;
      --  unspecified
      Reserved_21_23 : HAL.UInt3 := 16#0#;
      --  IRQ_7 Source Selection
      MUX_7          : IRQ_MUX_IO_SEL_1_MUX_7_Field :=
                        SAM_SVD.LPMCU_MISC_REGS.IRQ_MUX_IO_SEL_1_MUX_7_Field_0;
      --  unspecified
      Reserved_29_31 : HAL.UInt3 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   type IRQ_MUX_IO_SEL_2_MUX_8_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_2_MUX_8_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_2_MUX_8_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_2_MUX_8_Field use
     (IRQ_MUX_IO_SEL_2_MUX_8_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_2_MUX_8_Field_7 => 7,
      IRQ_MUX_IO_SEL_2_MUX_8_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_2_MUX_9_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_2_MUX_9_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_2_MUX_9_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_2_MUX_9_Field use
     (IRQ_MUX_IO_SEL_2_MUX_9_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_2_MUX_9_Field_7 => 7,
      IRQ_MUX_IO_SEL_2_MUX_9_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_2_MUX_10_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_2_MUX_10_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_2_MUX_10_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_2_MUX_10_Field use
     (IRQ_MUX_IO_SEL_2_MUX_10_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_2_MUX_10_Field_7 => 7,
      IRQ_MUX_IO_SEL_2_MUX_10_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_2_MUX_11_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_2_MUX_11_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_2_MUX_11_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_2_MUX_11_Field use
     (IRQ_MUX_IO_SEL_2_MUX_11_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_2_MUX_11_Field_7 => 7,
      IRQ_MUX_IO_SEL_2_MUX_11_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_3_MUX_12_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_3_MUX_12_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_3_MUX_12_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_3_MUX_12_Field use
     (IRQ_MUX_IO_SEL_3_MUX_12_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_3_MUX_12_Field_7 => 7,
      IRQ_MUX_IO_SEL_3_MUX_12_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_3_MUX_13_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_3_MUX_13_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_3_MUX_13_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_3_MUX_13_Field use
     (IRQ_MUX_IO_SEL_3_MUX_13_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_3_MUX_13_Field_7 => 7,
      IRQ_MUX_IO_SEL_3_MUX_13_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_3_MUX_14_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_3_MUX_14_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_3_MUX_14_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_3_MUX_14_Field use
     (IRQ_MUX_IO_SEL_3_MUX_14_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_3_MUX_14_Field_7 => 7,
      IRQ_MUX_IO_SEL_3_MUX_14_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_3_MUX_15_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_3_MUX_15_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_3_MUX_15_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_3_MUX_15_Field use
     (IRQ_MUX_IO_SEL_3_MUX_15_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_3_MUX_15_Field_7 => 7,
      IRQ_MUX_IO_SEL_3_MUX_15_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_4_MUX_16_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_4_MUX_16_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_4_MUX_16_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_4_MUX_16_Field use
     (IRQ_MUX_IO_SEL_4_MUX_16_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_4_MUX_16_Field_7 => 7,
      IRQ_MUX_IO_SEL_4_MUX_16_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_4_MUX_17_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_4_MUX_17_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_4_MUX_17_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_4_MUX_17_Field use
     (IRQ_MUX_IO_SEL_4_MUX_17_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_4_MUX_17_Field_7 => 7,
      IRQ_MUX_IO_SEL_4_MUX_17_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_4_MUX_18_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_4_MUX_18_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_4_MUX_18_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_4_MUX_18_Field use
     (IRQ_MUX_IO_SEL_4_MUX_18_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_4_MUX_18_Field_7 => 7,
      IRQ_MUX_IO_SEL_4_MUX_18_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_4_MUX_19_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_4_MUX_19_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_4_MUX_19_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_4_MUX_19_Field use
     (IRQ_MUX_IO_SEL_4_MUX_19_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_4_MUX_19_Field_7 => 7,
      IRQ_MUX_IO_SEL_4_MUX_19_Field_8 => 8,
   ...
   type IRQ_MUX_IO_SEL_5_MUX_20_Field is
     (
      ...
      --  SPI1 RX
      IRQ_MUX_IO_SEL_5_MUX_20_Field_7,
      --  SPI1 TX
      IRQ_MUX_IO_SEL_5_MUX_20_Field_8,
      --  I2C0 RX
   ...
   for IRQ_MUX_IO_SEL_5_MUX_20_Field use
     (IRQ_MUX_IO_SEL_5_MUX_20_Field_0 => 0,
      ...
      IRQ_MUX_IO_SEL_5_MUX_20_Field_7 => 7,
      IRQ_MUX_IO_SEL_5_MUX_20_Field_8 => 8,
   ...
   type MEGA_MUX_IO_SEL_1_LP_GPIO_4_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_1_LP_GPIO_4_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_1_Lp_Gpio_4_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_1_LP_GPIO_4_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_1_LP_GPIO_4_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_1_Lp_Gpio_4_Field_Reset => 63);

   --  LP_GPIO_5 mega mux selection
   type MEGA_MUX_IO_SEL_1_LP_GPIO_5_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_1_LP_GPIO_5_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_1_Lp_Gpio_5_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_1_LP_GPIO_5_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_1_LP_GPIO_5_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_1_Lp_Gpio_5_Field_Reset => 63);

   --  LP_GPIO_6 mega mux selection
   type MEGA_MUX_IO_SEL_1_LP_GPIO_6_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_1_LP_GPIO_6_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_1_Lp_Gpio_6_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_1_LP_GPIO_6_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_1_LP_GPIO_6_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_1_Lp_Gpio_6_Field_Reset => 63);

   --  LP_GPIO_7 mega mux selection
   type MEGA_MUX_IO_SEL_1_LP_GPIO_7_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_1_LP_GPIO_7_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_1_Lp_Gpio_7_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_1_LP_GPIO_7_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_1_LP_GPIO_7_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_1_Lp_Gpio_7_Field_Reset => 63);

   --  Mega Mux Selection (Refer to Mega_Mux_IO Spreadsheet)
   type MEGA_MUX_IO_SEL_1_Register is record
      --  LP_GPIO_4 mega mux selection
      LP_GPIO_4      : MEGA_MUX_IO_SEL_1_LP_GPIO_4_Field :=
                        Mega_Mux_Io_Sel_1_Lp_Gpio_4_Field_Reset;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  LP_GPIO_5 mega mux selection
      LP_GPIO_5      : MEGA_MUX_IO_SEL_1_LP_GPIO_5_Field :=
                        Mega_Mux_Io_Sel_1_Lp_Gpio_5_Field_Reset;
      --  unspecified
      Reserved_14_15 : HAL.UInt2 := 16#0#;
      --  LP_GPIO_6 mega mux selection
      LP_GPIO_6      : MEGA_MUX_IO_SEL_1_LP_GPIO_6_Field :=
                        Mega_Mux_Io_Sel_1_Lp_Gpio_6_Field_Reset;
      --  unspecified
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  LP_GPIO_7 mega mux selection
      LP_GPIO_7      : MEGA_MUX_IO_SEL_1_LP_GPIO_7_Field :=
                        Mega_Mux_Io_Sel_1_Lp_Gpio_7_Field_Reset;
      --  unspecified
      Reserved_30_31 : HAL.UInt2 := 16#0#;
   end record
   ...
   --  LP_GPIO_14 mega mux selection
   type MEGA_MUX_IO_SEL_3_LP_GPIO_14_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_3_LP_GPIO_14_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_3_Lp_Gpio_14_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_3_LP_GPIO_14_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_3_LP_GPIO_14_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_3_Lp_Gpio_14_Field_Reset => 63);

   --  LP_GPIO_15 mega mux selection
   type MEGA_MUX_IO_SEL_3_LP_GPIO_15_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_3_LP_GPIO_15_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_3_Lp_Gpio_15_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_3_LP_GPIO_15_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_3_LP_GPIO_15_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_3_Lp_Gpio_15_Field_Reset => 63);
   ...
   type MEGA_MUX_IO_SEL_3_Register is record
      ...
      Reserved_14_15 : HAL.UInt2 := 16#0#;
      --  LP_GPIO_14 mega mux selection
      LP_GPIO_14     : MEGA_MUX_IO_SEL_3_LP_GPIO_14_Field :=
                        Mega_Mux_Io_Sel_3_Lp_Gpio_14_Field_Reset;
      --  unspecified
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  LP_GPIO_15 mega mux selection
      LP_GPIO_15     : MEGA_MUX_IO_SEL_3_LP_GPIO_15_Field :=
                        Mega_Mux_Io_Sel_3_Lp_Gpio_15_Field_Reset;
      --  unspecified
      Reserved_30_31 : HAL.UInt2 := 16#0#;
   end record
   ...
   for MEGA_MUX_IO_SEL_3_Register use record
      ...
      Reserved_14_15 at 0 range 14 .. 15;
      LP_GPIO_14     at 0 range 16 .. 21;
      Reserved_22_23 at 0 range 22 .. 23;
      LP_GPIO_15     at 0 range 24 .. 29;
      Reserved_30_31 at 0 range 30 .. 31;
   end record;

   --  LP_GPIO_16 mega mux selection
   type MEGA_MUX_IO_SEL_4_LP_GPIO_16_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_4_LP_GPIO_16_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_4_Lp_Gpio_16_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_4_LP_GPIO_16_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_4_LP_GPIO_16_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_4_Lp_Gpio_16_Field_Reset => 63);

   --  LP_GPIO_17 mega mux selection
   type MEGA_MUX_IO_SEL_4_LP_GPIO_17_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_4_LP_GPIO_17_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_4_Lp_Gpio_17_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_4_LP_GPIO_17_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_4_LP_GPIO_17_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_4_Lp_Gpio_17_Field_Reset => 63);

   --  LP_GPIO_18 mega mux selection
   type MEGA_MUX_IO_SEL_4_LP_GPIO_18_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_4_LP_GPIO_18_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_4_Lp_Gpio_18_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_4_LP_GPIO_18_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_4_LP_GPIO_18_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_4_Lp_Gpio_18_Field_Reset => 63);

   --  LP_GPIO_19 mega mux selection
   type MEGA_MUX_IO_SEL_4_LP_GPIO_19_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_4_LP_GPIO_19_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_4_Lp_Gpio_19_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_4_LP_GPIO_19_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_4_LP_GPIO_19_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_4_Lp_Gpio_19_Field_Reset => 63);

   --  Mega Mux Selection (Refer to Mega_Mux_IO Spreadsheet)
   type MEGA_MUX_IO_SEL_4_Register is record
      --  LP_GPIO_16 mega mux selection
      LP_GPIO_16     : MEGA_MUX_IO_SEL_4_LP_GPIO_16_Field :=
                        Mega_Mux_Io_Sel_4_Lp_Gpio_16_Field_Reset;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  LP_GPIO_17 mega mux selection
      LP_GPIO_17     : MEGA_MUX_IO_SEL_4_LP_GPIO_17_Field :=
                        Mega_Mux_Io_Sel_4_Lp_Gpio_17_Field_Reset;
      --  unspecified
      Reserved_14_15 : HAL.UInt2 := 16#0#;
      --  LP_GPIO_18 mega mux selection
      LP_GPIO_18     : MEGA_MUX_IO_SEL_4_LP_GPIO_18_Field :=
                        Mega_Mux_Io_Sel_4_Lp_Gpio_18_Field_Reset;
      --  unspecified
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  LP_GPIO_19 mega mux selection
      LP_GPIO_19     : MEGA_MUX_IO_SEL_4_LP_GPIO_19_Field :=
                        Mega_Mux_Io_Sel_4_Lp_Gpio_19_Field_Reset;
      --  unspecified
      Reserved_30_31 : HAL.UInt2 := 16#0#;
   end record
   ...
   type MEGA_MUX_IO_SEL_5_LP_GPIO_20_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_5_LP_GPIO_20_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_5_Lp_Gpio_20_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_5_LP_GPIO_20_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_5_LP_GPIO_20_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_5_Lp_Gpio_20_Field_Reset => 63);

   --  LP_GPIO_21 mega mux selection
   type MEGA_MUX_IO_SEL_5_LP_GPIO_21_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_5_LP_GPIO_21_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_5_Lp_Gpio_21_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_5_LP_GPIO_21_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_5_LP_GPIO_21_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_5_Lp_Gpio_21_Field_Reset => 63);

   --  LP_GPIO_22 mega mux selection
   type MEGA_MUX_IO_SEL_5_LP_GPIO_22_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_5_LP_GPIO_22_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_5_Lp_Gpio_22_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_5_LP_GPIO_22_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_5_LP_GPIO_22_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_5_Lp_Gpio_22_Field_Reset => 63);

   --  LP_GPIO_23 mega mux selection
   type MEGA_MUX_IO_SEL_5_LP_GPIO_23_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_5_LP_GPIO_23_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_5_Lp_Gpio_23_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_5_LP_GPIO_23_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_5_LP_GPIO_23_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_5_Lp_Gpio_23_Field_Reset => 63);

   --  Mega Mux Selection (Refer to Mega_Mux_IO Spreadsheet)
   type MEGA_MUX_IO_SEL_5_Register is record
      --  LP_GPIO_20 mega mux selection
      LP_GPIO_20     : MEGA_MUX_IO_SEL_5_LP_GPIO_20_Field :=
                        Mega_Mux_Io_Sel_5_Lp_Gpio_20_Field_Reset;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  LP_GPIO_21 mega mux selection
      LP_GPIO_21     : MEGA_MUX_IO_SEL_5_LP_GPIO_21_Field :=
                        Mega_Mux_Io_Sel_5_Lp_Gpio_21_Field_Reset;
      --  unspecified
      Reserved_14_15 : HAL.UInt2 := 16#0#;
      --  LP_GPIO_22 mega mux selection
      LP_GPIO_22     : MEGA_MUX_IO_SEL_5_LP_GPIO_22_Field :=
                        Mega_Mux_Io_Sel_5_Lp_Gpio_22_Field_Reset;
      --  unspecified
      Reserved_22_23 : HAL.UInt2 := 16#0#;
      --  LP_GPIO_23 mega mux selection
      LP_GPIO_23     : MEGA_MUX_IO_SEL_5_LP_GPIO_23_Field :=
                        Mega_Mux_Io_Sel_5_Lp_Gpio_23_Field_Reset;
      --  unspecified
      Reserved_30_31 : HAL.UInt2 := 16#0#;
   end record
   ...
   type MEGA_MUX_IO_SEL_6_LP_GPIO_24_Field is
     (
      --  UART0_RXD
      Uart0_Rxd,
      --  UART0_TXD
      ...
      Pwm3_Out,
      --  32KHZ_CLK
      MEGA_MUX_IO_SEL_6_LP_GPIO_24_Field_32Khz_Clk,
      --  COEX_WLAN_TX
      Coex_Wlan_Tx,
      --  COEX_WLAN_RX
      Coex_Wlan_Rx,
      ...
      Quad_Dec2_B,
      --  Reset value for the field
      Mega_Mux_Io_Sel_6_Lp_Gpio_24_Field_Reset)
     with Size => 6;
   for MEGA_MUX_IO_SEL_6_LP_GPIO_24_Field use
     (Uart0_Rxd => 0,
      Uart0_Txd => 1,
      Uart0_Cts => 2,
      Uart0_Rts => 3,
      ...
      Pwm2_Out => 14,
      Pwm3_Out => 15,
      MEGA_MUX_IO_SEL_6_LP_GPIO_24_Field_32Khz_Clk => 16,
      Coex_Wlan_Tx => 17,
      Coex_Wlan_Rx => 18,
      Coex_Ble_Tx => 19,
      Coex_Ble_Rx => 20,
      ...
      Quad_Dec2_A => 33,
      Quad_Dec2_B => 34,
      Mega_Mux_Io_Sel_6_Lp_Gpio_24_Field_Reset => 63);

   --  Mega Mux Selection (Refer to Mega_Mux_IO Spreadsheet)
   type MEGA_MUX_IO_SEL_6_Register is record
      --  LP_GPIO_24 mega mux selection
      LP_GPIO_24   : MEGA_MUX_IO_SEL_6_LP_GPIO_24_Field :=
                      Mega_Mux_Io_Sel_6_Lp_Gpio_24_Field_Reset;
      --  unspecified
      Reserved_6_7 : HAL.UInt2 := 16#0#;
   end record
   ...
   type MS_GPIO_Register is record
      --  Mixed Signal LP_GPIO_44 Pull Type Select. 1: PD, 0: PU.
      PULL_TYPE_44   : Boolean := False;
      --  Mixed Signal LP_GPIO_45 Pull Type Select. 1: PD, 0: PU.
      PULL_TYPE_45   : Boolean := False;
      --  Mixed Signal LP_GPIO_46 Pull Type Select. 1: PD, 0: PU.
      PULL_TYPE_46   : Boolean := False;
      --  Mixed Signal LP_GPIO_47 Pull Type Select. 1: PD, 0: PU.
      PULL_TYPE_47   : Boolean := False;
      --  Active Low Pull Enable for Mixed Signal LP_GPIO_44
      PULL_ENABLE_44 : Boolean := True;
      --  Active Low Pull Enable for Mixed Signal LP_GPIO_45
      PULL_ENABLE_45 : Boolean := True;
      --  Active Low Pull Enable for Mixed Signal LP_GPIO_46
      PULL_ENABLE_46 : Boolean := True;
   ...
   for MS_GPIO_Register use record
      PULL_TYPE_44   at 0 range 0 .. 0;
      PULL_TYPE_45   at 0 range 1 .. 1;
      PULL_TYPE_46   at 0 range 2 .. 2;
      PULL_TYPE_47   at 0 range 3 .. 3;
      PULL_ENABLE_44 at 0 range 4 .. 4;
      PULL_ENABLE_45 at 0 range 5 .. 5;
      PULL_ENABLE_46 at 0 range 6 .. 6;
