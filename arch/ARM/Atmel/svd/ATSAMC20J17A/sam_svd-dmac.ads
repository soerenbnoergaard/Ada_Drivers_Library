...
package SAM_SVD.DMAC is
   ...
   type DMAC_QOSCTRL_Register is record
      --  Write-Back Quality of Service
      WRBQOS       : QOSCTRL_WRBQOSSelect := SAM_SVD.DMAC.Medium;
      --  Fetch Quality of Service
      FQOS         : QOSCTRL_FQOSSelect := SAM_SVD.DMAC.Medium;
      --  Data Transfer Quality of Service
      DQOS         : QOSCTRL_DQOSSelect := SAM_SVD.DMAC.Medium;
      --  unspecified
   ...
   type DMAC_SWTRIGCTRL_SWTRIG_Field_Array is array (0 .. 5) of Boolean
   ...
   for DMAC_SWTRIGCTRL_Register use record
      SWTRIG        at 0 range 0 .. 5;
      Reserved_6_31 at 0 range 6 .. 31;
   end record;

   subtype DMAC_PRICTRL0_LVLPRI0_Field is HAL.UInt3;
   subtype DMAC_PRICTRL0_LVLPRI1_Field is HAL.UInt3;
   subtype DMAC_PRICTRL0_LVLPRI2_Field is HAL.UInt3;
   subtype DMAC_PRICTRL0_LVLPRI3_Field is HAL.UInt3;
   ...
   type DMAC_INTSTATUS_CHINT_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   for DMAC_INTSTATUS_Register use record
      CHINT         at 0 range 0 .. 5;
      Reserved_6_31 at 0 range 6 .. 31;
   end record;

   --  DMAC_BUSYCH_BUSYCH array
   type DMAC_BUSYCH_BUSYCH_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   for DMAC_BUSYCH_Register use record
      BUSYCH        at 0 range 0 .. 5;
      Reserved_6_31 at 0 range 6 .. 31;
   end record;

   --  DMAC_PENDCH_PENDCH array
   type DMAC_PENDCH_PENDCH_Field_Array is array (0 .. 5) of Boolean
     with Component_Size => 1, Size => 6;
   ...
   subtype DMAC_CHID_ID_Field is HAL.UInt3;
   ...
   subtype DMAC_CHCTRLB_LVL_Field is HAL.UInt2;
   ...
   type DMAC_CHCTRLB_Register is record
      ...
      LVL            : DMAC_CHCTRLB_LVL_Field := 16#0#;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Trigger Source
