...
package SAM_SVD.SUPC is
   ...
   --  VREG33 Control
   type SUPC_VREG33_Register is record
      --  unspecified
      Reserved_0_0  : HAL.Bit := 16#0#;
      --  VREG33 Enable
      ENABLE        : Boolean := False;
   ...
   for SUPC_VREG33_Register use record
      Reserved_0_0  at 0 range 0 .. 0;
      ENABLE        at 0 range 1 .. 1;
      ENRDY         at 0 range 2 .. 2;
      BYPASS        at 0 range 3 .. 3;
      ISOEN         at 0 range 4 .. 4;
   ...
   type SUPC_Peripheral is record
      ...
      --  VREG33 Control
      VREG33   : aliased SUPC_VREG33_Register;
   end record
     with Volatile;
