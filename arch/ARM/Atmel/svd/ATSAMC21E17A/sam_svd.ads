...
--  Atmel ATSAMC21E17A device: Cortex-M0+ Microcontroller with 128KB Flash,
--  16KB SRAM, 32-pin package (refer to
--  http://www.atmel.com/devices/SAMC21E17A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
