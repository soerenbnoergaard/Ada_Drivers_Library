...
--  Atmel ATSAMC21E18A device: Cortex-M0+ Microcontroller with 256KB Flash,
--  32KB SRAM, 32-pin package (refer to
--  http://www.atmel.com/devices/SAMC21E18A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
