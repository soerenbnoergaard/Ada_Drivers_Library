...
--  Atmel ATSAMC21G17A device: Cortex-M0+ Microcontroller with 128KB Flash,
--  16KB SRAM, 48-pin package (refer to
--  http://www.atmel.com/devices/SAMC21G17A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
