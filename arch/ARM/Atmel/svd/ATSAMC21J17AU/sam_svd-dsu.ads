...
package SAM_SVD.DSU is
   ...
   subtype DSU_STATUSC_STATE_Field is HAL.UInt3;

   --  Status C
   type DSU_STATUSC_Register is record
      --  Read-only. State
      STATE        : DSU_STATUSC_STATE_Field;
      --  unspecified
      Reserved_3_7 : HAL.UInt5;
   end record
     with Volatile_Full_Access, Size => 8, Bit_Order => System.Low_Order_First;

   for DSU_STATUSC_Register use record
   ...
   for DID_FAMILYSelect use
     (DID_FAMILYSelect_0 => 0,
      ...
      DID_FAMILYSelect_2 => 2);

   --  Processor
   type DID_PROCESSORSelect is
     (
      --  Cortex-M0
      DID_PROCESSORSelect_0,
      --  Cortex-M0+
      DID_PROCESSORSelect_1,
      --  Cortex-M3
      DID_PROCESSORSelect_2,
      --  Cortex-M4
      DID_PROCESSORSelect_3)
     with Size => 4;
   for DID_PROCESSORSelect use
     (DID_PROCESSORSelect_0 => 0,
      DID_PROCESSORSelect_1 => 1,
      DID_PROCESSORSelect_2 => 2,
      DID_PROCESSORSelect_3 => 3);
   ...
   type DSU_Peripheral is record
      ...
      --  Status C
      STATUSC : aliased DSU_STATUSC_Register;
      --  Address
