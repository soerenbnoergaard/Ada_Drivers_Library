...
package SAM_SVD.NVMCTRL is
   ...
   subtype NVMCTRL_CTRLB_CACHEDIS_Field is HAL.UInt2;
   ...
   type NVMCTRL_Peripheral is record
      ...
      --  Page Buffer Load Data 0
      PBLDATA0 : aliased HAL.UInt32;
      --  Page Buffer Load Data 1
      PBLDATA1 : aliased HAL.UInt32;
   end record
     with Volatile;
   ...
   for NVMCTRL_Peripheral use record
      ...
      PBLDATA0 at 16#28# range 0 .. 31;
      PBLDATA1 at 16#2C# range 0 .. 31;
   end record;
