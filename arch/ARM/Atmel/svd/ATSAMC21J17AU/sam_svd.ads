...
--  Atmel ATSAMC21J17AU device: Cortex-M0+ Microcontroller with 128KB Flash,
--  16KB SRAM, 56-pin package (refer to
--  http://www.atmel.com/devices/SAMC21J17AU.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
