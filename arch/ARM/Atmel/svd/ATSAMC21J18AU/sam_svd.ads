...
--  Atmel ATSAMC21J18AU device: Cortex-M0+ Microcontroller with 256KB Flash,
--  32KB SRAM, 56-pin package (refer to
--  http://www.atmel.com/devices/SAMC21J18AU.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
