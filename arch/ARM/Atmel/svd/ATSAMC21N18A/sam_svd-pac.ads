...
package SAM_SVD.PAC is
   ...
   for PAC_INTFLAGC_Register use record
      ...
      SERCOM4        at 0 range 5 .. 5;
      SERCOM5        at 0 range 6 .. 6;
      CAN0           at 0 range 7 .. 7;
      CAN1           at 0 range 8 .. 8;
      TCC0           at 0 range 9 .. 9;
      ...
      ADC1           at 0 range 18 .. 18;
      SDADC          at 0 range 19 .. 19;
      AC             at 0 range 20 .. 20;
      DAC            at 0 range 21 .. 21;
   ...
   for PAC_INTFLAGD_Register use record
      SERCOM6       at 0 range 0 .. 0;
      SERCOM7       at 0 range 1 .. 1;
      TC5           at 0 range 2 .. 2;
      TC6           at 0 range 3 .. 3;
      TC7           at 0 range 4 .. 4;
   ...
   type PAC_STATUSA_Register is record
      ...
      FREQM          : Boolean;
      --  Read-only. TSENS APB Protect Enable
      TSENS          : Boolean;
      --  unspecified
   ...
   type PAC_STATUSC_Register is record
      ...
      SERCOM5        : Boolean;
      --  Read-only. CAN0 APB Protect Enable
      CAN0           : Boolean;
      --  Read-only. CAN1 APB Protect Enable
      CAN1           : Boolean;
      ...
      ADC1           : Boolean;
      --  Read-only. SDADC APB Protect Enable
      SDADC          : Boolean;
   ...
   type PAC_STATUSD_Register is record
      --  Read-only. SERCOM6 APB Protect Enable
      SERCOM6       : Boolean;
      --  Read-only. SERCOM7 APB Protect Enable
      SERCOM7       : Boolean;
      --  Read-only. TC5 APB Protect Enable
      TC5           : Boolean;
      --  Read-only. TC6 APB Protect Enable
      TC6           : Boolean;
      --  Read-only. TC7 APB Protect Enable
      TC7           : Boolean;
      --  unspecified
