...
--  Atmel ATSAMC21N18A device: Cortex-M0+ Microcontroller with 256KB Flash,
--  32KB SRAM, 100-pin package (refer to
--  http://www.atmel.com/devices/SAMC21N18A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
