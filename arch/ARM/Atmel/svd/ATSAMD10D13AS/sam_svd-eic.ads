...
package SAM_SVD.EIC is
   ...
   type EIC_EVCTRL_EXTINTEO_Field_Array is array (0 .. 7) of Boolean
   ...
   for EIC_EVCTRL_Register use record
      EXTINTEO      at 0 range 0 .. 7;
      Reserved_8_31 at 0 range 8 .. 31;
   end record;

   --  EIC_INTENCLR_EXTINT array
   type EIC_INTENCLR_EXTINT_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   for EIC_INTENCLR_Register use record
      EXTINT        at 0 range 0 .. 7;
      Reserved_8_31 at 0 range 8 .. 31;
   end record;

   --  EIC_INTENSET_EXTINT array
   type EIC_INTENSET_EXTINT_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type EIC_INTFLAG_EXTINT_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type EIC_WAKEUP_WAKEUPEN_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   type EIC_Peripheral is record
      ...
      --  Configuration n
      CONFIG   : aliased EIC_CONFIG_Register;
   end record
     with Volatile;
