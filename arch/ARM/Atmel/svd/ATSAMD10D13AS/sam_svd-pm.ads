...
package SAM_SVD.PM is
   ...
   --  Control
   type PM_CTRL_Register is record
      --  unspecified
      ...
      --  Backup Clock Select
      BKUPCLK      : Boolean := False;
      --  unspecified
      Reserved_5_7 : HAL.UInt3 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 8, Bit_Order => System.Low_Order_First;

   for PM_CTRL_Register use record
      Reserved_0_1 at 0 range 0 .. 1;
      CFDEN        at 0 range 2 .. 2;
      Reserved_3_3 at 0 range 3 .. 3;
      BKUPCLK      at 0 range 4 .. 4;
   ...
   type PM_EXTCTRL_Register is record
      --  External Reset Disable
      SETDIS       : Boolean := False;
      --  unspecified
      Reserved_1_7 : HAL.UInt7 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 8, Bit_Order => System.Low_Order_First;

   for PM_EXTCTRL_Register use record
      SETDIS       at 0 range 0 .. 0;
   ...
   type PM_Peripheral is record
      --  Control
      CTRL     : aliased PM_CTRL_Register;
      --  Sleep Mode
      SLEEP    : aliased PM_SLEEP_Register;
      --  External Reset Controller
      EXTCTRL  : aliased PM_EXTCTRL_Register;
      --  CPU Clock Select
