...
--  Atmel ATSAMD10D14AM device: Cortex-M0+ Microcontroller with 16KB Flash, 4KB
--  SRAM, QFN24_capless-pin package (refer to
--  http://www.atmel.com/devices/SAMD10D14AM.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
