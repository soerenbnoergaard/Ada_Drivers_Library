...
--  Atmel ATSAMD10D14AS device: Cortex-M0+ Microcontroller with 16KB Flash, 4KB
--  SRAM, SOIC20_capless-pin package (refer to
--  http://www.atmel.com/devices/SAMD10D14AS.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
