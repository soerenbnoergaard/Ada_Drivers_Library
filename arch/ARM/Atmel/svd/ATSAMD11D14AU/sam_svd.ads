...
--  Atmel ATSAMD11D14AU device: Cortex-M0+ Microcontroller with 16KB Flash, 4KB
--  SRAM, WLCSP20_capless-pin package (refer to
--  http://www.atmel.com/devices/SAMD11D14AU.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
