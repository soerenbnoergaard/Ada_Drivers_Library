...
--  Atmel ATSAMD20G18U device: Cortex-M0+ Microcontroller with 256KB Flash,
--  32KB SRAM, 45-pin package (refer to
--  http://www.atmel.com/devices/SAMD20G18U.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
