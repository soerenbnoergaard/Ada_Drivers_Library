...
--  This spec has been automatically generated from ATSAMD21E15CU.svd
...
package SAM_SVD.PORT_IOBUS is
   ...
   type PORT_PMUX0_Register is record
      --  Peripheral Multiplexing Even
      PMUXE : PMUX0_PMUXESelect := SAM_SVD.PORT_IOBUS.A;
      --  Peripheral Multiplexing Odd
      PMUXO : PMUX0_PMUXOSelect := SAM_SVD.PORT_IOBUS.A;
   end record
   ...
   --  Port Module (IOBUS)
   type PORT_IOBUS_Peripheral is record
      --  Data Direction
   ...
   for PORT_IOBUS_Peripheral use record
   ...
   --  Port Module (IOBUS)
   PORT_IOBUS_Periph : aliased PORT_IOBUS_Peripheral
     with Import, Address => System'To_Address (16#60000000#);

end SAM_SVD.PORT_IOBUS;
