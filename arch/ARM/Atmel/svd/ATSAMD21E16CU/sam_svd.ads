...
--  Atmel ATSAMD21E16CU device: Cortex-M0+ Microcontroller with 64KB Flash, 8KB
--  SRAM, 35-pin package (refer to
--  http://www.atmel.com/devices/SAMD21E16CU.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
