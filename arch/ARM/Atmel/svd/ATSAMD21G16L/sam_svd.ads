...
--  Atmel ATSAMD21G16L device: Cortex-M0+ Microcontroller with 64KB Flash, 8KB
--  SRAM, QFN48_LIGHTING-pin package (refer to
--  http://www.atmel.com/devices/SAMD21G16L.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
