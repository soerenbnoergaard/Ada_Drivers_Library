...
--  Atmel ATSAMD21G17AU device: Cortex-M0+ Microcontroller with 128KB Flash,
--  16KB SRAM, 45-pin package (refer to
--  http://www.atmel.com/devices/SAMD21G17AU.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
