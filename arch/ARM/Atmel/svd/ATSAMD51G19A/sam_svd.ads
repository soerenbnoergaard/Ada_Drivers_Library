...
--  Atmel ATSAMD51G19A device: Cortex-M4 Microcontroller with 512KB Flash,
--  192KB SRAM, 48-pin package (refer to
--  http://www.atmel.com/devices/SAMD51G19A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
