...
--  Atmel ATSAMD51J18A device: Cortex-M4 Microcontroller with 256KB Flash,
--  128KB SRAM, 64-pin package (refer to
--  http://www.atmel.com/devices/SAMD51J18A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
