...
--  This spec has been automatically generated from ATSAME51J18A.svd
...
package SAM_SVD.TCC is
   ...
   --  Compare and Capture
   type TCC_CC_DITH4_Registers is array (0 .. 5) of TCC_CC_DITH4_Register
     with Volatile;
   ...
   --  Compare and Capture
   type TCC_CC_DITH5_Registers is array (0 .. 5) of TCC_CC_DITH5_Register
     with Volatile;
   ...
   --  Compare and Capture
   type TCC_CC_DITH6_Registers is array (0 .. 5) of TCC_CC_DITH6_Register
     with Volatile;
   ...
   --  Compare and Capture Buffer
   type TCC_CCBUF_DITH4_Registers is array (0 .. 5)
   ...
   --  Compare and Capture Buffer
   type TCC_CCBUF_DITH5_Registers is array (0 .. 5)
   ...
   --  Compare and Capture Buffer
   type TCC_CCBUF_DITH6_Registers is array (0 .. 5)
   ...
   TCC3_Periph : aliased TCC_Peripheral
     with Import, Address => System'To_Address (16#42001000#);

   --  Timer Counter Control 4
   TCC4_Periph : aliased TCC_Peripheral
     with Import, Address => System'To_Address (16#43001000#);
