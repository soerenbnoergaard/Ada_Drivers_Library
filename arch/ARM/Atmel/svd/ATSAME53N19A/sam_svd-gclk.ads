...
package SAM_SVD.GCLK is
   ...
   type GCLK_SYNCBUSY_Register is record
      ...
      --  Read-only. Generic Clock Generator Control 9 Synchronization Busy
      --  bits
      GENCTRL9       : SYNCBUSY_GENCTRL9Select;
      --  Read-only. Generic Clock Generator Control 10 Synchronization Busy
      --  bits
      GENCTRL10      : SYNCBUSY_GENCTRL10Select;
      --  Read-only. Generic Clock Generator Control 11 Synchronization Busy
      --  bits
      GENCTRL11      : SYNCBUSY_GENCTRL11Select;
      --  unspecified
   ...
   for GCLK_SYNCBUSY_Register use record
      ...
      GENCTRL9       at 0 range 11 .. 11;
      GENCTRL10      at 0 range 12 .. 12;
      GENCTRL11      at 0 range 13 .. 13;
