...
--  Atmel ATSAME53N19A device: Cortex-M4 Microcontroller with 512KB Flash,
--  192KB SRAM, 100-pin package (refer to
--  http://www.atmel.com/devices/SAME53N19A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
