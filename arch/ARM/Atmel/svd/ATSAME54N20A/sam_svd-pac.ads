...
package SAM_SVD.PAC is
   ...
   for PAC_INTFLAGD_Register use record
      ...
      SERCOM6        at 0 range 2 .. 2;
      SERCOM7        at 0 range 3 .. 3;
      TCC4           at 0 range 4 .. 4;
      TC6            at 0 range 5 .. 5;
      TC7            at 0 range 6 .. 6;
      ADC0           at 0 range 7 .. 7;
   ...
   type PAC_STATUSC_Register is record
      ...
      CAN1           : Boolean;
      --  Read-only. GMAC APB Protect Enable
      GMAC           : Boolean;
      --  Read-only. TCC2 APB Protect Enable
      TCC2           : Boolean;
      --  Read-only. TCC3 APB Protect Enable
      TCC3           : Boolean;
   ...
   type PAC_STATUSD_Register is record
      ...
      SERCOM7        : Boolean;
      --  Read-only. TCC4 APB Protect Enable
      TCC4           : Boolean;
      ...
      DAC            : Boolean;
      --  Read-only. I2S APB Protect Enable
      I2S            : Boolean;
