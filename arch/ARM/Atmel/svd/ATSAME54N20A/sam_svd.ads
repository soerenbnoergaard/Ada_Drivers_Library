...
--  Atmel ATSAME54N20A device: Cortex-M4 Microcontroller with 1MB Flash, 256KB
--  SRAM, 100-pin package (refer to
--  http://www.atmel.com/devices/SAME54N20A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
