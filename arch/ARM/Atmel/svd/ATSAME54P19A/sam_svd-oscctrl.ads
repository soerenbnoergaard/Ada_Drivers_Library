...
package SAM_SVD.OSCCTRL is
   ...
   type DPLLCTRLB0_LTIMESelect is
     (
      ...
      DPLLCTRLB0_LTIMESelect_800Us,
      --  Time-out if no lock within 900us
      DPLLCTRLB0_LTIMESelect_900Us,
      --  Time-out if no lock within 1ms
      DPLLCTRLB0_LTIMESelect_1Ms,
      --  Time-out if no lock within 1.1ms
      DPLLCTRLB0_LTIMESelect_1P1Ms)
     with Size => 3;
   for DPLLCTRLB0_LTIMESelect use
     (Default => 0,
      DPLLCTRLB0_LTIMESelect_800Us => 4,
      DPLLCTRLB0_LTIMESelect_900Us => 5,
      DPLLCTRLB0_LTIMESelect_1Ms => 6,
      DPLLCTRLB0_LTIMESelect_1P1Ms => 7);
