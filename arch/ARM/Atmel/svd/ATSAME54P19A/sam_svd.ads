...
--  Atmel ATSAME54P19A device: Cortex-M4 Microcontroller with 512KB Flash,
--  192KB SRAM, 128-pin package (refer to
--  http://www.atmel.com/devices/SAME54P19A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
   ...
   SDHC1_Base : constant System.Address :=
     System'To_Address (16#46000000#);
