...
--  Atmel ATSAME54P20A device: Cortex-M4 Microcontroller with 1MB Flash, 256KB
--  SRAM, 128-pin package (refer to
--  http://www.atmel.com/devices/SAME54P20A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
