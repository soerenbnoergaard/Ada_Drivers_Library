...
package SAM_SVD.MATRIX is
   ...
   --  MATRIX_MRCR_RCB array
   type MATRIX_MRCR_RCB_Field_Array_1 is array (8 .. 11) of Boolean
   ...
   type MATRIX_Peripheral is record
      ...
      MATRIX_MCFG9  : aliased MATRIX_MCFG_Register;
   ...
   for MATRIX_Peripheral use record
      ...
      MATRIX_MCFG9  at 16#24# range 0 .. 31;
