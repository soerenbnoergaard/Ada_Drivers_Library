...
package SAM_SVD.ADC is
   ...
   type MR_LOWRES_Field is
     (
      --  10-bit resolution. For higher resolution by averaging, please refer
      --  to "ADC Extended Mode Register" on page 77.
      Bits_10,
      --  8-bit resolution
      Bits_8)
     with Size => 1;
   ...
   --  ADC Clock Prescaler Division forced to 1
   type MR_DIV1_Field is
     (
      --  The PRESCAL field is used to generate the ADC clock unless DIV3 is
      --  written to 1.
      No_Div1,
      --  The ADC clock equals peripheral clock (PRESCAL and DIV3 fields have
      --  no effect).
      Force_Div1)
     with Size => 1;
   for MR_DIV1_Field use
     (No_Div1 => 0,
      Force_Div1 => 1);
   ...
   --  ADC Clock Prescaler Division forced to 3
   type MR_DIV3_Field is
     (
      --  The PRESCAL field is used to generate the ADC clock unless DIV1 is
      --  written to 1.
      No_Div3,
      --  The ADC clock equals peripheral clock/3 unless DIV1 is written to 1.
      Force_Div3)
     with Size => 1;
   for MR_DIV3_Field use
     (No_Div3 => 0,
      Force_Div3 => 1);
   ...
   type ADC_MR_Register is record
      ...
      --  ADC Clock Prescaler Division forced to 1
      DIV1           : MR_DIV1_Field := SAM_SVD.ADC.No_Div1;
      --  unspecified
      ...
      --  ADC Clock Prescaler Division forced to 3
      DIV3           : MR_DIV3_Field := SAM_SVD.ADC.No_Div3;
      --  Use Sequence Enable
