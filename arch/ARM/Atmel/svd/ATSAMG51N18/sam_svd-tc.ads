--  This spec has been automatically generated from ATSAMG51N18.svd
...
package SAM_SVD.TC is
   ...
   type SR_Register is record
      ...
      ETRGS          : Boolean;
      --  Read-only. End of Receiver Transfer (cleared by writing TC_RCR or
      --  TC_RNCR)
      ENDRX          : Boolean;
      --  Read-only. Reception Buffer Full (cleared by writing TC_RCR or
      --  TC_RNCR)
      RXBUFF         : Boolean;
      --  unspecified
   ...
   subtype TC0_RCR2_RXCTR_Field is HAL.UInt16;

   --  Receive Counter Register (pdc = 2)
   type TC0_RCR2_Register is record
      --  Receive Counter Register
      RXCTR          : TC0_RCR2_RXCTR_Field := 16#0#;
      --  unspecified
   ...
   for TC0_RCR2_Register use record
      RXCTR          at 0 range 0 .. 15;
      Reserved_16_31 at 0 range 16 .. 31;
   end record;

   subtype TC0_RNCR2_RXNCTR_Field is HAL.UInt16;

   --  Receive Next Counter Register (pdc = 2)
   type TC0_RNCR2_Register is record
      --  Receive Next Counter
      RXNCTR         : TC0_RNCR2_RXNCTR_Field := 16#0#;
      --  unspecified
      Reserved_16_31 : HAL.UInt16 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for TC0_RNCR2_Register use record
      RXNCTR         at 0 range 0 .. 15;
      Reserved_16_31 at 0 range 16 .. 31;
   end record;

   --  Transfer Control Register (pdc = 2)
   type TC0_PTCR2_Register is record
   ...
   for TC0_PTCR2_Register use record
   ...
   type TC0_PTSR2_Register is record
   ...
   for TC0_PTSR2_Register use record
      RXTEN         at 0 range 0 .. 0;
      Reserved_1_7  at 0 range 1 .. 7;
      TXTEN         at 0 range 8 .. 8;
   ...
   is record
      ...
      --  Receive Counter Register (pdc = 2)
      RCR2           : aliased TC0_RCR2_Register;
      --  Receive Next Pointer Register (pdc = 2)
      RNPR2          : aliased HAL.UInt32;
      --  Receive Next Counter Register (pdc = 2)
      RNCR2          : aliased TC0_RNCR2_Register;
      --  Transfer Control Register (pdc = 2)
      PTCR2          : aliased TC0_PTCR2_Register;
      --  Transfer Status Register (pdc = 2)
      PTSR2          : aliased TC0_PTSR2_Register;
