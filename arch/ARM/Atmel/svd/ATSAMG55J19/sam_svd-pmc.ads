...
package SAM_SVD.PMC is
   ...
   type CKGR_MOR_Register is record
      ...
      MOSCRCF        : CKGR_MOR_MOSCRCF_Field :=
                        SAM_SVD.PMC.CKGR_MOR_MOSCRCF_Field_8_Mhz;
      --  unspecified
   ...
   subtype CKGR_PLLAR_MULA_Field is HAL.UInt13;
   ...
   for CKGR_PLLAR_Register use record
      ...
      MULA           at 0 range 16 .. 28;
      ZERO           at 0 range 29 .. 29;
      Reserved_30_31 at 0 range 30 .. 31;
   end record;

   subtype CKGR_PLLBR_PLLBEN_Field is HAL.UInt8;
   ...
   --  PMC_PCER1_PID array
   type PMC_PCER1_PID_Field_Array is array (47 .. 49) of Boolean
   ...
   type PMC_PCER1_Register is record
      ...
      --  Write-only. Peripheral Clock 47 Enable
   ...
   for PMC_PCER1_Register use record
      ...
      PID            at 0 range 15 .. 17;
      Reserved_18_31 at 0 range 18 .. 31;
   end record;

   --  PMC_PCDR1_PID array
   type PMC_PCDR1_PID_Field_Array is array (47 .. 49) of Boolean
     with Component_Size => 1, Size => 3;
   ...
   type PMC_PCDR1_Register is record
      --  unspecified
      Reserved_0_14  : HAL.UInt15 := 16#0#;
      --  Write-only. Peripheral Clock 47 Disable
   ...
   --  PMC_PCSR1_PID array
   type PMC_PCSR1_PID_Field_Array is array (47 .. 49) of Boolean
     with Component_Size => 1, Size => 3;
   ...
   type PMC_PCSR1_Register is record
      --  unspecified
      Reserved_0_14  : HAL.UInt15;
      --  Read-only. Peripheral Clock 47 Status
   ...
   type PMC_PCR_Register is record
      ...
      --  Divisor Value
      DIV            : PMC_PCR_DIV_Field := SAM_SVD.PMC.Periph_Div_Mck;
      --  unspecified
   ...
   subtype PMC_OCR_CAL16_Field is HAL.UInt7;
   subtype PMC_OCR_CAL24_Field is HAL.UInt7;
   ...
   type PMC_PMMR_Register is record
      ...
      PLLB_MMAX      : PMC_PMMR_PLLB_MMAX_Field := 16#7FF#;
      --  unspecified
