...
package SAM_SVD.TWI is
   ...
   subtype TWI0_ACR_DATAL_Field is HAL.UInt8;
   subtype TWI0_ACR_NDATAL_Field is HAL.UInt8;
   ...
   TWI0_Periph : aliased TWI_Peripheral
     with Import, Address => System'To_Address (16#4000C600#);

   --  Two-wire Interface 1
   TWI1_Periph : aliased TWI_Peripheral
     with Import, Address => System'To_Address (16#40020600#);

   --  Two-wire Interface 2
   TWI2_Periph : aliased TWI_Peripheral
     with Import, Address => System'To_Address (16#40024600#);

   --  Two-wire Interface 3
   TWI3_Periph : aliased TWI_Peripheral
     with Import, Address => System'To_Address (16#40018600#);

   --  Two-wire Interface 4
   TWI4_Periph : aliased TWI_Peripheral
     with Import, Address => System'To_Address (16#4001C600#);

   --  Two-wire Interface 5
   TWI5_Periph : aliased TWI_Peripheral
     with Import, Address => System'To_Address (16#40008600#);

   --  Two-wire Interface 6
   TWI6_Periph : aliased TWI_Peripheral
     with Import, Address => System'To_Address (16#40040600#);

   --  Two-wire Interface 7
   TWI7_Periph : aliased TWI_Peripheral
     with Import, Address => System'To_Address (16#40034600#);
