...
package SAM_SVD.UDP is
   ...
   --  UDP_RST_EP_EP array
   type UDP_RST_EP_EP_Field_Array is array (0 .. 5) of Boolean
   ...
   type UDP_CSR_Register is record
      ...
      EPEDS          : Boolean := False;
      --  Number of Bytes Available in the FIFO (Read-only)
   ...
   --  Endpoint Control and Status Register
   type UDP_CSR_Registers is array (0 .. 5) of UDP_CSR_Register
     with Volatile;

   --  Endpoint Type (Read/Write)
   type CSR0_ISOCHRONOUS_EPTYPE_Field is
     (
      --  Control
      Ctrl,
      --  Isochronous OUT
      ...
      Int_In)
     with Size => 3;
   for CSR0_ISOCHRONOUS_EPTYPE_Field use
     (Ctrl => 0,
      Iso_Out => 1,
      Bulk_Out => 2,
      Int_Out => 3,
   ...
   subtype UDP_CSR0_ISOCHRONOUS_RXBYTECNT_Field is HAL.UInt11;

   --  Endpoint Control and Status Register
   type UDP_CSR0_ISOCHRONOUS_Register is record
      --  Generates an IN Packet with Data Previously Written in the DPR
      TXCOMP         : Boolean := False;
      --  Receive Data Bank 0
      RX_DATA_BK0    : Boolean := False;
      ...
      DIR            : Boolean := False;
      --  Endpoint Type (Read/Write)
      EPTYPE         : CSR0_ISOCHRONOUS_EPTYPE_Field := SAM_SVD.UDP.Ctrl;
      --  Data Toggle (Read-only)
      DTGLE          : Boolean := False;
      --  unspecified
      Reserved_12_14 : HAL.UInt3 := 16#0#;
      ...
      EPEDS          : Boolean := False;
      --  Number of Bytes Available in the FIFO (Read-only)
      RXBYTECNT      : UDP_CSR0_ISOCHRONOUS_RXBYTECNT_Field := 16#0#;
      --  unspecified
      Reserved_27_31 : HAL.UInt5 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for UDP_CSR0_ISOCHRONOUS_Register use record
      TXCOMP         at 0 range 0 .. 0;
      RX_DATA_BK0    at 0 range 1 .. 1;
      RXSETUP        at 0 range 2 .. 2;
   ...
   is record
      ...
      case Discriminent is
         ...
         when UDP_Disc_0_Isochronous =>
            --  Endpoint Control and Status Register
            CSR0_ISOCHRONOUS : aliased UDP_CSR0_ISOCHRONOUS_Register;
      end case;
   end record
   ...
   for UDP_Peripheral use record
      ...
      CSR              at 16#30# range 0 .. 191;
      CSR0_ISOCHRONOUS at 16#30# range 0 .. 31;
   end record;
