...
--  Atmel ATSAMHA1G14AB device: Cortex-M0+ Microcontroller with 16KB Flash, 4KB
--  SRAM, 6632-pin package (refer to
--  http://www.atmel.com/devices/SAMHA1G14AB.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
   ...
   LINCTRL_Base : constant System.Address :=
     System'To_Address (16#42005800#);
