...
package SAM_SVD.DMAC is
   ...
   type DMAC_SWTRIGCTRL_SWTRIG_Field_Array is array (0 .. 15) of Boolean
   ...
   type DMAC_INTSTATUS_CHINT_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   for DMAC_INTSTATUS_Register use record
      CHINT          at 0 range 0 .. 15;
      Reserved_16_31 at 0 range 16 .. 31;
   end record;

   --  DMAC_BUSYCH_BUSYCH array
   type DMAC_BUSYCH_BUSYCH_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   for DMAC_BUSYCH_Register use record
      BUSYCH         at 0 range 0 .. 15;
      Reserved_16_31 at 0 range 16 .. 31;
   end record;

   --  DMAC_PENDCH_PENDCH array
   type DMAC_PENDCH_PENDCH_Field_Array is array (0 .. 15) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   DMAC_Periph : aliased DMAC_Peripheral
     with Import, Address => System'To_Address (16#44000400#);
