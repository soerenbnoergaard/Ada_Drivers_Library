...
package SAM_SVD.EVSYS is
   ...
   type EVSYS_CHSTATUS_USRRDY_Field_Array is array (0 .. 11) of Boolean
   ...
   type EVSYS_CHSTATUS_CHBUSY_Field_Array is array (0 .. 11) of Boolean
     with Component_Size => 1, Size => 12;
   ...
   for EVSYS_CHSTATUS_Register use record
      USRRDY         at 0 range 0 .. 11;
      Reserved_12_15 at 0 range 12 .. 15;
      CHBUSY         at 0 range 16 .. 27;
      Reserved_28_31 at 0 range 28 .. 31;
   end record;

   --  EVSYS_INTENCLR_OVR array
   type EVSYS_INTENCLR_OVR_Field_Array is array (0 .. 11) of Boolean
     with Component_Size => 1, Size => 12;
   ...
   type EVSYS_INTENCLR_EVD_Field_Array is array (0 .. 11) of Boolean
     with Component_Size => 1, Size => 12;
   ...
   for EVSYS_INTENCLR_Register use record
      OVR            at 0 range 0 .. 11;
      Reserved_12_15 at 0 range 12 .. 15;
      EVD            at 0 range 16 .. 27;
      Reserved_28_31 at 0 range 28 .. 31;
   end record;

   --  EVSYS_INTENSET_OVR array
   type EVSYS_INTENSET_OVR_Field_Array is array (0 .. 11) of Boolean
     with Component_Size => 1, Size => 12;
   ...
   type EVSYS_INTENSET_EVD_Field_Array is array (0 .. 11) of Boolean
     with Component_Size => 1, Size => 12;
   ...
   type EVSYS_INTFLAG_OVR_Field_Array is array (0 .. 11) of Boolean
     with Component_Size => 1, Size => 12;
   ...
   type EVSYS_INTFLAG_EVD_Field_Array is array (0 .. 11) of Boolean
     with Component_Size => 1, Size => 12;
   ...
   type EVSYS_SWEVT_CHANNEL_Field_Array is array (0 .. 11) of Boolean
     with Component_Size => 1, Size => 12;
   ...
   --  Channel n
   type EVSYS_CHANNEL_Registers is array (0 .. 11) of EVSYS_CHANNEL_Register
     with Volatile;

   subtype EVSYS_USER_CHANNEL_Field is HAL.UInt5;
   ...
   for EVSYS_USER_Register use record
      CHANNEL       at 0 range 0 .. 4;
      Reserved_5_31 at 0 range 5 .. 31;
   end record;

   --  User Multiplexer n
   type EVSYS_USER_Registers is array (0 .. 44) of EVSYS_USER_Register
     with Volatile;
   ...
   for EVSYS_Peripheral use record
      ...
      CHANNEL  at 16#20# range 0 .. 383;
      USER     at 16#80# range 0 .. 1439;
   end record;
