...
package SAM_SVD.MCLK is
   ...
   --  Control A
   type MCLK_CTRLA_Register is record
      --  unspecified
   ...
   for MCLK_CTRLA_Register use record
      Reserved_0_1 at 0 range 0 .. 1;
      CFDEN        at 0 range 2 .. 2;
      Reserved_3_3 at 0 range 3 .. 3;
      EMCLK        at 0 range 4 .. 4;
   ...
   type MCLK_Peripheral is record
      --  Control A
      CTRLA    : aliased MCLK_CTRLA_Register;
      --  Interrupt Enable Clear
