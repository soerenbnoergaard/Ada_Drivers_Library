...
--  This spec has been automatically generated from ATSAML21J18A.svd
...
package SAM_SVD.TCC is
   ...
   type TCC_STATUS_CCBUFV_Field_Array is array (0 .. 3) of Boolean
     with Component_Size => 1, Size => 4;
   ...
   subtype TCC_PER_DITH5_DITHER_Field is HAL.UInt5;
   subtype TCC_PER_DITH5_PER_Field is HAL.UInt19;

   --  Period
   type TCC_PER_DITH5_Register is record
      --  Dithering Cycle Number
      DITHER         : TCC_PER_DITH5_DITHER_Field := 16#1F#;
      --  Period Value
   ...
   subtype TCC_PER_DITH6_DITHER_Field is HAL.UInt6;
   subtype TCC_PER_DITH6_PER_Field is HAL.UInt18;

   --  Period
   type TCC_PER_DITH6_Register is record
      --  Dithering Cycle Number
      DITHER         : TCC_PER_DITH6_DITHER_Field := 16#3F#;
      --  Period Value
   ...
   subtype TCC_CC_DITH4_DITHER_Field is HAL.UInt4;
   subtype TCC_CC_DITH4_CC_Field is HAL.UInt20;

   --  Compare and Capture
   type TCC_CC_DITH4_Register is record
      --  Dithering Cycle Number
      DITHER         : TCC_CC_DITH4_DITHER_Field := 16#0#;
      --  Channel Compare/Capture Value
   ...
   subtype TCC_CC_DITH5_DITHER_Field is HAL.UInt5;
   subtype TCC_CC_DITH5_CC_Field is HAL.UInt19;

   --  Compare and Capture
   type TCC_CC_DITH5_Register is record
      --  Dithering Cycle Number
      DITHER         : TCC_CC_DITH5_DITHER_Field := 16#0#;
      --  Channel Compare/Capture Value
   ...
   subtype TCC_CC_DITH6_DITHER_Field is HAL.UInt6;
   subtype TCC_CC_DITH6_CC_Field is HAL.UInt18;

   --  Compare and Capture
   type TCC_CC_DITH6_Register is record
      --  Dithering Cycle Number
      DITHER         : TCC_CC_DITH6_DITHER_Field := 16#0#;
      --  Channel Compare/Capture Value
   ...
   type WAVEBUF_WAVEGENBSelect is
     (
      --  Normal frequency
      Nfrq,
      --  Match frequency
      ...
      Dstop)
     with Size => 3;
   for WAVEBUF_WAVEGENBSelect use
     (Nfrq => 0,
      Mfrq => 1,
      Npwm => 2,
      Dscritical => 4,
   ...
   subtype TCC_WAVEBUF_RAMPB_Field is HAL.UInt2;

   --  TCC_WAVEBUF_CICCENB array
   type TCC_WAVEBUF_CICCENB_Field_Array is array (0 .. 3) of Boolean
     with Component_Size => 1, Size => 4;

   --  Type definition for TCC_WAVEBUF_CICCENB
   type TCC_WAVEBUF_CICCENB_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
         ...
         when True =>
            --  CICCENB as an array
            Arr : TCC_WAVEBUF_CICCENB_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 4;

   for TCC_WAVEBUF_CICCENB_Field use record
      Val at 0 range 0 .. 3;
      Arr at 0 range 0 .. 3;
   end record;

   --  TCC_WAVEBUF_POLB array
   type TCC_WAVEBUF_POLB_Field_Array is array (0 .. 3) of Boolean
     with Component_Size => 1, Size => 4;

   --  Type definition for TCC_WAVEBUF_POLB
   type TCC_WAVEBUF_POLB_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
         ...
         when True =>
            --  POLB as an array
            Arr : TCC_WAVEBUF_POLB_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 4;

   for TCC_WAVEBUF_POLB_Field use record
      Val at 0 range 0 .. 3;
      Arr at 0 range 0 .. 3;
   end record;

   --  TCC_WAVEBUF_SWAPB array
   type TCC_WAVEBUF_SWAPB_Field_Array is array (0 .. 3) of Boolean
     with Component_Size => 1, Size => 4;

   --  Type definition for TCC_WAVEBUF_SWAPB
   type TCC_WAVEBUF_SWAPB_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
         ...
         when True =>
            --  SWAPB as an array
            Arr : TCC_WAVEBUF_SWAPB_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 4;

   for TCC_WAVEBUF_SWAPB_Field use record
      Val at 0 range 0 .. 3;
      Arr at 0 range 0 .. 3;
   end record;

   --  Waveform Control Buffer
   type TCC_WAVEBUF_Register is record
      --  Waveform Generation Buffer
      WAVEGENB       : WAVEBUF_WAVEGENBSelect := SAM_SVD.TCC.Nfrq;
      --  unspecified
      Reserved_3_3   : HAL.Bit := 16#0#;
      --  Ramp Mode Buffer
      RAMPB          : TCC_WAVEBUF_RAMPB_Field := 16#0#;
      --  unspecified
      Reserved_6_6   : HAL.Bit := 16#0#;
      --  Circular Period Enable Buffer
      CIPERENB       : Boolean := False;
      --  Circular Channel 0 Enable Buffer
      CICCENB        : TCC_WAVEBUF_CICCENB_Field :=
                        (As_Array => False, Val => 16#0#);
      --  unspecified
      Reserved_12_15 : HAL.UInt4 := 16#0#;
      --  Channel 0 Polarity Buffer
      POLB           : TCC_WAVEBUF_POLB_Field :=
                        (As_Array => False, Val => 16#0#);
      --  unspecified
      Reserved_20_23 : HAL.UInt4 := 16#0#;
      --  Swap DTI Output Pair 0 Buffer
      SWAPB          : TCC_WAVEBUF_SWAPB_Field :=
                        (As_Array => False, Val => 16#0#);
      --  unspecified
      Reserved_28_31 : HAL.UInt4 := 16#0#;
   end record
   ...
   for TCC_WAVEBUF_Register use record
   ...
   subtype TCC_PERBUF_DITH4_DITHERBUF_Field is HAL.UInt4;
   subtype TCC_PERBUF_DITH4_PERBUF_Field is HAL.UInt20;

   --  Period Buffer
   type TCC_PERBUF_DITH4_Register is record
      --  Dithering Buffer Cycle Number
      DITHERBUF      : TCC_PERBUF_DITH4_DITHERBUF_Field := 16#F#;
      --  Period Buffer Value
      PERBUF         : TCC_PERBUF_DITH4_PERBUF_Field := 16#FFFFF#;
      --  unspecified
      Reserved_24_31 : HAL.UInt8 := 16#FF#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for TCC_PERBUF_DITH4_Register use record
      DITHERBUF      at 0 range 0 .. 3;
      PERBUF         at 0 range 4 .. 23;
      Reserved_24_31 at 0 range 24 .. 31;
   end record;

   subtype TCC_PERBUF_DITH5_DITHERBUF_Field is HAL.UInt5;
   subtype TCC_PERBUF_DITH5_PERBUF_Field is HAL.UInt19;

   --  Period Buffer
   type TCC_PERBUF_DITH5_Register is record
      --  Dithering Buffer Cycle Number
      DITHERBUF      : TCC_PERBUF_DITH5_DITHERBUF_Field := 16#1F#;
      --  Period Buffer Value
      PERBUF         : TCC_PERBUF_DITH5_PERBUF_Field := 16#7FFFF#;
      --  unspecified
      Reserved_24_31 : HAL.UInt8 := 16#FF#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for TCC_PERBUF_DITH5_Register use record
      DITHERBUF      at 0 range 0 .. 4;
      PERBUF         at 0 range 5 .. 23;
      Reserved_24_31 at 0 range 24 .. 31;
   end record;

   subtype TCC_PERBUF_DITH6_DITHERBUF_Field is HAL.UInt6;
   subtype TCC_PERBUF_DITH6_PERBUF_Field is HAL.UInt18;

   --  Period Buffer
   type TCC_PERBUF_DITH6_Register is record
      --  Dithering Buffer Cycle Number
      DITHERBUF      : TCC_PERBUF_DITH6_DITHERBUF_Field := 16#3F#;
      --  Period Buffer Value
      PERBUF         : TCC_PERBUF_DITH6_PERBUF_Field := 16#3FFFF#;
      --  unspecified
      Reserved_24_31 : HAL.UInt8 := 16#FF#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for TCC_PERBUF_DITH6_Register use record
   ...
   --  Compare and Capture Buffer
   type TCC_CCBUF_Registers is array (0 .. 3) of TCC_CCBUF_Register
     with Volatile;

   subtype TCC_CCBUF_DITH4_CCBUF_Field is HAL.UInt4;
   subtype TCC_CCBUF_DITH4_DITHERBUF_Field is HAL.UInt20;

   --  Compare and Capture Buffer
   type TCC_CCBUF_DITH4_Register is record
      --  Channel Compare/Capture Buffer Value
      CCBUF          : TCC_CCBUF_DITH4_CCBUF_Field := 16#0#;
      --  Dithering Buffer Cycle Number
      DITHERBUF      : TCC_CCBUF_DITH4_DITHERBUF_Field := 16#0#;
      --  unspecified
      Reserved_24_31 : HAL.UInt8 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for TCC_CCBUF_DITH4_Register use record
   ...
   --  Compare and Capture Buffer
   type TCC_CCBUF_DITH4_Registers is array (0 .. 3)
     of TCC_CCBUF_DITH4_Register
     with Volatile;

   subtype TCC_CCBUF_DITH5_DITHERBUF_Field is HAL.UInt5;
   subtype TCC_CCBUF_DITH5_CCBUF_Field is HAL.UInt19;

   --  Compare and Capture Buffer
   type TCC_CCBUF_DITH5_Register is record
      --  Dithering Buffer Cycle Number
      DITHERBUF      : TCC_CCBUF_DITH5_DITHERBUF_Field := 16#0#;
      --  Channel Compare/Capture Buffer Value
      CCBUF          : TCC_CCBUF_DITH5_CCBUF_Field := 16#0#;
      --  unspecified
      Reserved_24_31 : HAL.UInt8 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for TCC_CCBUF_DITH5_Register use record
      DITHERBUF      at 0 range 0 .. 4;
   ...
   --  Compare and Capture Buffer
   type TCC_CCBUF_DITH5_Registers is array (0 .. 3)
     of TCC_CCBUF_DITH5_Register
     with Volatile;

   subtype TCC_CCBUF_DITH6_DITHERBUF_Field is HAL.UInt6;
   subtype TCC_CCBUF_DITH6_CCBUF_Field is HAL.UInt18;

   --  Compare and Capture Buffer
   type TCC_CCBUF_DITH6_Register is record
      --  Dithering Buffer Cycle Number
      DITHERBUF      : TCC_CCBUF_DITH6_DITHERBUF_Field := 16#0#;
      --  Channel Compare/Capture Buffer Value
      CCBUF          : TCC_CCBUF_DITH6_CCBUF_Field := 16#0#;
      --  unspecified
      Reserved_24_31 : HAL.UInt8 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for TCC_CCBUF_DITH6_Register use record
      DITHERBUF      at 0 range 0 .. 5;
   ...
   --  Compare and Capture Buffer
   type TCC_CCBUF_DITH6_Registers is array (0 .. 3)
     of TCC_CCBUF_DITH6_Register
     with Volatile;
   ...
   is record
      ...
      --  Waveform Control Buffer
      WAVEBUF      : aliased TCC_WAVEBUF_Register;
      case Discriminent is
         ...
         when Dith4 =>
            ...
            --  Period Buffer
            PERBUF_DITH4 : aliased TCC_PERBUF_DITH4_Register;
            --  Compare and Capture Buffer
            CCBUF_DITH4 : aliased TCC_CCBUF_DITH4_Registers;
         when Dith5 =>
            --  Count
            ...
            --  Period Buffer
            PERBUF_DITH5 : aliased TCC_PERBUF_DITH5_Register;
            --  Compare and Capture Buffer
            CCBUF_DITH5 : aliased TCC_CCBUF_DITH5_Registers;
         when Dith6 =>
            --  Count
            ...
            --  Period Buffer
            PERBUF_DITH6 : aliased TCC_PERBUF_DITH6_Register;
            --  Compare and Capture Buffer
            CCBUF_DITH6 : aliased TCC_CCBUF_DITH6_Registers;
      end case;
   end record
