...
package SAM_SVD.USB is
   ...
   type USB_QOSCTRL_USB_DEVICE_Register is record
      ...
      CQOS         : USB_QOSCTRL_USB_DEVICE_CQOS_Field := 16#1#;
      --  Data Quality of Service
      DQOS         : USB_QOSCTRL_USB_DEVICE_DQOS_Field := 16#1#;
      --  unspecified
      Reserved_4_7 : HAL.UInt4 := 16#1#;
   end record
     with Volatile_Full_Access, Size => 8, Bit_Order => System.Low_Order_First;
   ...
   type USB_QOSCTRL_USB_HOST_Register is record
      --  Configuration Quality of Service
      CQOS         : USB_QOSCTRL_USB_HOST_CQOS_Field := 16#1#;
      --  Data Quality of Service
      DQOS         : USB_QOSCTRL_USB_HOST_DQOS_Field := 16#1#;
      --  unspecified
      Reserved_4_7 : HAL.UInt4 := 16#1#;
   end record
     with Volatile_Full_Access, Size => 8, Bit_Order => System.Low_Order_First;
