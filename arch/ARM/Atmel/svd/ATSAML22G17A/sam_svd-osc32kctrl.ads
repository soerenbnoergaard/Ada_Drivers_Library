...
package SAM_SVD.OSC32KCTRL is
   ...
   type OSC32KCTRL_SLCDCTRL_Register is record
      --  SLCD Clock Selection
      SLCDSEL      : Boolean := False;
      --  unspecified
      Reserved_1_7 : HAL.UInt7 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 8, Bit_Order => System.Low_Order_First;

   for OSC32KCTRL_SLCDCTRL_Register use record
      SLCDSEL      at 0 range 0 .. 0;
   ...
   type OSC32KCTRL_Peripheral is record
      ...
      --  SLCD Clock Selection
      SLCDCTRL  : aliased OSC32KCTRL_SLCDCTRL_Register;
      --  32kHz External Crystal Oscillator (XOSC32K) Control
