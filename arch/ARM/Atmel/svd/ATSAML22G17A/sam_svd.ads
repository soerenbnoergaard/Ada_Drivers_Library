...
--  Atmel ATSAML22G17A device: Cortex-M0+ Microcontroller with 128KB Flash,
--  16KB SRAM, 49-pin package (refer to
--  http://www.atmel.com/devices/SAML22G17A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
