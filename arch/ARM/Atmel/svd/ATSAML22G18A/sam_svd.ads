...
--  Atmel ATSAML22G18A device: Cortex-M0+ Microcontroller with 256KB Flash,
--  32KB SRAM, 49-pin package (refer to
--  http://www.atmel.com/devices/SAML22G18A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
