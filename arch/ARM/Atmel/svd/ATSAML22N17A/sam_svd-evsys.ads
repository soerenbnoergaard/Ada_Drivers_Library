...
package SAM_SVD.EVSYS is
   ...
   type EVSYS_SWEVT_CHANNEL_Field_Array is array (0 .. 7) of Boolean
     with Component_Size => 1, Size => 8;
   ...
   --  Channel n
   type EVSYS_CHANNEL_Registers is array (0 .. 7) of EVSYS_CHANNEL_Register
     with Volatile;
   ...
   --  User Multiplexer n
   type EVSYS_USER_Registers is array (0 .. 30) of EVSYS_USER_Register
     with Volatile;
   ...
   for EVSYS_Peripheral use record
      ...
      CHANNEL  at 16#20# range 0 .. 255;
      USER     at 16#80# range 0 .. 991;
   end record;
