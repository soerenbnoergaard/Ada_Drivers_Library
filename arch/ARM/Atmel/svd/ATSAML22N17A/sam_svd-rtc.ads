...
package SAM_SVD.RTC is
   ...
   type RTC_SYNCBUSY_RTC_MODE0_GP_Field_Array is array (0 .. 1) of Boolean
   ...
   --  General Purpose
   type RTC_GP_RTC_MODE0_Registers is array (0 .. 1) of HAL.UInt32
     with Volatile;
   ...
   type RTC_SYNCBUSY_RTC_MODE1_GP_Field_Array is array (0 .. 1) of Boolean
     with Component_Size => 1, Size => 2;
   ...
   --  General Purpose
   type RTC_GP_RTC_MODE1_Registers is array (0 .. 1) of HAL.UInt32
     with Volatile;
   ...
   type RTC_SYNCBUSY_RTC_MODE2_GP_Field_Array is array (0 .. 1) of Boolean
     with Component_Size => 1, Size => 2;
   ...
   --  General Purpose
   type RTC_GP_RTC_MODE2_Registers is array (0 .. 1) of HAL.UInt32
     with Volatile;
