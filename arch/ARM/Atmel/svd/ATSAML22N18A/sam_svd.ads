...
--  Atmel ATSAML22N18A device: Cortex-M0+ Microcontroller with 256KB Flash,
--  32KB SRAM, 100-pin package (refer to
--  http://www.atmel.com/devices/SAML22N18A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
   ...
   SLCD_Base : constant System.Address :=
