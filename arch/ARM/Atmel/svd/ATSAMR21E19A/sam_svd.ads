...
--  Atmel ATSAMR21E19A device: Cortex-M0+ Microcontroller with 256KB Flash,
--  32KB SRAM, SIP48_RF233_FL512KB-pin package (refer to
--  http://www.atmel.com/devices/SAMR21E19A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
