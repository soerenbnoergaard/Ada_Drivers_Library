...
--  Atmel ATSAMR21G16A device: Cortex-M0+ Microcontroller with 64KB Flash, 16KB
--  SRAM, 233-pin package (refer to
--  http://www.atmel.com/devices/SAMR21G16A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
