...
--  Atmel ATSAMR21G18A device: Cortex-M0+ Microcontroller with 256KB Flash,
--  32KB SRAM, 233-pin package (refer to
--  http://www.atmel.com/devices/SAMR21G18A.aspx for more)
package SAM_SVD is
   pragma Preelaborate;
   ...
   RFCTRL_Base : constant System.Address :=
