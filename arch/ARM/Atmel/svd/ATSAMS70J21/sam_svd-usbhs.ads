...
package SAM_SVD.USBHS is
   ...
   type USBHS_DEVISR_Register is record
      ...
      PEP_9          : Boolean;
      --  Read-only. Endpoint 10 Interrupt
      PEP_10         : Boolean;
      --  Read-only. Endpoint 11 Interrupt
      PEP_11         : Boolean;
      --  unspecified
   ...
   for USBHS_DEVISR_Register use record
      ...
      PEP_10         at 0 range 22 .. 22;
      PEP_11         at 0 range 23 .. 23;
   ...
   type USBHS_DEVIMR_Register is record
      ...
      PEP_9          : Boolean;
      --  Read-only. Endpoint 10 Interrupt Mask
      PEP_10         : Boolean;
      --  Read-only. Endpoint 11 Interrupt Mask
      PEP_11         : Boolean;
      --  unspecified
      Reserved_24_24 : HAL.Bit;
   ...
   type USBHS_DEVIDR_Register is record
      ...
      PEP_9          : Boolean := False;
      --  Write-only. Endpoint 10 Interrupt Disable
      PEP_10         : Boolean := False;
      --  Write-only. Endpoint 11 Interrupt Disable
      PEP_11         : Boolean := False;
      --  unspecified
   ...
   type USBHS_DEVIER_Register is record
      ...
      PEP_9          : Boolean := False;
      --  Write-only. Endpoint 10 Interrupt Enable
      PEP_10         : Boolean := False;
      --  Write-only. Endpoint 11 Interrupt Enable
      PEP_11         : Boolean := False;
      --  unspecified
      Reserved_24_24 : HAL.Bit := 16#0#;
   ...
   type USBHS_HSTISR_Register is record
      ...
      PEP_9          : Boolean;
      --  Read-only. Pipe 10 Interrupt
      PEP_10         : Boolean;
      --  Read-only. Pipe 11 Interrupt
      PEP_11         : Boolean;
      --  unspecified
   ...
   for USBHS_HSTISR_Register use record
      ...
      PEP_10         at 0 range 18 .. 18;
      PEP_11         at 0 range 19 .. 19;
   ...
   type USBHS_HSTIMR_Register is record
      ...
      PEP_9          : Boolean;
      --  Read-only. Pipe 10 Interrupt Enable
      PEP_10         : Boolean;
      --  Read-only. Pipe 11 Interrupt Enable
      PEP_11         : Boolean;
      --  unspecified
      Reserved_20_24 : HAL.UInt5;
   ...
   type USBHS_HSTIDR_Register is record
      ...
      PEP_9          : Boolean := False;
      --  Write-only. Pipe 10 Interrupt Disable
      PEP_10         : Boolean := False;
      --  Write-only. Pipe 11 Interrupt Disable
      PEP_11         : Boolean := False;
      --  unspecified
   ...
   type USBHS_HSTIER_Register is record
      ...
      PEP_9          : Boolean := False;
      --  Write-only. Pipe 10 Interrupt Enable
      PEP_10         : Boolean := False;
      --  Write-only. Pipe 11 Interrupt Enable
      PEP_11         : Boolean := False;
      --  unspecified
      Reserved_20_24 : HAL.UInt5 := 16#0#;
      --  Write-only. DMA Channel 1 Interrupt Enable
   ...
   type USBHS_SR_Register is record
      ...
      --  Read-only. VBUS Request (Host mode only)
      VBUSRQ         : Boolean;
      --  unspecified
      Reserved_10_11 : HAL.UInt2;
