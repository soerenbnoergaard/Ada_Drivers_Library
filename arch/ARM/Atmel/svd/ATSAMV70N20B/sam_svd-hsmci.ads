...
package SAM_SVD.HSMCI is
   ...
   type DMA_CHKSIZE_Field is
     (
      ...
      DMA_CHKSIZE_Field_8,
      --  16 data available
      DMA_CHKSIZE_Field_16)
     with Size => 3;
   for DMA_CHKSIZE_Field use
     (DMA_CHKSIZE_Field_1 => 0,
      DMA_CHKSIZE_Field_2 => 1,
      DMA_CHKSIZE_Field_4 => 2,
      DMA_CHKSIZE_Field_8 => 3,
      DMA_CHKSIZE_Field_16 => 4);
   ...
   subtype HSMCI_VERSION_VERSION_Field is HAL.UInt12;
   subtype HSMCI_VERSION_MFN_Field is HAL.UInt3;

   --  Version Register
   type HSMCI_VERSION_Register is record
      --  Read-only. Hardware Module Version
      VERSION        : HSMCI_VERSION_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : HSMCI_VERSION_MFN_Field;
      --  unspecified
   ...
   for HSMCI_VERSION_Register use record
   ...
   type HSMCI_Peripheral is record
      ...
      --  Version Register
      VERSION : aliased HSMCI_VERSION_Register;
      --  FIFO Memory Aperture0
