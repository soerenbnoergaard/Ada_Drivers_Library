...
package SAM_SVD.MATRIX is
   ...
   --  MATRIX_MRCR_RCB array
   type MATRIX_MRCR_RCB_Field_Array_1 is array (10 .. 12) of Boolean
   ...
   type MATRIX_Peripheral is record
      ...
      MATRIX_MCFG12  : aliased MATRIX_MCFG_Register;
      --  Slave Configuration Register
   ...
   for MATRIX_Peripheral use record
      ...
      MATRIX_MCFG12  at 16#30# range 0 .. 31;
