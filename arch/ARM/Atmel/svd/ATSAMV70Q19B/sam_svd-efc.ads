...
package SAM_SVD.EFC is
   ...
   subtype EFC_VERSION_VERSION_Field is HAL.UInt12;
   subtype EFC_VERSION_MFN_Field is HAL.UInt3;

   --  EEFC Version Register
   type EFC_VERSION_Register is record
      --  Read-only. Version of the Hardware Module
      VERSION        : EFC_VERSION_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : EFC_VERSION_MFN_Field;
      --  unspecified
   ...
   for EFC_VERSION_Register use record
   ...
   type EFC_Peripheral is record
      ...
      --  EEFC Version Register
      VERSION : aliased EFC_VERSION_Register;
      --  Write Protection Mode Register
