...
package SAM_SVD.PMC is
   ...
   --  PMC_SCER_PCK array
   type PMC_SCER_PCK_Field_Array is array (0 .. 6) of Boolean
   ...
   --  PMC_SCDR_PCK array
   type PMC_SCDR_PCK_Field_Array is array (0 .. 6) of Boolean
     with Component_Size => 1, Size => 7;
   ...
   --  PMC_SCSR_PCK array
   type PMC_SCSR_PCK_Field_Array is array (0 .. 6) of Boolean
     with Component_Size => 1, Size => 7;
   ...
   type PMC_SCSR_Register is record
      --  Read-only. Processor Clock Status
      HCLKS          : Boolean;
      --  unspecified
   ...
   --  PMC_PCER0_PID array
   type PMC_PCER0_PID_Field_Array is array (7 .. 8) of Boolean
   ...
   --  PMC_PCER0_PID array
   type PMC_PCER0_PID_Field_Array_1 is array (16 .. 31) of Boolean
   ...
   type PMC_PCER0_Register is record
      ...
      --  Write-only. Peripheral Clock 16 Enable
   ...
   for PMC_PCER0_Register use record
      ...
      PID_1         at 0 range 16 .. 31;
   end record;

   --  PMC_PCDR0_PID array
   type PMC_PCDR0_PID_Field_Array is array (7 .. 8) of Boolean
     with Component_Size => 1, Size => 2;
   ...
   --  PMC_PCDR0_PID array
   type PMC_PCDR0_PID_Field_Array_1 is array (16 .. 31) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   type PMC_PCDR0_Register is record
      ...
      --  unspecified
      Reserved_9_15 : HAL.UInt7 := 16#0#;
      --  Write-only. Peripheral Clock 16 Disable
   ...
   --  PMC_PCSR0_PID array
   type PMC_PCSR0_PID_Field_Array is array (7 .. 8) of Boolean
     with Component_Size => 1, Size => 2;
   ...
   --  PMC_PCSR0_PID array
   type PMC_PCSR0_PID_Field_Array_1 is array (16 .. 31) of Boolean
     with Component_Size => 1, Size => 16;
   ...
   type PMC_PCSR0_Register is record
      ...
      --  Read-only. Peripheral Clock 16 Status
   ...
   --  Programmable Clock Register (chid = 0)
   ...
   subtype PMC_VERSION_VERSION_Field is HAL.UInt12;
   subtype PMC_VERSION_MFN_Field is HAL.UInt3;

   --  Version Register
   type PMC_VERSION_Register is record
      --  Read-only. Version of the Hardware Module
      VERSION        : PMC_VERSION_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : PMC_VERSION_MFN_Field;
      --  unspecified
   ...
   for PMC_VERSION_Register use record
   ...
   subtype PMC_APLLACR_DCOFLTSEL_Field is HAL.UInt4;
   subtype PMC_APLLACR_FLTSEL_Field is HAL.UInt4;
   subtype PMC_APLLACR_BIAS_Field is HAL.UInt2;

   --  Audio PLL Analog Configuration Register
   type PMC_APLLACR_Register is record
      --  DCO Filter Selection
      DCOFLTSEL      : PMC_APLLACR_DCOFLTSEL_Field := 16#0#;
      --  PLL Filter Selection
      FLTSEL         : PMC_APLLACR_FLTSEL_Field := 16#0#;
      --  Bias Voltage Selection
      BIAS           : PMC_APLLACR_BIAS_Field := 16#0#;
      --  unspecified
   ...
   for PMC_APLLACR_Register use record
   ...
   subtype PMC_WMST_WMST_Field is HAL.UInt8;
   ...
   type PMC_WMST_Register is record
      --  Wait Mode Startup Time
      WMST          : PMC_WMST_WMST_Field := 16#0#;
      --  unspecified
   ...
   for PMC_WMST_Register use record
      WMST          at 0 range 0 .. 7;
   ...
   type PMC_Peripheral is record
      ...
      --  Version Register
      PMC_VERSION    : aliased PMC_VERSION_Register;
      --  Peripheral Clock Enable Register 1
      ...
      --  Audio PLL Analog Configuration Register
      PMC_APLLACR    : aliased PMC_APLLACR_Register;
      --  Wait Mode Startup Time Register
      PMC_WMST       : aliased PMC_WMST_Register;
   end record
     with Volatile;
