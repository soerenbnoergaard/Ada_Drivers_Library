--  This spec has been automatically generated from ATSAMV71J20B.svd
...
package SAM_SVD.ISI is
   ...
   subtype ISI_CFG1_FRATE_Field is HAL.UInt3;

   --  Threshold Mask
   type CFG1_THMASK_Field is
     (
      ...
      Beats_16)
     with Size => 2;
   for CFG1_THMASK_Field use
     (Beats_4 => 0,
      Beats_8 => 1,
      Beats_16 => 2);

   subtype ISI_CFG1_SLD_Field is HAL.UInt8;
   subtype ISI_CFG1_SFD_Field is HAL.UInt8;

   --  ISI Configuration 1 Register
   type ISI_CFG1_Register is record
      --  unspecified
      ...
      --  Frame Rate [0..7]
      FRATE          : ISI_CFG1_FRATE_Field := 16#0#;
      --  Disable Codec Request
      DISCR          : Boolean := False;
      --  Full Mode is Allowed
      FULL           : Boolean := False;
      --  Threshold Mask
      THMASK         : CFG1_THMASK_Field := SAM_SVD.ISI.Beats_4;
      --  unspecified
      Reserved_15_15 : HAL.Bit := 16#0#;
      --  Start of Line Delay
      SLD            : ISI_CFG1_SLD_Field := 16#0#;
      --  Start of Frame Delay
      SFD            : ISI_CFG1_SFD_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for ISI_CFG1_Register use record
   ...
   subtype ISI_CFG2_IM_VSIZE_Field is HAL.UInt11;
   subtype ISI_CFG2_IM_HSIZE_Field is HAL.UInt11;

   --  YCrCb Format Swap Mode
   type CFG2_YCC_SWAP_Field is
     (
   ...
   type ISI_CFG2_Register is record
      --  Vertical Size of the Image Sensor [0..2047]
      IM_VSIZE       : ISI_CFG2_IM_VSIZE_Field := 16#0#;
      ...
      IM_HSIZE       : ISI_CFG2_IM_HSIZE_Field := 16#0#;
      --  unspecified
      Reserved_27_27 : HAL.Bit := 16#0#;
      --  YCrCb Format Swap Mode
      YCC_SWAP       : CFG2_YCC_SWAP_Field := SAM_SVD.ISI.Default;
      --  RGB Pixel Mapping Configuration
      RGB_CFG        : CFG2_RGB_CFG_Field := SAM_SVD.ISI.Default;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for ISI_CFG2_Register use record
   ...
   subtype ISI_PSIZE_PREV_VSIZE_Field is HAL.UInt10;
   subtype ISI_PSIZE_PREV_HSIZE_Field is HAL.UInt10;

   --  ISI Preview Size Register
   type ISI_PSIZE_Register is record
      --  Vertical Size for the Preview Path
      PREV_VSIZE     : ISI_PSIZE_PREV_VSIZE_Field := 16#0#;
      --  unspecified
      Reserved_10_15 : HAL.UInt6 := 16#0#;
      --  Horizontal Size for the Preview Path
      PREV_HSIZE     : ISI_PSIZE_PREV_HSIZE_Field := 16#0#;
      --  unspecified
   ...
   for ISI_PSIZE_Register use record
   ...
   subtype ISI_PDECF_DEC_FACTOR_Field is HAL.UInt8;

   --  ISI Preview Decimation Factor Register
   type ISI_PDECF_Register is record
      --  Decimation Factor
      DEC_FACTOR    : ISI_PDECF_DEC_FACTOR_Field := 16#10#;
      --  unspecified
   ...
   for ISI_PDECF_Register use record
      DEC_FACTOR    at 0 range 0 .. 7;
      Reserved_8_31 at 0 range 8 .. 31;
   end record;

   --  ISI_Y2R_SET0_C array element
   subtype ISI_Y2R_SET0_C_Element is HAL.UInt8;

   --  ISI_Y2R_SET0_C array
   type ISI_Y2R_SET0_C_Field_Array is array (0 .. 3)
     of ISI_Y2R_SET0_C_Element
     with Component_Size => 8, Size => 32;

   --  ISI Color Space Conversion YCrCb To RGB Set 0 Register
   type ISI_Y2R_SET0_Register
   ...
   is record
      case As_Array is
         ...
         when True =>
            --  C as an array
            Arr : ISI_Y2R_SET0_C_Field_Array;
      end case;
   end record
     with Unchecked_Union, Size => 32, Volatile_Full_Access,
          Bit_Order => System.Low_Order_First;

   for ISI_Y2R_SET0_Register use record
      Val at 0 range 0 .. 31;
      Arr at 0 range 0 .. 31;
   end record;

   subtype ISI_Y2R_SET1_C4_Field is HAL.UInt9;

   --  ISI Color Space Conversion YCrCb To RGB Set 1 Register
   type ISI_Y2R_SET1_Register is record
      --  Color Space Conversion Matrix Coefficient C4
      C4             : ISI_Y2R_SET1_C4_Field := 16#102#;
      --  unspecified
   ...
   for ISI_Y2R_SET1_Register use record
      C4             at 0 range 0 .. 8;
   ...
   subtype ISI_R2Y_SET0_C0_Field is HAL.UInt7;
   subtype ISI_R2Y_SET0_C1_Field is HAL.UInt7;
   subtype ISI_R2Y_SET0_C2_Field is HAL.UInt7;

   --  ISI Color Space Conversion RGB To YCrCb Set 0 Register
   type ISI_R2Y_SET0_Register is record
      --  Color Space Conversion Matrix Coefficient C0
      C0             : ISI_R2Y_SET0_C0_Field := 16#45#;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Color Space Conversion Matrix Coefficient C1
      C1             : ISI_R2Y_SET0_C1_Field := 16#41#;
      --  unspecified
      Reserved_15_15 : HAL.Bit := 16#0#;
      --  Color Space Conversion Matrix Coefficient C2
      C2             : ISI_R2Y_SET0_C2_Field := 16#32#;
      --  unspecified
   ...
   for ISI_R2Y_SET0_Register use record
      C0             at 0 range 0 .. 6;
   ...
   subtype ISI_R2Y_SET1_C3_Field is HAL.UInt7;
   subtype ISI_R2Y_SET1_C4_Field is HAL.UInt7;
   subtype ISI_R2Y_SET1_C5_Field is HAL.UInt7;

   --  ISI Color Space Conversion RGB To YCrCb Set 1 Register
   type ISI_R2Y_SET1_Register is record
      --  Color Space Conversion Matrix Coefficient C3
      C3             : ISI_R2Y_SET1_C3_Field := 16#38#;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Color Space Conversion Matrix Coefficient C4
      C4             : ISI_R2Y_SET1_C4_Field := 16#5E#;
      --  unspecified
      Reserved_15_15 : HAL.Bit := 16#0#;
      --  Color Space Conversion Matrix Coefficient C5
      C5             : ISI_R2Y_SET1_C5_Field := 16#24#;
      --  unspecified
      Reserved_23_23 : HAL.Bit := 16#0#;
   ...
   for ISI_R2Y_SET1_Register use record
      C3             at 0 range 0 .. 6;
      Reserved_7_7   at 0 range 7 .. 7;
      C4             at 0 range 8 .. 14;
      Reserved_15_15 at 0 range 15 .. 15;
   ...
   subtype ISI_R2Y_SET2_C6_Field is HAL.UInt7;
   subtype ISI_R2Y_SET2_C7_Field is HAL.UInt7;
   subtype ISI_R2Y_SET2_C8_Field is HAL.UInt7;

   --  ISI Color Space Conversion RGB To YCrCb Set 2 Register
   type ISI_R2Y_SET2_Register is record
      --  Color Space Conversion Matrix Coefficient C6
      C6             : ISI_R2Y_SET2_C6_Field := 16#4B#;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Color Space Conversion Matrix Coefficient C7
      C7             : ISI_R2Y_SET2_C7_Field := 16#4A#;
      --  unspecified
      Reserved_15_15 : HAL.Bit := 16#0#;
      --  Color Space Conversion Matrix Coefficient C8
      C8             : ISI_R2Y_SET2_C8_Field := 16#38#;
      --  unspecified
      Reserved_23_23 : HAL.Bit := 16#0#;
   ...
   for ISI_R2Y_SET2_Register use record
      C6             at 0 range 0 .. 6;
      Reserved_7_7   at 0 range 7 .. 7;
      C7             at 0 range 8 .. 14;
      Reserved_15_15 at 0 range 15 .. 15;
   ...
   type ISI_CR_Register is record
   ...
   for ISI_CR_Register use record
   ...
   --  ISI Status Register
   type ISI_SR_Register is record
   ...
   for ISI_SR_Register use record
   ...
   type ISI_IER_Register is record
      --  unspecified
   ...
   for ISI_IER_Register use record
   ...
   type ISI_IDR_Register is record
      --  unspecified
      Reserved_0_0   : HAL.Bit := 16#0#;
   ...
   for ISI_IDR_Register use record
      Reserved_0_0   at 0 range 0 .. 0;
      DIS_DONE       at 0 range 1 .. 1;
      SRST           at 0 range 2 .. 2;
      Reserved_3_9   at 0 range 3 .. 9;
   ...
   type ISI_IMR_Register is record
      --  unspecified
   ...
   for ISI_IMR_Register use record
      Reserved_0_0   at 0 range 0 .. 0;
      DIS_DONE       at 0 range 1 .. 1;
      SRST           at 0 range 2 .. 2;
      Reserved_3_9   at 0 range 3 .. 9;
   ...
   type ISI_DMA_CHER_Register is record
   ...
   for ISI_DMA_CHER_Register use record
   ...
   type ISI_DMA_CHDR_Register is record
   ...
   for ISI_DMA_CHDR_Register use record
   ...
   type ISI_DMA_CHSR_Register is record
   ...
   for ISI_DMA_CHSR_Register use record
      P_CH_S        at 0 range 0 .. 0;
      C_CH_S        at 0 range 1 .. 1;
      Reserved_2_31 at 0 range 2 .. 31;
   end record;

   subtype ISI_DMA_P_ADDR_P_ADDR_Field is HAL.UInt30;

   --  DMA Preview Base Address Register
   type ISI_DMA_P_ADDR_Register is record
      --  unspecified
      Reserved_0_1 : HAL.UInt2 := 16#0#;
      --  Preview Image Base Address
      P_ADDR       : ISI_DMA_P_ADDR_P_ADDR_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for ISI_DMA_P_ADDR_Register use record
      Reserved_0_1 at 0 range 0 .. 1;
      P_ADDR       at 0 range 2 .. 31;
   end record;

   --  DMA Preview Control Register
   type ISI_DMA_P_CTRL_Register is record
   ...
   for ISI_DMA_P_CTRL_Register use record
   ...
   subtype ISI_DMA_P_DSCR_P_DSCR_Field is HAL.UInt30;

   --  DMA Preview Descriptor Address Register
   type ISI_DMA_P_DSCR_Register is record
      --  unspecified
      Reserved_0_1 : HAL.UInt2 := 16#0#;
      --  Preview Descriptor Base Address
      P_DSCR       : ISI_DMA_P_DSCR_P_DSCR_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for ISI_DMA_P_DSCR_Register use record
      Reserved_0_1 at 0 range 0 .. 1;
      P_DSCR       at 0 range 2 .. 31;
   end record;

   subtype ISI_DMA_C_ADDR_C_ADDR_Field is HAL.UInt30;

   --  DMA Codec Base Address Register
   type ISI_DMA_C_ADDR_Register is record
      --  unspecified
      Reserved_0_1 : HAL.UInt2 := 16#0#;
      --  Codec Image Base Address
      C_ADDR       : ISI_DMA_C_ADDR_C_ADDR_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for ISI_DMA_C_ADDR_Register use record
      Reserved_0_1 at 0 range 0 .. 1;
      C_ADDR       at 0 range 2 .. 31;
   end record;

   --  DMA Codec Control Register
   type ISI_DMA_C_CTRL_Register is record
      --  Descriptor Fetch Control Bit
   ...
   for ISI_DMA_C_CTRL_Register use record
   ...
   subtype ISI_DMA_C_DSCR_C_DSCR_Field is HAL.UInt30;

   --  DMA Codec Descriptor Address Register
   type ISI_DMA_C_DSCR_Register is record
      --  unspecified
      Reserved_0_1 : HAL.UInt2 := 16#0#;
      --  Codec Descriptor Base Address
      C_DSCR       : ISI_DMA_C_DSCR_C_DSCR_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for ISI_DMA_C_DSCR_Register use record
      Reserved_0_1 at 0 range 0 .. 1;
   ...
   type ISI_WPMR_Register is record
   ...
   for ISI_WPMR_Register use record
      WPEN         at 0 range 0 .. 0;
      Reserved_1_7 at 0 range 1 .. 7;
      WPKEY        at 0 range 8 .. 31;
   end record;

   subtype ISI_WPSR_WPVSRC_Field is HAL.UInt16;

   --  Write Protection Status Register
   type ISI_WPSR_Register is record
      --  Read-only. Write Protection Violation Status
      WPVS           : Boolean;
      --  unspecified
      Reserved_1_7   : HAL.UInt7;
      --  Read-only. Write Protection Violation Source
      WPVSRC         : ISI_WPSR_WPVSRC_Field;
      --  unspecified
   ...
   for ISI_WPSR_Register use record
      WPVS           at 0 range 0 .. 0;
      Reserved_1_7   at 0 range 1 .. 7;
   ...
   subtype ISI_VERSION_VERSION_Field is HAL.UInt12;
   subtype ISI_VERSION_MFN_Field is HAL.UInt3;

   --  Version Register
   type ISI_VERSION_Register is record
      --  Read-only. Version of the Hardware Module
      VERSION        : ISI_VERSION_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : ISI_VERSION_MFN_Field;
      --  unspecified
   ...
   for ISI_VERSION_Register use record
   ...
   type ISI_Peripheral is record
      --  ISI Configuration 1 Register
      CFG1       : aliased ISI_CFG1_Register;
      --  ISI Configuration 2 Register
      CFG2       : aliased ISI_CFG2_Register;
      --  ISI Preview Size Register
      PSIZE      : aliased ISI_PSIZE_Register;
      --  ISI Preview Decimation Factor Register
      PDECF      : aliased ISI_PDECF_Register;
      --  ISI Color Space Conversion YCrCb To RGB Set 0 Register
      Y2R_SET0   : aliased ISI_Y2R_SET0_Register;
      --  ISI Color Space Conversion YCrCb To RGB Set 1 Register
      Y2R_SET1   : aliased ISI_Y2R_SET1_Register;
      --  ISI Color Space Conversion RGB To YCrCb Set 0 Register
      R2Y_SET0   : aliased ISI_R2Y_SET0_Register;
      --  ISI Color Space Conversion RGB To YCrCb Set 1 Register
      R2Y_SET1   : aliased ISI_R2Y_SET1_Register;
      --  ISI Color Space Conversion RGB To YCrCb Set 2 Register
      R2Y_SET2   : aliased ISI_R2Y_SET2_Register;
      --  ISI Control Register
      CR         : aliased ISI_CR_Register;
      --  ISI Status Register
      SR         : aliased ISI_SR_Register;
      --  ISI Interrupt Enable Register
      IER        : aliased ISI_IER_Register;
      --  ISI Interrupt Disable Register
      IDR        : aliased ISI_IDR_Register;
      --  ISI Interrupt Mask Register
      IMR        : aliased ISI_IMR_Register;
      --  DMA Channel Enable Register
      DMA_CHER   : aliased ISI_DMA_CHER_Register;
      --  DMA Channel Disable Register
      DMA_CHDR   : aliased ISI_DMA_CHDR_Register;
      --  DMA Channel Status Register
      DMA_CHSR   : aliased ISI_DMA_CHSR_Register;
      --  DMA Preview Base Address Register
      DMA_P_ADDR : aliased ISI_DMA_P_ADDR_Register;
      --  DMA Preview Control Register
      DMA_P_CTRL : aliased ISI_DMA_P_CTRL_Register;
      --  DMA Preview Descriptor Address Register
      DMA_P_DSCR : aliased ISI_DMA_P_DSCR_Register;
      --  DMA Codec Base Address Register
      DMA_C_ADDR : aliased ISI_DMA_C_ADDR_Register;
      --  DMA Codec Control Register
      DMA_C_CTRL : aliased ISI_DMA_C_CTRL_Register;
      --  DMA Codec Descriptor Address Register
      DMA_C_DSCR : aliased ISI_DMA_C_DSCR_Register;
      --  Write Protection Mode Register
      WPMR       : aliased ISI_WPMR_Register;
      --  Write Protection Status Register
      WPSR       : aliased ISI_WPSR_Register;
      --  Version Register
      VERSION    : aliased ISI_VERSION_Register;
   end record
     with Volatile;
   ...
   for ISI_Peripheral use record
      ...
      PSIZE      at 16#8# range 0 .. 31;
      PDECF      at 16#C# range 0 .. 31;
      Y2R_SET0   at 16#10# range 0 .. 31;
      Y2R_SET1   at 16#14# range 0 .. 31;
      R2Y_SET0   at 16#18# range 0 .. 31;
      R2Y_SET1   at 16#1C# range 0 .. 31;
      R2Y_SET2   at 16#20# range 0 .. 31;
      CR         at 16#24# range 0 .. 31;
      SR         at 16#28# range 0 .. 31;
      IER        at 16#2C# range 0 .. 31;
      IDR        at 16#30# range 0 .. 31;
      IMR        at 16#34# range 0 .. 31;
      DMA_CHER   at 16#38# range 0 .. 31;
      DMA_CHDR   at 16#3C# range 0 .. 31;
      DMA_CHSR   at 16#40# range 0 .. 31;
      DMA_P_ADDR at 16#44# range 0 .. 31;
      DMA_P_CTRL at 16#48# range 0 .. 31;
      DMA_P_DSCR at 16#4C# range 0 .. 31;
      DMA_C_ADDR at 16#50# range 0 .. 31;
      DMA_C_CTRL at 16#54# range 0 .. 31;
      DMA_C_DSCR at 16#58# range 0 .. 31;
