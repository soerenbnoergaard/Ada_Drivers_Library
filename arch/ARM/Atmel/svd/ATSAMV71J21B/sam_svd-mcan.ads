...
package SAM_SVD.MCAN is
   ...
   subtype MCAN0_DBTP_DSJW_Field is HAL.UInt3;
   subtype MCAN0_DBTP_DTSEG2_Field is HAL.UInt4;
   subtype MCAN0_DBTP_DTSEG1_Field is HAL.UInt5;
   subtype MCAN0_DBTP_DBRP_Field is HAL.UInt5;

   --  Transmitter Delay Compensation
   type DBTP_TDC_Field is
     (
      ...
      Enabled)
     with Size => 1;
   for DBTP_TDC_Field use
     (Disabled => 0,
      Enabled => 1);

   --  Data Bit Timing and Prescaler Register
   type MCAN0_DBTP_Register is record
      --  Data (Re) Synchronization Jump Width
      DSJW           : MCAN0_DBTP_DSJW_Field := 16#3#;
      --  unspecified
      Reserved_3_3   : HAL.Bit := 16#0#;
      --  Data Time Segment After Sample Point
      DTSEG2         : MCAN0_DBTP_DTSEG2_Field := 16#3#;
      --  Data Time Segment Before Sample Point
      DTSEG1         : MCAN0_DBTP_DTSEG1_Field := 16#A#;
      --  unspecified
      Reserved_13_15 : HAL.UInt3 := 16#0#;
      --  Data Bit Rate Prescaler
      DBRP           : MCAN0_DBTP_DBRP_Field := 16#0#;
      --  unspecified
      Reserved_21_22 : HAL.UInt2 := 16#0#;
      --  Transmitter Delay Compensation
      TDC            : DBTP_TDC_Field := SAM_SVD.MCAN.Disabled;
      --  unspecified
   ...
   for MCAN0_DBTP_Register use record
      DSJW           at 0 range 0 .. 2;
   ...
   type MCAN0_CCCR_Register is record
      ...
      --  CAN FD Operation Enable (read/write, write protection)
      FDOE           : CCCR_FDOE_Field := SAM_SVD.MCAN.Disabled;
      --  Bit Rate Switching Enable (read/write, write protection)
      BRSE           : CCCR_BRSE_Field := SAM_SVD.MCAN.Disabled;
      --  unspecified
   ...
   subtype MCAN0_NBTP_NTSEG2_Field is HAL.UInt7;
   subtype MCAN0_NBTP_NTSEG1_Field is HAL.UInt8;
   subtype MCAN0_NBTP_NBRP_Field is HAL.UInt9;
   subtype MCAN0_NBTP_NSJW_Field is HAL.UInt7;

   --  Nominal Bit Timing and Prescaler Register
   type MCAN0_NBTP_Register is record
      --  Nominal Time Segment After Sample Point
      NTSEG2       : MCAN0_NBTP_NTSEG2_Field := 16#3#;
      --  unspecified
      Reserved_7_7 : HAL.Bit := 16#0#;
      --  Nominal Time Segment Before Sample Point
      NTSEG1       : MCAN0_NBTP_NTSEG1_Field := 16#A#;
      --  Nominal Bit Rate Prescaler
      NBRP         : MCAN0_NBTP_NBRP_Field := 16#0#;
      --  Nominal (Re) Synchronization Jump Width
      NSJW         : MCAN0_NBTP_NSJW_Field := 16#3#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for MCAN0_NBTP_Register use record
   ...
   type PSR_LEC_Field is
     (
      ...
      --  node.
      Ack_Error,
      --  During transmission of a message (with the exception of the
      --  arbitration field), the device tried to send a recessive level (bit
      --  of logical value '1'), but the monitored bus value was dominant.
      Bit1_Error,
      --  During transmission of a message (or acknowledge bit, or active error
      --  flag, or overload flag), the device tried to send a dominant level
      --  (data or identifier bit logical value '0'), but the monitored bus
      --  value was recessive. During Bus_Off recovery, this status is set each
      --  time a sequence of 11 recessive bits has been monitored. This enables
      --  the processor to monitor the proceeding of the Bus_Off recovery
      ...
      --  LEC to '7'. When the LEC shows value '7', no CAN bus event was
   ...
   subtype MCAN0_PSR_DLEC_Field is HAL.UInt3;
   subtype MCAN0_PSR_TDCV_Field is HAL.UInt7;
   ...
   subtype MCAN0_TDCR_TDCF_Field is HAL.UInt7;
   subtype MCAN0_TDCR_TDCO_Field is HAL.UInt7;

   --  Transmit Delay Compensation Register
   type MCAN0_TDCR_Register is record
      --  Transmitter Delay Compensation Filter
      TDCF           : MCAN0_TDCR_TDCF_Field := 16#0#;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Transmitter Delay Compensation Offset
      TDCO           : MCAN0_TDCR_TDCO_Field := 16#0#;
      --  unspecified
   ...
   for MCAN0_TDCR_Register use record
      TDCF           at 0 range 0 .. 6;
      Reserved_7_7   at 0 range 7 .. 7;
   ...
   type MCAN_Peripheral is record
      ...
      --  Data Bit Timing and Prescaler Register
      DBTP   : aliased MCAN0_DBTP_Register;
      --  Test Register
      ...
      --  Nominal Bit Timing and Prescaler Register
      NBTP   : aliased MCAN0_NBTP_Register;
      --  Timestamp Counter Configuration Register
      ...
      --  Transmit Delay Compensation Register
      TDCR   : aliased MCAN0_TDCR_Register;
      --  Interrupt Register
