...
package SAM_SVD.SPI is
   ...
   --  Chip Select Register (CS_number = 0)
   ...
   subtype SPI0_VERSION_VERSION_Field is HAL.UInt12;
   subtype SPI0_VERSION_MFN_Field is HAL.UInt3;

   --  Version Register
   type SPI0_VERSION_Register is record
      --  Read-only. Version of the Hardware Module
      VERSION        : SPI0_VERSION_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : SPI0_VERSION_MFN_Field;
      --  unspecified
   ...
   for SPI0_VERSION_Register use record
   ...
   type SPI_Peripheral is record
      ...
      --  Version Register
      VERSION : aliased SPI0_VERSION_Register;
   end record
     with Volatile;
