...
package SAM_SVD.AES is
   ...
   subtype AES_VERSION_VERSION_Field is HAL.UInt12;
   subtype AES_VERSION_MFN_Field is HAL.UInt3;

   --  Version Register
   type AES_VERSION_Register is record
      --  Read-only. Version of the Hardware Module
      VERSION        : AES_VERSION_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : AES_VERSION_MFN_Field;
      --  unspecified
   ...
   for AES_VERSION_Register use record
   ...
   type AES_Peripheral is record
      ...
      --  Version Register
      VERSION : aliased AES_VERSION_Register;
   end record
     with Volatile;
