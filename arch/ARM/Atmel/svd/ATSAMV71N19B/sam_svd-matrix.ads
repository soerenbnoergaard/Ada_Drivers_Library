...
package SAM_SVD.MATRIX is
   ...
   type MATRIX_MCFG_ULBT_Field is
     (
      ...
      MATRIX_MCFG_ULBT_Field_4Beat_Burst,
      ...
      MATRIX_MCFG_ULBT_Field_8Beat_Burst,
      ...
      MATRIX_MCFG_ULBT_Field_16Beat_Burst,
      ...
      MATRIX_MCFG_ULBT_Field_32Beat_Burst,
      ...
      MATRIX_MCFG_ULBT_Field_64Beat_Burst,
      ...
      --  beats.
      MATRIX_MCFG_ULBT_Field_128Beat_Burst)
     with Size => 3;
   for MATRIX_MCFG_ULBT_Field use
     (Unltd_Length => 0,
      Single_Access => 1,
      MATRIX_MCFG_ULBT_Field_4Beat_Burst => 2,
      MATRIX_MCFG_ULBT_Field_8Beat_Burst => 3,
      MATRIX_MCFG_ULBT_Field_16Beat_Burst => 4,
      MATRIX_MCFG_ULBT_Field_32Beat_Burst => 5,
      MATRIX_MCFG_ULBT_Field_64Beat_Burst => 6,
      MATRIX_MCFG_ULBT_Field_128Beat_Burst => 7);
   ...
   type MATRIX_PRBS_Register is record
      ...
      Reserved_2_3   : HAL.UInt2 := 16#0#;
      --  Master 9 Priority
      M9PR           : MATRIX_PRBS_M9PR_Field := 16#0#;
      --  unspecified
      Reserved_6_7   : HAL.UInt2 := 16#0#;
      --  Master 10 Priority
      ...
      Reserved_14_15 : HAL.UInt2 := 16#0#;
      --  Master 12 Priority
      M12PR          : MATRIX_PRBS_M12PR_Field := 16#0#;
      --  unspecified
   ...
   type CCFG_PCCR_Register is record
      --  unspecified
      Reserved_0_19  : HAL.UInt20 := 16#22224#;
   ...
   for CCFG_PCCR_Register use record
   ...
   type MATRIX_Peripheral is record
      ...
      --  Peripheral Clock Configuration Register
      CCFG_PCCR      : aliased CCFG_PCCR_Register;
      --  Dynamic Clock Gating Register
      CCFG_DYNCFG    : aliased HAL.UInt32;
      --  SMC NAND Flash Chip Select Configuration Register
   ...
   for MATRIX_Peripheral use record
      MATRIX_MCFG    at 16#0# range 0 .. 415;
      ...
      CCFG_DYNCFG    at 16#11C# range 0 .. 31;
