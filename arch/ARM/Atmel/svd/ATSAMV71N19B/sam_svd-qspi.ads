...
package SAM_SVD.QSPI is
   ...
   subtype QSPI_MR_CSMODE_Field is HAL.UInt2;
   ...
   type QSPI_MR_Register is record
      ...
      --  Chip Select Mode
      CSMODE         : QSPI_MR_CSMODE_Field := 16#0#;
      --  unspecified
   ...
   subtype QSPI_VERSION_VERSION_Field is HAL.UInt12;
   subtype QSPI_VERSION_MFN_Field is HAL.UInt3;

   --  Version Register
   type QSPI_VERSION_Register is record
      --  Read-only. Hardware Module Version
      VERSION        : QSPI_VERSION_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : QSPI_VERSION_MFN_Field;
      --  unspecified
   ...
   for QSPI_VERSION_Register use record
   ...
   type QSPI_Peripheral is record
      ...
      --  Version Register
      VERSION : aliased QSPI_VERSION_Register;
   end record
     with Volatile;
