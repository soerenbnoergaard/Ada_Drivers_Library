...
package SAM_SVD.SSC is
   ...
   subtype SSC_CMR_DIV_Field is HAL.UInt12;
   ...
   subtype SSC_RCMR_STTDLY_Field is HAL.UInt8;
   subtype SSC_RCMR_PERIOD_Field is HAL.UInt8;

   --  Receive Clock Mode Register
   type SSC_RCMR_Register is record
      --  Receive Clock Selection
      CKS            : RCMR_CKS_Field := SAM_SVD.SSC.Mck;
      --  Receive Clock Output Mode Selection
      CKO            : RCMR_CKO_Field := SAM_SVD.SSC.None;
      --  Receive Clock Inversion
      CKI            : Boolean := False;
      --  Receive Clock Gating Selection
      CKG            : RCMR_CKG_Field := SAM_SVD.SSC.Continuous;
      --  Receive Start Selection
      START          : RCMR_START_Field := SAM_SVD.SSC.Continuous;
   ...
   subtype SSC_RFMR_DATLEN_Field is HAL.UInt5;
   subtype SSC_RFMR_DATNB_Field is HAL.UInt4;
   subtype SSC_RFMR_FSLEN_Field is HAL.UInt4;
   ...
   subtype SSC_RFMR_FSLEN_EXT_Field is HAL.UInt4;
   ...
   type SSC_RFMR_Register is record
      ...
      --  Receive Frame Sync Output Selection
      FSOS           : RFMR_FSOS_Field := SAM_SVD.SSC.None;
      --  unspecified
      Reserved_23_23 : HAL.Bit := 16#0#;
      --  Frame Sync Edge Detection
      FSEDGE         : RFMR_FSEDGE_Field := SAM_SVD.SSC.Positive;
      --  unspecified
   ...
   subtype SSC_TCMR_STTDLY_Field is HAL.UInt8;
   subtype SSC_TCMR_PERIOD_Field is HAL.UInt8;

   --  Transmit Clock Mode Register
   type SSC_TCMR_Register is record
      --  Transmit Clock Selection
      CKS            : TCMR_CKS_Field := SAM_SVD.SSC.Mck;
      --  Transmit Clock Output Mode Selection
      CKO            : TCMR_CKO_Field := SAM_SVD.SSC.None;
      --  Transmit Clock Inversion
      CKI            : Boolean := False;
      --  Transmit Clock Gating Selection
      CKG            : TCMR_CKG_Field := SAM_SVD.SSC.Continuous;
      --  Transmit Start Selection
      START          : TCMR_START_Field := SAM_SVD.SSC.Continuous;
      --  unspecified
      Reserved_12_15 : HAL.UInt4 := 16#0#;
   ...
   subtype SSC_TFMR_DATLEN_Field is HAL.UInt5;
   subtype SSC_TFMR_DATNB_Field is HAL.UInt4;
   subtype SSC_TFMR_FSLEN_Field is HAL.UInt4;
   ...
   subtype SSC_TFMR_FSLEN_EXT_Field is HAL.UInt4;
   ...
   type SSC_TFMR_Register is record
      ...
      --  Transmit Frame Sync Output Selection
      FSOS           : TFMR_FSOS_Field := SAM_SVD.SSC.None;
      --  Frame Sync Data Enable
      FSDEN          : Boolean := False;
      --  Frame Sync Edge Detection
      FSEDGE         : TFMR_FSEDGE_Field := SAM_SVD.SSC.Positive;
      --  unspecified
      Reserved_25_27 : HAL.UInt3 := 16#0#;
      --  FSLEN Field Extension
   ...
   subtype SSC_RSHR_RSDAT_Field is HAL.UInt16;
   ...
   subtype SSC_TSHR_TSDAT_Field is HAL.UInt16;
   ...
   subtype SSC_RC0R_CP0_Field is HAL.UInt16;
   ...
   subtype SSC_RC1R_CP1_Field is HAL.UInt16;
   ...
   subtype SSC_WPSR_WPVSRC_Field is HAL.UInt16;
   ...
   subtype SSC_VERSION_VERSION_Field is HAL.UInt16;
   subtype SSC_VERSION_MFN_Field is HAL.UInt3;

   --  Version Register
   type SSC_VERSION_Register is record
      --  Read-only. Version of the Hardware Module
      VERSION        : SSC_VERSION_VERSION_Field;
      --  Read-only. Metal Fix Number
      MFN            : SSC_VERSION_MFN_Field;
      --  unspecified
   ...
   for SSC_VERSION_Register use record
   ...
   type SSC_Peripheral is record
      ...
      --  Version Register
      VERSION : aliased SSC_VERSION_Register;
   end record
     with Volatile;
