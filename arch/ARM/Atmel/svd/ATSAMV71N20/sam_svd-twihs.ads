...
package SAM_SVD.TWIHS is
   ...
   type CWGR_CKSRC_Field is
     (
      --  Peripheral clock is used to generate the TWIHS baud rate.
      Periph_Ck,
      --  PMC_PCKx is used to generate the TWIHS baud rate.
      Pmc_Pck)
     with Size => 1;
   for CWGR_CKSRC_Field use
     (Periph_Ck => 0,
      Pmc_Pck => 1);
   ...
   type TWIHS0_CWGR_Register is record
      ...
      --  Transfer Rate Clock Source
      CKSRC          : CWGR_CKSRC_Field := SAM_SVD.TWIHS.Periph_Ck;
      --  unspecified
   ...
   --  Debug Register
   type TWIHS0_DR_Register is record
   ...
   for TWIHS0_DR_Register use record
      SWEN          at 0 range 0 .. 0;
   ...
   subtype TWIHS0_VER_VERSION_Field is HAL.UInt12;
   subtype TWIHS0_VER_MFN_Field is HAL.UInt3;

   --  Version Register
   type TWIHS0_VER_Register is record
      --  Read-only. Version of the Hardware Module
      VERSION        : TWIHS0_VER_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : TWIHS0_VER_MFN_Field;
      --  unspecified
   ...
   for TWIHS0_VER_Register use record
