...
package SAM_SVD.ACC is
   ...
   subtype ACC_VER_VERSION_Field is HAL.UInt12;
   subtype ACC_VER_MFN_Field is HAL.UInt3;

   --  Version Register
   type ACC_VER_Register is record
      --  Read-only. Version of the Hardware Module
      VERSION        : ACC_VER_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : ACC_VER_MFN_Field;
      --  unspecified
   ...
   for ACC_VER_Register use record
