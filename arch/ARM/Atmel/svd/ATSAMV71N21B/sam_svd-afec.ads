...
package SAM_SVD.AFEC is
   ...
   type AFEC0_SEQ2R_USCH_Field_Array is array (8 .. 11)
     of AFEC0_SEQ2R_USCH_Element
     with Component_Size => 4, Size => 16;

   --  Type definition for AFEC0_SEQ2R_USCH
   type AFEC0_SEQ2R_USCH_Field
     (As_Array : Boolean := False)
   is record
      case As_Array is
         when False =>
   ...
   for AFEC0_SEQ2R_USCH_Field use record
      Val at 0 range 0 .. 15;
      Arr at 0 range 0 .. 15;
   end record;

   --  AFEC Channel Sequence 2 Register
   type AFEC0_SEQ2R_Register is record
      --  User Sequence Number 8
      USCH           : AFEC0_SEQ2R_USCH_Field :=
   ...
   subtype AFEC0_VERSION_VERSION_Field is HAL.UInt12;
   subtype AFEC0_VERSION_MFN_Field is HAL.UInt3;

   --  AFEC Version Register
   type AFEC0_VERSION_Register is record
      --  Read-only. Version of the Hardware Module
      VERSION        : AFEC0_VERSION_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : AFEC0_VERSION_MFN_Field;
      --  unspecified
   ...
   for AFEC0_VERSION_Register use record
   ...
   type AFEC_Peripheral is record
      ...
      --  AFEC Version Register
      VERSION : aliased AFEC0_VERSION_Register;
   end record
     with Volatile;
