...
package SAM_SVD.PIO is
   ...
   --  Peripheral ABCD Select Register
   ...
   subtype PIOA_VERSION_VERSION_Field is HAL.UInt12;
   subtype PIOA_VERSION_MFN_Field is HAL.UInt3;

   --  Version Register
   type PIOA_VERSION_Register is record
      --  Read-only. Hardware Module Version
      VERSION        : PIOA_VERSION_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : PIOA_VERSION_MFN_Field;
      --  unspecified
   ...
   for PIOA_VERSION_Register use record
   ...
   type PIO_Peripheral is record
      ...
      --  Version Register
      VERSION : aliased PIOA_VERSION_Register;
      --  Schmitt Trigger Register
