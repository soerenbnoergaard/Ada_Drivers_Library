...
package SAM_SVD.GMAC is
   ...
   type GMAC_NCFGR_Register is record
      ...
      RFCS           : Boolean := False;
      --  MDC CLock Division
      CLK            : NCFGR_CLK_Field := SAM_SVD.GMAC.Mck_32;
      --  Data Bus Width
   ...
   type GMAC_DCFGR_Register is record
      --  Fixed Burst Length for DMA Data Operations:
      FBLDO          : DCFGR_FBLDO_Field := SAM_SVD.GMAC.Incr4;
      --  unspecified
      ...
      ESPA           : Boolean := False;
      --  Receiver Packet Buffer Memory Size Select
      RXBMS          : DCFGR_RXBMS_Field := SAM_SVD.GMAC.Eighth;
   ...
   type GMAC_TPSF_Register is record
      ...
      TPB1ADR        : GMAC_TPSF_TPB1ADR_Field := 16#FFF#;
      --  unspecified
   ...
   type GMAC_RPSF_Register is record
      ...
      RPB1ADR        : GMAC_RPSF_RPB1ADR_Field := 16#FFF#;
      --  unspecified
      Reserved_12_30 : HAL.UInt19 := 16#0#;
   ...
   --  Interrupt Status Register Priority Queue (index = 1)
   type GMAC_ISRPQ_Registers is array (0 .. 1) of GMAC_ISRPQ_Register
     with Volatile;
   ...
   --  Transmit Buffer Queue Base Address Register Priority Queue (index = 1)
   type GMAC_TBQBAPQ_Registers is array (0 .. 1) of GMAC_TBQBAPQ_Register
     with Volatile;
   ...
   --  Receive Buffer Queue Base Address Register Priority Queue (index = 1)
   type GMAC_RBQBAPQ_Registers is array (0 .. 1) of GMAC_RBQBAPQ_Register
     with Volatile;
   ...
   --  Receive Buffer Size Register Priority Queue (index = 1)
   type GMAC_RBSRPQ_Registers is array (0 .. 1) of GMAC_RBSRPQ_Register
     with Volatile;
   ...
   --  Interrupt Enable Register Priority Queue (index = 1)
   type GMAC_IERPQ_Registers is array (0 .. 1) of GMAC_IERPQ_Register
     with Volatile;
   ...
   --  Interrupt Disable Register Priority Queue (index = 1)
   type GMAC_IDRPQ_Registers is array (0 .. 1) of GMAC_IDRPQ_Register
     with Volatile;
   ...
   --  Interrupt Mask Register Priority Queue (index = 1)
   type GMAC_IMRPQ_Registers is array (0 .. 1) of GMAC_IMRPQ_Register
     with Volatile;
   ...
   subtype ST2CW_MASKVAL_Field is HAL.UInt16;
   subtype ST2CW_COMPVAL_Field is HAL.UInt16;

   --  Screening Type 2 Compare Word 0 Register (index = 0)
   type ST2CW_Register is record
      --  Mask Value
      MASKVAL : ST2CW_MASKVAL_Field := 16#0#;
      --  Compare Value
      COMPVAL : ST2CW_COMPVAL_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for ST2CW_Register use record
      MASKVAL at 0 range 0 .. 15;
      COMPVAL at 0 range 16 .. 31;
   end record;

   subtype ST2CW_OFFSVAL_Field is HAL.UInt7;

   --  Ethernet Frame Offset Start
   type ST2CW10_OFFSSTRT_Field is
     (
      ...
      Tcp_Udp)
     with Size => 2;
   for ST2CW10_OFFSSTRT_Field use
     (Framestart => 0,
      Ethertype => 1,
      Ip => 2,
      Tcp_Udp => 3);
   ...
   type ST2CW_Register_1 is record
      --  Offset Value in Bytes
      OFFSVAL       : ST2CW_OFFSVAL_Field := 16#0#;
      --  Ethernet Frame Offset Start
      OFFSSTRT      : ST2CW10_OFFSSTRT_Field := SAM_SVD.GMAC.Framestart;
      --  unspecified
      Reserved_9_31 : HAL.UInt23 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for ST2CW_Register_1 use record
   ...
   type GMAC_Peripheral is record
      ...
      SAB4      : aliased HAL.UInt32;
      --  Specific Address 4 Top Register
      SAT4      : aliased SAT_Register;
      --  Type ID Match 1 Register
   ...
   for GMAC_Peripheral use record
      ...
      SAB1      at 16#88# range 0 .. 31;
      SAT1      at 16#8C# range 0 .. 31;
      SAB2      at 16#90# range 0 .. 31;
      SAT2      at 16#94# range 0 .. 31;
      SAB3      at 16#98# range 0 .. 31;
      SAT3      at 16#9C# range 0 .. 31;
      SAB4      at 16#A0# range 0 .. 31;
      SAT4      at 16#A4# range 0 .. 31;
      ...
      ISRPQ     at 16#400# range 0 .. 63;
      TBQBAPQ   at 16#440# range 0 .. 63;
      RBQBAPQ   at 16#480# range 0 .. 63;
      RBSRPQ    at 16#4A0# range 0 .. 63;
      ...
      IERPQ     at 16#600# range 0 .. 63;
      IDRPQ     at 16#620# range 0 .. 63;
      IMRPQ     at 16#640# range 0 .. 63;
      ST2ER     at 16#6E0# range 0 .. 127;
      ST2CW00   at 16#700# range 0 .. 31;
      ST2CW10   at 16#704# range 0 .. 31;
      ST2CW01   at 16#708# range 0 .. 31;
      ST2CW11   at 16#70C# range 0 .. 31;
      ST2CW02   at 16#710# range 0 .. 31;
      ST2CW12   at 16#714# range 0 .. 31;
      ST2CW03   at 16#718# range 0 .. 31;
      ST2CW13   at 16#71C# range 0 .. 31;
      ST2CW04   at 16#720# range 0 .. 31;
      ST2CW14   at 16#724# range 0 .. 31;
      ST2CW05   at 16#728# range 0 .. 31;
      ST2CW15   at 16#72C# range 0 .. 31;
      ST2CW06   at 16#730# range 0 .. 31;
      ST2CW16   at 16#734# range 0 .. 31;
      ST2CW07   at 16#738# range 0 .. 31;
      ST2CW17   at 16#73C# range 0 .. 31;
      ST2CW08   at 16#740# range 0 .. 31;
      ST2CW18   at 16#744# range 0 .. 31;
      ST2CW09   at 16#748# range 0 .. 31;
      ST2CW19   at 16#74C# range 0 .. 31;
      ST2CW010  at 16#750# range 0 .. 31;
      ST2CW110  at 16#754# range 0 .. 31;
      ST2CW011  at 16#758# range 0 .. 31;
      ST2CW111  at 16#75C# range 0 .. 31;
      ST2CW012  at 16#760# range 0 .. 31;
      ST2CW112  at 16#764# range 0 .. 31;
      ST2CW013  at 16#768# range 0 .. 31;
      ST2CW113  at 16#76C# range 0 .. 31;
      ST2CW014  at 16#770# range 0 .. 31;
      ST2CW114  at 16#774# range 0 .. 31;
      ST2CW015  at 16#778# range 0 .. 31;
      ST2CW115  at 16#77C# range 0 .. 31;
      ST2CW016  at 16#780# range 0 .. 31;
      ST2CW116  at 16#784# range 0 .. 31;
      ST2CW017  at 16#788# range 0 .. 31;
      ST2CW117  at 16#78C# range 0 .. 31;
      ST2CW018  at 16#790# range 0 .. 31;
      ST2CW118  at 16#794# range 0 .. 31;
      ST2CW019  at 16#798# range 0 .. 31;
      ST2CW119  at 16#79C# range 0 .. 31;
      ST2CW020  at 16#7A0# range 0 .. 31;
      ST2CW120  at 16#7A4# range 0 .. 31;
      ST2CW021  at 16#7A8# range 0 .. 31;
      ST2CW121  at 16#7AC# range 0 .. 31;
      ST2CW022  at 16#7B0# range 0 .. 31;
      ST2CW122  at 16#7B4# range 0 .. 31;
      ST2CW023  at 16#7B8# range 0 .. 31;
      ST2CW123  at 16#7BC# range 0 .. 31;
   end record;
