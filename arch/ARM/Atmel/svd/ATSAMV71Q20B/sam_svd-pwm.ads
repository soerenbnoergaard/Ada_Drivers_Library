...
package SAM_SVD.PWM is
   ...
   subtype PWM0_VERSION_VERSION_Field is HAL.UInt12;
   subtype PWM0_VERSION_MFN_Field is HAL.UInt3;

   --  Version Register
   type PWM0_VERSION_Register is record
      --  Read-only. Version of the Hardware Module
      VERSION        : PWM0_VERSION_VERSION_Field;
      --  unspecified
      Reserved_12_15 : HAL.UInt4;
      --  Read-only. Metal Fix Number
      MFN            : PWM0_VERSION_MFN_Field;
      --  unspecified
   ...
   for PWM0_VERSION_Register use record
   ...
   type PWM_Peripheral is record
      ...
      --  Version Register
      VERSION  : aliased PWM0_VERSION_Register;
      --  PWM Comparison 0 Value Register
