...
package STM32_SVD.AFIO is
   ...
   type MAPR2_Register is record
      --  TIM15 remapping
      TIM15_REMAP         : Boolean := False;
      --  TIM16 remapping
      TIM16_REMAP         : Boolean := False;
      --  TIM17 remapping
      TIM17_REMAP         : Boolean := False;
      --  CEC remapping
      CEC_REMAP           : Boolean := False;
      --  TIM1 DMA remapping
      TIM1_DMA_REMAP      : Boolean := False;
      --  unspecified
      ...
      TIM67_DAC_DMA_REMAP : Boolean := False;
      --  TIM12 remapping
      TIM12_REMAP         : Boolean := False;
      --  Miscellaneous features remapping
      MISC_REMAP          : Boolean := False;
      --  unspecified
   ...
   for MAPR2_Register use record
      TIM15_REMAP         at 0 range 0 .. 0;
      TIM16_REMAP         at 0 range 1 .. 1;
      TIM17_REMAP         at 0 range 2 .. 2;
      CEC_REMAP           at 0 range 3 .. 3;
      TIM1_DMA_REMAP      at 0 range 4 .. 4;
      Reserved_5_7        at 0 range 5 .. 7;
      TIM13_REMAP         at 0 range 8 .. 8;
      TIM14_REMAP         at 0 range 9 .. 9;
      FSMC_NADV           at 0 range 10 .. 10;
      TIM67_DAC_DMA_REMAP at 0 range 11 .. 11;
      TIM12_REMAP         at 0 range 12 .. 12;
      MISC_REMAP          at 0 range 13 .. 13;
