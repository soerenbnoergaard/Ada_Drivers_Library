...
package STM32_SVD.TIM is
   ...
   --  capture/compare mode register 2 (input mode)
   type CCMR2_Input_Register_1 is record
      --  Capture/Compare 3 selection
      CC3S           : CCMR2_Input_CC3S_Field := 16#0#;
      --  Input capture 3 prescaler
      IC3PSC         : CCMR2_Input_IC3PSC_Field := 16#0#;
   ...
   for CCMR2_Input_Register_1 use record
      CC3S           at 0 range 0 .. 1;
      IC3PSC         at 0 range 2 .. 3;
      IC3F           at 0 range 4 .. 7;
      CC4S           at 0 range 8 .. 9;
   ...
   type CCMR1_Input_Register_3 is record
      --  Capture/Compare 1 selection
      CC1S          : CCMR1_Input_CC1S_Field := 16#0#;
      --  Input capture 1 prescaler
      IC1PSC        : CCMR1_Input_IC1PSC_Field := 16#0#;
   ...
   for CCMR1_Input_Register_3 use record
      CC1S          at 0 range 0 .. 1;
      IC1PSC        at 0 range 2 .. 3;
      IC1F          at 0 range 4 .. 7;
      Reserved_8_31 at 0 range 8 .. 31;
   ...
   --  DMA/Interrupt enable register
   type DIER_Register_6 is record
      --  Update interrupt enable
      UIE            : Boolean := False;
      --  Capture/Compare 1 interrupt enable
      CC1IE          : Boolean := False;
   ...
   for DIER_Register_6 use record
      UIE            at 0 range 0 .. 0;
      CC1IE          at 0 range 1 .. 1;
   ...
   --  capture/compare enable register
   type CCER_Register_5 is record
      --  Capture/Compare 1 output enable
      CC1E          : Boolean := False;
      --  Capture/Compare 1 output Polarity
      CC1P          : Boolean := False;
   ...
   for CCER_Register_5 use record
      CC1E          at 0 range 0 .. 0;
      CC1P          at 0 range 1 .. 1;
      CC1NE         at 0 range 2 .. 2;
      CC1NP         at 0 range 3 .. 3;
   ...
   is record
      ...
      case Discriminent is
         ...
         when Input =>
            ...
            --  capture/compare mode register 2 (input mode)
            CCMR2_Input : aliased CCMR2_Input_Register_1;
      end case;
   end record
     with Unchecked_Union, Volatile;
   ...
   is record
      ...
      case Discriminent is
         ...
         when Input =>
            --  capture/compare mode register (input mode)
            CCMR1_Input : aliased CCMR1_Input_Register_3;
      end case;
   end record
     with Unchecked_Union, Volatile;
   ...
   is record
      ...
      --  DMA/Interrupt enable register
      DIER         : aliased DIER_Register_6;
      --  status register
      SR           : aliased SR_Register_6;
      --  event generation register
      EGR          : aliased EGR_Register_6;
      --  capture/compare enable register
      CCER         : aliased CCER_Register_5;
      --  counter
      CNT          : aliased CNT_Register;
      --  prescaler
      PSC          : aliased PSC_Register;
