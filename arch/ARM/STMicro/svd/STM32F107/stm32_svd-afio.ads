...
package STM32_SVD.AFIO is
   ...
   subtype MAPR_CAN1_REMAP_Field is HAL.UInt2;
   ...
   type MAPR_Register is record
      ...
      ETH_REMAP       : Boolean := False;
      --  CAN2 I/O remapping
      CAN2_REMAP      : Boolean := False;
      ...
      --  SPI3/I2S3 remapping
      SPI3_REMAP      : Boolean := False;
      --  TIM2 internal trigger 1 remapping
      TIM2ITR1_IREMAP : Boolean := False;
      --  Ethernet PTP PPS remapping
      PTP_PPS_REMAP   : Boolean := False;
      --  unspecified
