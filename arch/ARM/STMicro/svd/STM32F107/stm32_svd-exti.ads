...
package STM32_SVD.EXTI is
   ...
   --  IMR_MR array
   type IMR_MR_Field_Array is array (0 .. 19) of Boolean
   ...
   --  EMR_MR array
   type EMR_MR_Field_Array is array (0 .. 19) of Boolean
     with Component_Size => 1, Size => 20;
   ...
   --  RTSR_TR array
   type RTSR_TR_Field_Array is array (0 .. 19) of Boolean
     with Component_Size => 1, Size => 20;
   ...
   --  FTSR_TR array
   type FTSR_TR_Field_Array is array (0 .. 19) of Boolean
     with Component_Size => 1, Size => 20;
   ...
   --  SWIER array
   type SWIER_Field_Array is array (0 .. 19) of Boolean
     with Component_Size => 1, Size => 20;
   ...
   for SWIER_Register use record
      SWIER          at 0 range 0 .. 19;
      Reserved_20_31 at 0 range 20 .. 31;
   end record;

   --  PR array
   type PR_Field_Array is array (0 .. 19) of Boolean
     with Component_Size => 1, Size => 20;
