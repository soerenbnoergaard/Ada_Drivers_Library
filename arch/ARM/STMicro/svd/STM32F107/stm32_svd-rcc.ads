...
package STM32_SVD.RCC is
   ...
   subtype CFGR_MCO_Field is HAL.UInt4;
   ...
   for AHBENR_Register use record
      ...
      Reserved_13_13 at 0 range 13 .. 13;
      ETHMACEN       at 0 range 14 .. 14;
      ETHMACTXEN     at 0 range 15 .. 15;
      ETHMACRXEN     at 0 range 16 .. 16;
   ...
   for AHBRSTR_Register use record
      ...
      Reserved_13_13 at 0 range 13 .. 13;
      ETHMACRST      at 0 range 14 .. 14;
      Reserved_15_31 at 0 range 15 .. 31;
   end record;

   --  CFGR2_PREDIV array element
   subtype CFGR2_PREDIV_Element is HAL.UInt4;
   ...
   subtype CFGR2_PLL2MUL_Field is HAL.UInt4;
   subtype CFGR2_PLL3MUL_Field is HAL.UInt4;
   ...
   type CFGR2_Register is record
      ...
      PREDIV1SRC     : Boolean := False;
      --  I2S2 clock source
      I2S2SRC        : Boolean := False;
      --  I2S3 clock source
      I2S3SRC        : Boolean := False;
      --  unspecified
