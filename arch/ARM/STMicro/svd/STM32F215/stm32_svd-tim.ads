...
package STM32_SVD.TIM is
   ...
   subtype TIM2_OR_IT4_RMP_Field is HAL.UInt2;

   --  TIM2 option register
   type TIM2_OR_Register is record
      --  unspecified
      Reserved_0_5  : HAL.UInt6 := 16#0#;
      --  Timer Input 4 remap
      IT4_RMP       : TIM2_OR_IT4_RMP_Field := 16#0#;
      --  unspecified
      Reserved_8_31 : HAL.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   subtype TIM5_OR_IT4_RMP_Field is HAL.UInt2;

   --  TIM5 option register
   type TIM5_OR_Register is record
      --  unspecified
      Reserved_0_5  : HAL.UInt6 := 16#0#;
      --  Timer Input 4 remap
      IT4_RMP       : TIM5_OR_IT4_RMP_Field := 16#0#;
      --  unspecified
      Reserved_8_31 : HAL.UInt24 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   is record
      ...
      DMAR         : aliased DMAR_Register;
      --  TIM2 option register
      TIM2_OR      : aliased TIM2_OR_Register;
      case Discriminent is
         when Output =>
            --  capture/compare mode register 1 (output mode)
            CCMR1_Output : aliased CCMR1_Output_Register;
   ...
   is record
      ...
      DMAR         : aliased DMAR_Register;
      --  TIM5 option register
      TIM5_OR      : aliased TIM5_OR_Register;
      case Discriminent is
         when Output =>
            --  capture/compare mode register 1 (output mode)
            CCMR1_Output : aliased CCMR1_Output_Register;
