...
package STM32_SVD.RCC is
   ...
   for AHBRSTR_Register use record
      ...
      Reserved_25_27 at 0 range 25 .. 27;
      ADC1RST        at 0 range 28 .. 28;
      Reserved_29_31 at 0 range 29 .. 31;
   end record;

   subtype CFGR2_PREDIV_Field is HAL.UInt4;
   subtype CFGR2_ADC1PRES_Field is HAL.UInt4;
   ...
   type CFGR2_Register is record
      ...
      --  ADC1 prescaler
      ADC1PRES      : CFGR2_ADC1PRES_Field := 16#0#;
      --  unspecified
   ...
   for CFGR2_Register use record
      ...
      ADC1PRES      at 0 range 4 .. 7;
      Reserved_8_31 at 0 range 8 .. 31;
   end record;

   subtype CFGR3_USART1SW_Field is HAL.UInt2;
   subtype CFGR3_TIM17SW_Field is HAL.UInt2;
   ...
   type CFGR3_Register is record
      ...
      TIM15SW        : Boolean := False;
      --  Timer16 clock source selection
      TIM16SW        : Boolean := False;
      --  unspecified
      Reserved_12_12 : HAL.Bit := 16#0#;
      --  Timer17 clock source selection
      TIM17SW        : CFGR3_TIM17SW_Field := 16#0#;
      --  unspecified
   ...
   for CFGR3_Register use record
      ...
      TIM15SW        at 0 range 10 .. 10;
      TIM16SW        at 0 range 11 .. 11;
      Reserved_12_12 at 0 range 12 .. 12;
      TIM17SW        at 0 range 13 .. 14;
