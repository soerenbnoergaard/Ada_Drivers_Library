...
package STM32_SVD.TIM is
   ...
   subtype CR1_UIFREMAP_Field is HAL.UInt2;
   ...
   subtype CNT_CNTH_Field_1 is HAL.UInt16;
   ...
   --  capture/compare mode register (output mode)
   type CCMR1_Output_Register_3 is record
      --  Capture/Compare 1 selection
      CC1S          : CCMR1_Output_CC1S_Field := 16#0#;
      --  Output compare 1 fast enable
      OC1FE         : Boolean := False;
   ...
   for CCMR1_Output_Register_3 use record
      CC1S          at 0 range 0 .. 1;
      OC1FE         at 0 range 2 .. 2;
      OC1PE         at 0 range 3 .. 3;
      OC1M          at 0 range 4 .. 6;
   ...
   --  General purpose timer
   TIM19_Periph : aliased TIM3_Peripheral
   ...
   --  Basic timers
   TIM18_Periph : aliased TIM6_Peripheral
     with Import, Address => System'To_Address (16#40009C00#);
   ...
   is record
      ...
      case Discriminent is
         when Output =>
            --  capture/compare mode register (output mode)
            CCMR1_Output : aliased CCMR1_Output_Register_3;
         when Input =>
            --  capture/compare mode register (input mode)
