...
package STM32_SVD.SPI is
   ...
   type I2S2ext_Peripheral is record
      --  control register 1
   ...
   for I2S2ext_Peripheral use record
   ...
   --  Serial peripheral interface/Inter-IC2
   I2S2ext_Periph : aliased I2S2ext_Peripheral
     with Import, Address => System'To_Address (16#40003400#);

   --  Serial peripheral interface/Inter-IC2
   I2S3ext_Periph : aliased I2S2ext_Peripheral
     with Import, Address => System'To_Address (16#40004000#);

   --  Serial peripheral interface/Inter-IC2
   SPI2_Periph : aliased I2S2ext_Peripheral
