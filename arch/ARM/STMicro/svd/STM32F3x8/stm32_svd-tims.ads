...
package STM32_SVD.TIMs is
   ...
   subtype OR_TIM1_ETR_ADC4_RMP_Field is HAL.UInt2;
   ...
   for TIMs_Peripheral use record
   ...
   --  Advanced timer
   TIM1_Periph : aliased TIMs_Peripheral
     with Import, Address => System'To_Address (16#40012C00#);

   --  Advanced timer
   TIM8_Periph : aliased TIMs_Peripheral
