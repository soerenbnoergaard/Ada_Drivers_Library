...
package STM32_SVD.SYSCFG is
   ...
   --  I2C_BUFOUT
   type I2C_BUFOUT_Register is record
      --  I2C4SCL
      I2C4SCL       : Boolean := False;
      --  I2C4SDA
      I2C4SDA       : Boolean := False;
      --  unspecified
      Reserved_2_31 : HAL.UInt30 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
   ...
   for I2C_BUFOUT_Register use record
      I2C4SCL       at 0 range 0 .. 0;
      I2C4SDA       at 0 range 1 .. 1;
      Reserved_2_31 at 0 range 2 .. 31;
   end record;
   ...
   type SYSCFG_Peripheral is record
      ...
      --  I2C_BUFOUT
      I2C_BUFOUT : aliased I2C_BUFOUT_Register;
   end record
     with Volatile;
   ...
   for SYSCFG_Peripheral use record
      ...
      I2C_BUFOUT at 16#2C# range 0 .. 31;
   end record;
