...
package STM32_SVD.FSMC is
   ...
   subtype BCR1_CPSIZE_Field is HAL.UInt3;
   ...
   subtype SDCR2_NC_Field is HAL.UInt2;
   subtype SDCR2_NR_Field is HAL.UInt2;
   subtype SDCR2_MWID_Field is HAL.UInt2;
   subtype SDCR2_CAS_Field is HAL.UInt2;
   subtype SDCR2_SDCLK_Field is HAL.UInt2;
   ...
   type FMC_Peripheral
     (Discriminent : FMC_Disc := FMC_Disc_1)
   is record
      --  SRAM/NOR-Flash chip-select control register 1
