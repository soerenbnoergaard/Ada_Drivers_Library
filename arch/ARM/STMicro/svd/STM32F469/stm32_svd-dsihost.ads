--  This spec has been automatically generated from STM32F469.svd
...
package STM32_SVD.DSIHOST is
   ...
   subtype DSIHSOT_CCR_TXECKDIV_Field is HAL.UInt8;
   subtype DSIHSOT_CCR_TOCKDIV_Field is HAL.UInt8;
   ...
   type DSIHSOT_CCR_Register is record
      ...
      --  unspecified
      Reserved_16_31 : HAL.UInt16 := 16#3133#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype DSI_TCCR1_LPRX_TOCNT_Field is HAL.UInt16;
   subtype DSI_TCCR1_HSTX_TOCNT_Field is HAL.UInt16;
   ...
   subtype DSI_TCCR2_HSRD_TOCNT_Field is HAL.UInt16;
   ...
   subtype DSI_TCCR3_LPRD_TOCNT_Field is HAL.UInt16;
   ...
   subtype DSI_TCCR4_HSWR_TOCNT_Field is HAL.UInt16;
   ...
   subtype DSI_TCCR5_LSWR_TOCNT_Field is HAL.UInt16;
   ...
   subtype DSI_TCCR6_BTA_TOCNT_Field is HAL.UInt16;
   ...
   subtype DSI_PCCONFR_SW_TIME_Field is HAL.UInt8;
   ...
   type DSIHOST_Peripheral is record
      ...
      --  DSI HOST Clock Control Register
      DSIHSOT_CCR : aliased DSIHSOT_CCR_Register;
      --  DSI Host LTDC VCID Register
      ...
      --  DSI Host Timeout Counter Configuration Register6
      DSI_TCCR6   : aliased DSI_TCCR6_Register;
      --  DSI Host Clock Lane Configuration Register
      ...
      --  DSI Host PHY Configuration Register
      DSI_PCCONFR : aliased DSI_PCCONFR_Register;
      --  DSI Host PHY ULPS Control Register
   ...
   for DSIHOST_Peripheral use record
      ...
      DSIHSOT_CCR at 16#8# range 0 .. 31;
      ...
      DSI_TCCR1   at 16#78# range 0 .. 31;
      DSI_TCCR2   at 16#7C# range 0 .. 31;
      DSI_TCCR3   at 16#80# range 0 .. 31;
      DSI_TCCR4   at 16#84# range 0 .. 31;
      DSI_TCCR5   at 16#88# range 0 .. 31;
      DSI_TCCR6   at 16#8C# range 0 .. 31;
      DSI_CLCR    at 16#94# range 0 .. 31;
      DSI_CLTCR   at 16#98# range 0 .. 31;
      DSI_DLTCR   at 16#9C# range 0 .. 31;
      DSI_PCTLR   at 16#A0# range 0 .. 31;
      DSI_PCCONFR at 16#A4# range 0 .. 31;
