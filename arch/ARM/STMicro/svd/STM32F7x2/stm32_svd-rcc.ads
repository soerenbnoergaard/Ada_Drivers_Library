...
package STM32_SVD.RCC is
   ...
   type AHB2LPENR_Register is record
      ...
      AESLPEN       : Boolean := True;
      --  unspecified
      Reserved_5_5  : HAL.Bit := 16#1#;
   ...
   subtype DCKCFGR1_PLLI2SDIV_Field is HAL.UInt5;
   subtype DCKCFGR1_PLLSAIDIVQ_Field is HAL.UInt5;
   subtype DCKCFGR1_SAI1SEL_Field is HAL.UInt2;
   subtype DCKCFGR1_SAI2SEL_Field is HAL.UInt2;

   --  dedicated clocks configuration register
   type DCKCFGR1_Register is record
      --  PLLI2S division factor for SAI1 clock
      PLLI2SDIV      : DCKCFGR1_PLLI2SDIV_Field := 16#0#;
      --  unspecified
      Reserved_5_7   : HAL.UInt3 := 16#0#;
      --  PLLSAI division factor for SAI1 clock
      PLLSAIDIVQ     : DCKCFGR1_PLLSAIDIVQ_Field := 16#10#;
      --  unspecified
      Reserved_13_19 : HAL.UInt7 := 16#1#;
      --  SAI1 clock source selection
      SAI1SEL        : DCKCFGR1_SAI1SEL_Field := 16#0#;
      --  SAI2 clock source selection
      SAI2SEL        : DCKCFGR1_SAI2SEL_Field := 16#0#;
   ...
   for DCKCFGR1_Register use record
   ...
   subtype DCKCFGR2_UART1SEL_Field is HAL.UInt2;
   subtype DCKCFGR2_UART2SEL_Field is HAL.UInt2;
   subtype DCKCFGR2_UART3SEL_Field is HAL.UInt2;
   subtype DCKCFGR2_UART4SEL_Field is HAL.UInt2;
   subtype DCKCFGR2_UART5SEL_Field is HAL.UInt2;
   subtype DCKCFGR2_UART6SEL_Field is HAL.UInt2;
   subtype DCKCFGR2_UART7SEL_Field is HAL.UInt2;
   subtype DCKCFGR2_UART8SEL_Field is HAL.UInt2;
   subtype DCKCFGR2_I2C1SEL_Field is HAL.UInt2;
   subtype DCKCFGR2_I2C2SEL_Field is HAL.UInt2;
   subtype DCKCFGR2_I2C3SEL_Field is HAL.UInt2;
   subtype DCKCFGR2_LPTIM1SEL_Field is HAL.UInt2;

   --  dedicated clocks configuration register
   type DCKCFGR2_Register is record
      --  USART 1 clock source selection
      UART1SEL       : DCKCFGR2_UART1SEL_Field := 16#0#;
      --  USART 2 clock source selection
      UART2SEL       : DCKCFGR2_UART2SEL_Field := 16#0#;
      --  USART 3 clock source selection
      UART3SEL       : DCKCFGR2_UART3SEL_Field := 16#0#;
      --  UART 4 clock source selection
      UART4SEL       : DCKCFGR2_UART4SEL_Field := 16#0#;
      --  UART 5 clock source selection
      UART5SEL       : DCKCFGR2_UART5SEL_Field := 16#0#;
      --  USART 6 clock source selection
      UART6SEL       : DCKCFGR2_UART6SEL_Field := 16#0#;
      --  UART 7 clock source selection
      UART7SEL       : DCKCFGR2_UART7SEL_Field := 16#3#;
      --  UART 8 clock source selection
      UART8SEL       : DCKCFGR2_UART8SEL_Field := 16#0#;
      --  I2C1 clock source selection
      I2C1SEL        : DCKCFGR2_I2C1SEL_Field := 16#0#;
      --  I2C2 clock source selection
      I2C2SEL        : DCKCFGR2_I2C2SEL_Field := 16#0#;
      --  I2C3 clock source selection
      I2C3SEL        : DCKCFGR2_I2C3SEL_Field := 16#0#;
      --  unspecified
   ...
   for DCKCFGR2_Register use record
      UART1SEL       at 0 range 0 .. 1;
      UART2SEL       at 0 range 2 .. 3;
      UART3SEL       at 0 range 4 .. 5;
      UART4SEL       at 0 range 6 .. 7;
      UART5SEL       at 0 range 8 .. 9;
      UART6SEL       at 0 range 10 .. 11;
   ...
   type RCC_Peripheral is record
      ...
      --  dedicated clocks configuration register
      DCKCFGR1   : aliased DCKCFGR1_Register;
      --  dedicated clocks configuration register
   ...
   for RCC_Peripheral use record
      ...
      DCKCFGR1   at 16#8C# range 0 .. 31;
      DCKCFGR2   at 16#90# range 0 .. 31;
   end record;
