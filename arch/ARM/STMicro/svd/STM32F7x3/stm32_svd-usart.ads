...
package STM32_SVD.USART is
   ...
   subtype BRR_BRR_Field is HAL.UInt16;
   ...
   type ICR_Register is record
      ...
      TCCF           : Boolean := False;
      --  Write-only. Transmission completed before guard time clear flag
   ...
   --  Universal synchronous asynchronous receiver transmitter
   USART3_Periph : aliased UART4_Peripheral
     with Import, Address => System'To_Address (16#40004800#);

   --  Universal synchronous asynchronous receiver transmitter
   USART6_Periph : aliased UART4_Peripheral
