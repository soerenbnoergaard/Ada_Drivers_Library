...
package STM32_SVD.USB_OTG_HS is
   ...
   subtype OTG_HS_HNPTXSTS_NPTXFSAV_Field is HAL.UInt16;
   subtype OTG_HS_HNPTXSTS_NPTQXSAV_Field is HAL.UInt8;
   subtype OTG_HS_HNPTXSTS_NPTXQTOP_Field is HAL.UInt7;

   --  OTG_HS nonperiodic transmit FIFO/queue status register
   type OTG_HS_HNPTXSTS_Register is record
      --  Read-only. Nonperiodic TxFIFO space available
      NPTXFSAV       : OTG_HS_HNPTXSTS_NPTXFSAV_Field;
      --  Read-only. Nonperiodic transmit request queue space available
      NPTQXSAV       : OTG_HS_HNPTXSTS_NPTQXSAV_Field;
      --  Read-only. Top of the nonperiodic transmit request queue
      NPTXQTOP       : OTG_HS_HNPTXSTS_NPTXQTOP_Field;
      --  unspecified
   ...
   for OTG_HS_HNPTXSTS_Register use record
   ...
   subtype OTG_HS_GI2CCTL_RWDATA_Field is HAL.UInt8;
   subtype OTG_HS_GI2CCTL_REGADDR_Field is HAL.UInt8;
   subtype OTG_HS_GI2CCTL_ADDR_Field is HAL.UInt7;
   subtype OTG_HS_GI2CCTL_I2CDEVADR_Field is HAL.UInt2;

   --  OTG I2C access register
   type OTG_HS_GI2CCTL_Register is record
      --  I2C Read/Write Data
      RWDATA         : OTG_HS_GI2CCTL_RWDATA_Field := 16#0#;
      --  I2C Register Address
      REGADDR        : OTG_HS_GI2CCTL_REGADDR_Field := 16#0#;
      --  I2C Address
      ADDR           : OTG_HS_GI2CCTL_ADDR_Field := 16#0#;
      --  I2C Enable
      I2CEN          : Boolean := False;
      --  I2C ACK
      ACK            : Boolean := False;
      ...
      --  I2C Device Address
      I2CDEVADR      : OTG_HS_GI2CCTL_I2CDEVADR_Field := 16#0#;
      --  I2C DatSe0 USB mode
   ...
   for OTG_HS_GI2CCTL_Register use record
   ...
   type OTG_HS_DEVICE_Peripheral is record
      ...
      OTG_HS_DIEPDMA0    : aliased HAL.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      --  OTG Device channel-x DMA address register
      OTG_HS_DIEPDMA6    : aliased HAL.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      ...
      --  OTG Device channel-x DMA address register
      OTG_HS_DIEPDMA7    : aliased HAL.UInt32;
      --  OTG_HS device IN endpoint transmit FIFO status register
      OTG_HS_DTXFSTS7    : aliased OTG_HS_DTXFSTS_Register;
      --  OTG Device channel-x DMA address register
      OTG_HS_DIEPDMA8    : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DIEPDMA9    : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DIEPDMA10   : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DIEPDMA11   : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DIEPDMA12   : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DIEPDMA13   : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DIEPDMA14   : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DIEPDMA15   : aliased HAL.UInt32;
      --  OTG_HS device control OUT endpoint 0 control register
      ...
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA0    : aliased HAL.UInt32;
      --  OTG device endpoint-1 control register
      ...
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA1    : aliased HAL.UInt32;
      --  OTG device endpoint-2 control register
      ...
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA2    : aliased HAL.UInt32;
      --  OTG device endpoint-3 control register
      ...
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA3    : aliased HAL.UInt32;
      --  OTG device endpoint-4 control register
      ...
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA4    : aliased HAL.UInt32;
      --  OTG device endpoint-5 control register
      ...
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA5    : aliased HAL.UInt32;
      --  OTG device endpoint-6 control register
      ...
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA6    : aliased HAL.UInt32;
      --  OTG device endpoint-7 control register
      ...
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA7    : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA8    : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA9    : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA10   : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA11   : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA12   : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA13   : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA14   : aliased HAL.UInt32;
      --  OTG Device channel-x DMA address register
      OTG_HS_DOEPDMA15   : aliased HAL.UInt32;
   end record
     with Volatile;
   ...
   for OTG_HS_DEVICE_Peripheral use record
      ...
      OTG_HS_DIEPDMA0    at 16#114# range 0 .. 31;
      ...
      OTG_HS_DIEPDMA1    at 16#134# range 0 .. 31;
      ...
      OTG_HS_DIEPDMA2    at 16#154# range 0 .. 31;
      ...
      OTG_HS_DIEPDMA3    at 16#174# range 0 .. 31;
      ...
      OTG_HS_DIEPDMA4    at 16#194# range 0 .. 31;
      ...
      OTG_HS_DIEPDMA5    at 16#1B4# range 0 .. 31;
      ...
      OTG_HS_DIEPDMA6    at 16#1D4# range 0 .. 31;
      ...
      OTG_HS_DIEPDMA7    at 16#1F4# range 0 .. 31;
      OTG_HS_DTXFSTS7    at 16#1F8# range 0 .. 31;
      OTG_HS_DIEPDMA8    at 16#214# range 0 .. 31;
      OTG_HS_DIEPDMA9    at 16#234# range 0 .. 31;
      OTG_HS_DIEPDMA10   at 16#254# range 0 .. 31;
      OTG_HS_DIEPDMA11   at 16#274# range 0 .. 31;
      OTG_HS_DIEPDMA12   at 16#294# range 0 .. 31;
      OTG_HS_DIEPDMA13   at 16#2B4# range 0 .. 31;
      OTG_HS_DIEPDMA14   at 16#2D4# range 0 .. 31;
      OTG_HS_DIEPDMA15   at 16#2F4# range 0 .. 31;
      OTG_HS_DOEPCTL0    at 16#300# range 0 .. 31;
      OTG_HS_DOEPINT0    at 16#308# range 0 .. 31;
      OTG_HS_DOEPTSIZ0   at 16#310# range 0 .. 31;
      OTG_HS_DOEPDMA0    at 16#314# range 0 .. 31;
      OTG_HS_DOEPCTL1    at 16#320# range 0 .. 31;
      OTG_HS_DOEPINT1    at 16#328# range 0 .. 31;
      OTG_HS_DOEPTSIZ1   at 16#330# range 0 .. 31;
      OTG_HS_DOEPDMA1    at 16#334# range 0 .. 31;
      OTG_HS_DOEPCTL2    at 16#340# range 0 .. 31;
      OTG_HS_DOEPINT2    at 16#348# range 0 .. 31;
      OTG_HS_DOEPTSIZ2   at 16#350# range 0 .. 31;
      OTG_HS_DOEPDMA2    at 16#354# range 0 .. 31;
      OTG_HS_DOEPCTL3    at 16#360# range 0 .. 31;
      OTG_HS_DOEPINT3    at 16#368# range 0 .. 31;
      OTG_HS_DOEPTSIZ3   at 16#370# range 0 .. 31;
      OTG_HS_DOEPDMA3    at 16#374# range 0 .. 31;
      OTG_HS_DOEPCTL4    at 16#380# range 0 .. 31;
      OTG_HS_DOEPINT4    at 16#388# range 0 .. 31;
      OTG_HS_DOEPTSIZ4   at 16#390# range 0 .. 31;
      OTG_HS_DOEPDMA4    at 16#394# range 0 .. 31;
      OTG_HS_DOEPCTL5    at 16#3A0# range 0 .. 31;
      OTG_HS_DOEPINT5    at 16#3A8# range 0 .. 31;
      OTG_HS_DOEPTSIZ5   at 16#3B0# range 0 .. 31;
      OTG_HS_DOEPDMA5    at 16#3B4# range 0 .. 31;
      OTG_HS_DOEPCTL6    at 16#3C0# range 0 .. 31;
      OTG_HS_DOEPINT6    at 16#3C8# range 0 .. 31;
      OTG_HS_DOEPTSIZ6   at 16#3D0# range 0 .. 31;
      OTG_HS_DOEPDMA6    at 16#3D4# range 0 .. 31;
      OTG_HS_DOEPCTL7    at 16#3E0# range 0 .. 31;
      OTG_HS_DOEPINT7    at 16#3E8# range 0 .. 31;
      OTG_HS_DOEPTSIZ7   at 16#3F0# range 0 .. 31;
      OTG_HS_DOEPDMA7    at 16#3F4# range 0 .. 31;
      OTG_HS_DOEPDMA8    at 16#414# range 0 .. 31;
      OTG_HS_DOEPDMA9    at 16#434# range 0 .. 31;
      OTG_HS_DOEPDMA10   at 16#454# range 0 .. 31;
      OTG_HS_DOEPDMA11   at 16#474# range 0 .. 31;
      OTG_HS_DOEPDMA12   at 16#494# range 0 .. 31;
      OTG_HS_DOEPDMA13   at 16#4B4# range 0 .. 31;
      OTG_HS_DOEPDMA14   at 16#4D4# range 0 .. 31;
      OTG_HS_DOEPDMA15   at 16#4F4# range 0 .. 31;
   end record;
   ...
   is record
      ...
      --  OTG_HS nonperiodic transmit FIFO/queue status register
      OTG_HS_HNPTXSTS        : aliased OTG_HS_HNPTXSTS_Register;
      --  OTG I2C access register
      OTG_HS_GI2CCTL         : aliased OTG_HS_GI2CCTL_Register;
      --  OTG_HS general core configuration register
   ...
   for OTG_HS_GLOBAL_Peripheral use record
      ...
      OTG_HS_HNPTXSTS        at 16#2C# range 0 .. 31;
      OTG_HS_GI2CCTL         at 16#30# range 0 .. 31;
   ...
   for OTG_HS_HOST_Peripheral use record
      ...
      OTG_HS_HCCHAR12   at 16#280# range 0 .. 31;
      OTG_HS_HCSPLT12   at 16#284# range 0 .. 31;
      OTG_HS_HCINT12    at 16#288# range 0 .. 31;
      OTG_HS_HCINTMSK12 at 16#28C# range 0 .. 31;
      OTG_HS_HCTSIZ12   at 16#290# range 0 .. 31;
      OTG_HS_HCDMA12    at 16#294# range 0 .. 31;
      OTG_HS_HCCHAR13   at 16#2A0# range 0 .. 31;
      OTG_HS_HCSPLT13   at 16#2A4# range 0 .. 31;
      OTG_HS_HCINT13    at 16#2A8# range 0 .. 31;
      OTG_HS_HCINTMSK13 at 16#2AC# range 0 .. 31;
      OTG_HS_HCTSIZ13   at 16#2B0# range 0 .. 31;
      OTG_HS_HCDMA13    at 16#2B4# range 0 .. 31;
      OTG_HS_HCCHAR14   at 16#2C0# range 0 .. 31;
      OTG_HS_HCSPLT14   at 16#2C4# range 0 .. 31;
      OTG_HS_HCINT14    at 16#2C8# range 0 .. 31;
      OTG_HS_HCINTMSK14 at 16#2CC# range 0 .. 31;
      OTG_HS_HCTSIZ14   at 16#2D0# range 0 .. 31;
      OTG_HS_HCDMA14    at 16#2D4# range 0 .. 31;
      OTG_HS_HCCHAR15   at 16#2E0# range 0 .. 31;
      OTG_HS_HCSPLT15   at 16#2E4# range 0 .. 31;
      OTG_HS_HCINT15    at 16#2E8# range 0 .. 31;
      OTG_HS_HCINTMSK15 at 16#2EC# range 0 .. 31;
      OTG_HS_HCTSIZ15   at 16#2F0# range 0 .. 31;
      OTG_HS_HCDMA15    at 16#2F4# range 0 .. 31;
   end record;
