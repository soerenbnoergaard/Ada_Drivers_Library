...
package STM32_SVD.SPI is
   ...
   --  Serial peripheral interface
   type SPI3_Peripheral is record
      --  control register 1
      CR1     : aliased CR1_Register;
      --  control register 2
      CR2     : aliased CR2_Register;
   ...
   for SPI3_Peripheral use record
      CR1     at 16#0# range 0 .. 31;
      CR2     at 16#4# range 0 .. 31;
      SR      at 16#8# range 0 .. 31;
      DR      at 16#C# range 0 .. 31;
   ...
   --  Serial peripheral interface
   SPI3_Periph : aliased SPI3_Peripheral
     with Import, Address => System'To_Address (16#40003C00#);

   --  Serial peripheral interface
   type SPI6_Peripheral is record
      --  control register 1
      CR1     : aliased CR1_Register;
      --  control register 2
      CR2     : aliased CR2_Register;
   ...
   for SPI6_Peripheral use record
      CR1     at 16#0# range 0 .. 31;
      CR2     at 16#4# range 0 .. 31;
      SR      at 16#8# range 0 .. 31;
      DR      at 16#C# range 0 .. 31;
   ...
   --  Serial peripheral interface
   SPI6_Periph : aliased SPI6_Peripheral
