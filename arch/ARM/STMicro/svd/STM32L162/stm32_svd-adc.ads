...
package STM32_SVD.ADC is
   ...
   subtype CR2_DELS_Field is HAL.UInt3;
   ...
   subtype SMPR_SMP_Field is HAL.UInt30;
   ...
   subtype SQR4_SQ_Element is HAL.UInt5;
   ...
   subtype SQR5_SQ_Element is HAL.UInt5;
   ...
   subtype SMPR0_SMP_Field is HAL.UInt6;
