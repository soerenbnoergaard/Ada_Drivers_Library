--  This spec has been automatically generated from STM32L4R5.svd
...
package STM32_SVD.DSI is
   ...
   subtype DSI_DLTRC_MRD_TIME_Field is HAL.UInt15;
   subtype DSI_DLTRC_LP2HS_TIME_Field is HAL.UInt8;
   subtype DSI_DLTRC_HS2LP_TIME_Field is HAL.UInt8;

   --  DSI Host Data Lane Timer Configuration Register
   type DSI_DLTRC_Register is record
      --  Maximum Read Time
      MRD_TIME       : DSI_DLTRC_MRD_TIME_Field := 16#0#;
      --  unspecified
      Reserved_15_15 : HAL.Bit := 16#0#;
      --  Low-Power To High-Speed Time
      LP2HS_TIME     : DSI_DLTRC_LP2HS_TIME_Field := 16#0#;
      --  High-Speed To Low-Power Time
      HS2LP_TIME     : DSI_DLTRC_HS2LP_TIME_Field := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;

   for DSI_DLTRC_Register use record
   ...
   type DSI_Peripheral is record
      ...
      --  DSI Host Data Lane Timer Configuration Register
      DSI_DLTRC   : aliased DSI_DLTRC_Register;
      --  DSI Host PHY Control Register
   ...
   for DSI_Peripheral use record
      ...
      DSI_PCR     at 16#1C# range 0 .. 31;
      DSI_GVCIDR  at 16#20# range 0 .. 31;
      DSI_MCR     at 16#24# range 0 .. 31;
      DSI_VMCR    at 16#28# range 0 .. 31;
      DSI_VPCR    at 16#2C# range 0 .. 31;
      DSI_VCCR    at 16#30# range 0 .. 31;
      DSI_VNPCR   at 16#34# range 0 .. 31;
      DSI_VHSACR  at 16#38# range 0 .. 31;
      DSI_VHBPCR  at 16#3C# range 0 .. 31;
      DSI_VLCR    at 16#40# range 0 .. 31;
      DSI_VVSACR  at 16#44# range 0 .. 31;
      DSI_VVBPCR  at 16#48# range 0 .. 31;
      DSI_VVFPCR  at 16#4C# range 0 .. 31;
      DSI_VVACR   at 16#50# range 0 .. 31;
      DSI_LCCR    at 16#54# range 0 .. 31;
      DSI_CMCR    at 16#58# range 0 .. 31;
      DSI_GHCR    at 16#5C# range 0 .. 31;
      DSI_GPDR    at 16#60# range 0 .. 31;
      DSI_GPSR    at 16#64# range 0 .. 31;
      DSI_TCCR0   at 16#68# range 0 .. 31;
      DSI_TCCR1   at 16#6C# range 0 .. 31;
      DSI_TCCR2   at 16#70# range 0 .. 31;
      DSI_TCCR3   at 16#74# range 0 .. 31;
      DSI_TCCR4   at 16#78# range 0 .. 31;
      DSI_TCCR5   at 16#7C# range 0 .. 31;
      DSI_CLCR    at 16#80# range 0 .. 31;
      DSI_CLTCR   at 16#84# range 0 .. 31;
      DSI_DLTRC   at 16#88# range 0 .. 31;
      DSI_PCTLR   at 16#8C# range 0 .. 31;
      DSI_PCONFR  at 16#90# range 0 .. 31;
      DSI_PUCR    at 16#94# range 0 .. 31;
      DSI_PTTCR   at 16#98# range 0 .. 31;
      DSI_PSR     at 16#9C# range 0 .. 31;
      DSI_ISR0    at 16#A0# range 0 .. 31;
      DSI_ISR1    at 16#A4# range 0 .. 31;
      DSI_IER0    at 16#A8# range 0 .. 31;
      DSI_IER1    at 16#AC# range 0 .. 31;
      DSI_FIR0    at 16#B0# range 0 .. 31;
      DSI_FIR1    at 16#B4# range 0 .. 31;
      DSI_VSCR    at 16#B8# range 0 .. 31;
      DSI_LCVCIDR at 16#BC# range 0 .. 31;
      DSI_LCCCR   at 16#C0# range 0 .. 31;
      DSI_LPMCCR  at 16#C4# range 0 .. 31;
      DSI_VMCCR   at 16#C8# range 0 .. 31;
      DSI_VPCCR   at 16#CC# range 0 .. 31;
      DSI_VCCCR   at 16#D0# range 0 .. 31;
      DSI_VNPCCR  at 16#D4# range 0 .. 31;
      DSI_VHSACCR at 16#D8# range 0 .. 31;
      DSI_VHBPCCR at 16#DC# range 0 .. 31;
      DSI_VLCCR   at 16#E0# range 0 .. 31;
      DSI_VVSACCR at 16#E4# range 0 .. 31;
      DSI_VVBPCCR at 16#E8# range 0 .. 31;
      DSI_VVFPCCR at 16#EC# range 0 .. 31;
      DSI_VVACCR  at 16#F0# range 0 .. 31;
